    ...
    void skal_runde_ned_ved_gradering() {
        ...
        var periode =
                OppgittPeriode.forGradering(
                        ...
                        null);
        var trekkdager =
                TrekkdagerUtregningUtil.trekkdagerFor(periode, true, arbeidstidsprosent, null);
    ...
    void skal_redusere_trekkdager_ved_samtidig_uttak_uten_gradering() {
        ...
        var periode =
                OppgittPeriode.forVanligPeriode(
                        ...
                        null);
        var trekkdager =
                TrekkdagerUtregningUtil.trekkdagerFor(periode, false, null, samtidigUttaksprosent);
