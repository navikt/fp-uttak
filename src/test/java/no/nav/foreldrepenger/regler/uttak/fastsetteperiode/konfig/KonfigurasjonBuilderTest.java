...
class KonfigurasjonBuilderTest {
    ...
    void konfigurasjon_med_en_verdi_i_to_intervaller() {
        ...
        assertThat(konfigurasjon.getParameter(Parametertype.FORBEHOLDT_MOR_ETTER_FØDSEL_UKER, nå))
                .isEqualTo(6);
        assertThat(konfigurasjon.getParameter(Parametertype.FORBEHOLDT_MOR_ETTER_FØDSEL_UKER, nå.plusDays(7)))
                .isEqualTo(7);
        assertThat(konfigurasjon.getParameter(Parametertype.FORBEHOLDT_MOR_ETTER_FØDSEL_UKER, nå.plusDays(70)))
                .isEqualTo(7);
    }
