...
public class AdopsjonOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    public void UT1230_adopsjon_mor_søker_mødrekvote_før_omsorgsovertakelse() {
        ...
        verifiserAvslåttPeriode(resultater.get(0).getUttakPeriode(), omsorgsovertakelseDato.minusWeeks(1), omsorgsovertakelseDato.minusDays(1),
    ...
    public void UT1006_adopsjon_mor_søker_mødrekvote_etter_omsorgsovertakelse_men_uten_omsorg() {
        ...
        RegelGrunnlag grunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        ...
                        .leggTilOppgittPeriode(oppgittPeriode(MØDREKVOTE, omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1)))
        ...
        assertThat(resultater).hasSize(1);
        verifiserAvslåttPeriode(resultater.get(0).getUttakPeriode(), omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1),
        ...
        RegelGrunnlag grunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        ...
                        .leggTilOppgittPeriode(OppgittPeriode.forOverføring(MØDREKVOTE, omsorgsovertakelseDato.minusWeeks(1), omsorgsovertakelseDato.minusDays(1),
                                PeriodeVurderingType.PERIODE_OK, OverføringÅrsak.INNLEGGELSE, null))
                        .medDokumentasjon(new Dokumentasjon.Builder()
    ...
    public void UT1030_adopsjon_far_søker_fedrekvote_før_omsorgsovertakelse_men_uten_omsorg() {
        ...
        RegelGrunnlag grunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        .medType(Søknadstype.ADOPSJON)
                        .leggTilOppgittPeriode(oppgittPeriode(Stønadskontotype.FEDREKVOTE, omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1)))
                        .medDokumentasjon(new Dokumentasjon.Builder()
                                .leggPeriodeUtenOmsorg(new PeriodeUtenOmsorg(omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(3)))))
                .medAdopsjon(new Adopsjon.Builder()
                        .medAnkomstNorge(null))
                .build();
    ...
    public void UT1046_adopsjon_mor_søker_fellesperiode_etter_omsorgsovertakelse_men_uten_omsorg() {
        ...
        RegelGrunnlag grunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        .medType(Søknadstype.ADOPSJON)
                        .leggTilOppgittPeriode(oppgittPeriode(FELLESPERIODE, omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1)))
                        .medDokumentasjon(new Dokumentasjon.Builder()
                                .leggPeriodeUtenOmsorg(new PeriodeUtenOmsorg(omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(100)))))
                .medAdopsjon(new Adopsjon.Builder().medAnkomstNorge(null))
                .build();
    ...
    public void UT1191_adopsjon_mor_søker_foreldrepenger_etter_omsorgsovertakelse_men_uten_omsorg() {
        ...
        RegelGrunnlag grunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        .medType(Søknadstype.ADOPSJON)
                        .leggTilOppgittPeriode(oppgittPeriode(FORELDREPENGER, omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1)))
                        .medDokumentasjon(new Dokumentasjon.Builder()
                                .leggPeriodeUtenOmsorg(new PeriodeUtenOmsorg(omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(100)))))
                .medAdopsjon(new Adopsjon.Builder()
                        .medAnkomstNorge(null))
    ...
    public void UT1201_adopsjon_far_søker_foreldrepenger_etter_omsorgsovertakelse_men_før_etter_uke_7() {
        ...
        assertThat(resultater).hasSize(1);
        verifiserManuellBehandlingPeriode(resultater.get(0).getUttakPeriode(), omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1),
    ...
    public void UT1082_adopsjon_avslag_perioder_forut_for_førsteLovligeUttaksdag() {
        ...
        var testGrunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        ...
                        .leggTilOppgittPeriode(OppgittPeriode.forVanligPeriode(FORELDREPENGER, omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(1).minusDays(1),
                                null, false, PeriodeVurderingType.IKKE_VURDERT, omsorgsovertakelseDato.plusMonths(4))))
                .medAdopsjon(new Adopsjon.Builder()
    ...
    public void UT1241_stebarnsadopsjon_far_omsorg_disponible_dager_og_ingen_gradering() {
        ...
        RegelGrunnlag grunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        .medType(Søknadstype.ADOPSJON)
                        .leggTilOppgittPeriode(oppgittPeriode(FEDREKVOTE, omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1))))
                .medAdopsjon(new Adopsjon.Builder()
                        .medAnkomstNorge(null)
                        .medStebarnsadopsjon(true))
                .build();
    ...
    public void UT1242_stebarnsadopsjon_far_omsorg_disponible_dager_gradering_og_avklart_periode() {
        ...
        RegelGrunnlag grunnlag = grunnlagAdopsjon
                ...
                .medSøknad(new Søknad.Builder()
                        .medType(Søknadstype.ADOPSJON)
                        .leggTilOppgittPeriode(gradertoppgittPeriode(FEDREKVOTE, omsorgsovertakelseDato, omsorgsovertakelseDato.plusWeeks(2).minusDays(1), BigDecimal.TEN)))
                .medAdopsjon(new Adopsjon.Builder()
                        .medAnkomstNorge(null)
                        .medStebarnsadopsjon(true))
                .build();
    ...
    public void UT1244_stebarnsadopsjon_far_omsorg_ikke_disponible_stønadsdager() {
        ...
        assertThat(resultater).hasSize(1);
        verifiserManuellBehandlingPeriode(resultater.get(0).getUttakPeriode(), omsorgsovertakelseDato,
                omsorgsovertakelseDato.plusWeeks(2).minusDays(1), FEDREKVOTE, IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN, Manuellbehandlingårsak.STØNADSKONTO_TOM);
    }
}
