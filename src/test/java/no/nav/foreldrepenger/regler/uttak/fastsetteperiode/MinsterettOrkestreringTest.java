...
class MinsterettOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void bfhr_mor_med_bekreftet_uføretrygd_skal_godkjennes() {
        ...
        var oppgittPeriodeU1 =
                foreldrepengerUtsettelse(
                        utsettelseFra,
        ...
        var søknad =
                new Søknad.Builder()
                        ...
                        .oppgittePerioder(
                                List.of(oppgittPeriode, oppgittPeriodeU1, oppgittPeriode2));
    ...
    void bfhr_mor_med_bekreftet_uføretrygd_flerbarn_skal_godkjennes() {
        ...
        var søknad =
                new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittePerioder(
                                List.of(oppgittPeriode, oppgittPeriode2, oppgittPeriode3));
    ...
    void bfhr_mor_med_bekreftet_uføretrygd_overskrider_minsterett() {
        ...
        var søknad =
                new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittePerioder(List.of(oppgittPeriode));
    ...
    void bfhr_enkel_minsterett_vs_innvilget_med_mye_godkjent_aktivitet() {
        ...
        var oppgittPeriode2 =
                foreldrepenger(
                        fødselsdato.plusWeeks(45),
                        fødselsdato.plusWeeks(47).minusDays(1),
                        null,
                        null);
        var søknad =
                new Søknad.Builder()
    ...
    void bfhr_mor_med_bekreftet_uføretrygd_uten_aktivitetskrav_skal_godkjennes() {
        var fødselsdato = Virkedager.justerHelgTilMandag(LocalDate.of(2022, 1, 1));
        var kontoer =
                new Kontoer.Builder().konto(konto(FORELDREPENGER, 200)).utenAktivitetskravDager(75);
        var oppgittPeriode = foreldrepenger(fødselsdato, MorsAktivitet.UFØRE, null);
    ...
    @Test
    void
            bfhr_mor_med_bekreftet_uføretrygd_uten_aktivitetskrav_avslått_periode_med_aktivitet_skal_godkjennes() {
        var fødselsdato = Virkedager.justerHelgTilMandag(LocalDate.of(2022, 1, 1));
        var kontoer =
                new Kontoer.Builder().konto(konto(FORELDREPENGER, 200)).utenAktivitetskravDager(75);
        var oppgittPeriode =
                foreldrepenger(
                        fødselsdato.minusWeeks(1), MorsAktivitet.SYK, MORS_AKTIVITET_GODKJENT);
    ...
    void bfhr_minsterett_gradering_flere_arbeidsforhold() {
        ...
        var kontoer =
                new Kontoer.Builder().konto(konto(FORELDREPENGER, 40 * 5)).minsterettDager(8 * 5);
    ...
    void bfhr_minsterett_gradering_flere_arbeidsforhold_2() {
        ...
        var søknad =
                new Søknad.Builder().type(Søknadstype.FØDSEL).oppgittePerioder(List.of(gradering));
    ...
    private boolean harPeriode(
            UttakPeriode p, Perioderesultattype prt, PeriodeResultatÅrsak prå, int dager) {
