...
class SaldoUtregningTjenesteTest {
    ...
    void skal_knekke_annenparts_perioder() {
        ...
        var annenpartUttaksperiode =
                AnnenpartUttakPeriode.Builder.uttak(fomAnnenpart, tomAnnenpart)
                        .innvilget(true)
        ...
        var grunnlag =
                new RegelGrunnlag.Builder()
                        ...
                        .arbeid(
                                new Arbeid.Builder()
                                        .arbeidsforhold(new Arbeidsforhold(annenAktivitet())))
    ...
    private OppgittPeriode oppgittPeriode(
        ...
        return OppgittPeriode.forVanligPeriode(
                stønadskontotype, fom, tom, null, false, null, null, null, null);
    }

    @Test
    void
            skal_ikke_ta_med_opphold_på_annenpart_hvis_overlapp_med_søkers_periode_og_berørt_behandling() {
        var fomAnnenpartOpphold = LocalDate.of(2019, 12, 2);
        var tomAnnenpartOpphold = fomAnnenpartOpphold.plusWeeks(10).minusDays(1);
        var annenpartOpphold =
                AnnenpartUttakPeriode.Builder.opphold(
                ...
                new RegelGrunnlag.Builder()
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(annenpartOpphold)
                                        .uttaksperiode(annenpartUttaksperiode))
                        .kontoer(kontoer)
                        .arbeid(
                                new Arbeid.Builder()
                                        .arbeidsforhold(new Arbeidsforhold(annenAktivitet())))
                        .behandling(
                                new Behandling.Builder()
                                        .berørtBehandling(true)
    ...
    void
        ...
        var kontoer = new Kontoer.Builder().konto(konto(FEDREKVOTE, 100));
        var aktuellPeriode =
                oppgittPeriode(FEDREKVOTE, fomAnnenpartOpphold, tomAnnenpartOpphold.minusWeeks(5));
        var grunnlag =
                new RegelGrunnlag.Builder()
                        .annenPart(
                                new AnnenPart.Builder()
    ...
    void
        ...
        var kontoer = new Kontoer.Builder().konto(konto(FEDREKVOTE, 100));
        var aktuellPeriode =
                oppgittPeriode(FEDREKVOTE, fomAnnenpartOpphold.plusWeeks(5), tomAnnenpartOpphold);
        var grunnlag =
                new RegelGrunnlag.Builder()
                        .annenPart(
                                new AnnenPart.Builder()
    ...
    void
        ...
        var aktuellPeriode =
                oppgittPeriode(
                        FEDREKVOTE,
                        fomAnnenpartOpphold.plusWeeks(2),
    ...
    private SaldoUtregningGrunnlag lagGrunnlag(
            OppgittPeriode aktuellPeriode, RegelGrunnlag grunnlag) {
    ...
    void skal_knekke_annenparts_perioder_overlapp_annenpart_starter_en_dag_før() {
        ...
        var kontoer = new Kontoer.Builder().konto(konto(FELLESPERIODE, 100));
        var aktuellPeriode =
                oppgittPeriode(FELLESPERIODE, fomAnnenpart.plusDays(1), tomAnnenpart.plusWeeks(10));
        var grunnlag =
                new RegelGrunnlag.Builder()
                        .annenPart(new AnnenPart.Builder().uttaksperiode(annenpartUttaksperiode))
                        .kontoer(kontoer)
    ...
    void skal_ikke_avrunde_før_saldo_arves_til_nytt_arbeidsforhold() {
                        ...
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(2.5), FELLESPERIODE, identifikator)))
                        .build();
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        ...
                        .arbeid(
                                new Arbeid.Builder()
                                        ...
                                        .arbeidsforhold(
                                                new Arbeidsforhold(
                                                        identifikatorNyttArbeidsforhold)))
                        .kontoer(kontoer)
                        .build();
        ...
        assertThat(resultat.saldoITrekkdager(FELLESPERIODE, identifikator))
        ...
        var fastsattPeriode =
                new FastsattUttakPeriode.Builder()
                        ...
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(50), FELLESPERIODE, identifikator)))
                        .build();
        var annenpartsPeriode =
                AnnenpartUttakPeriode.Builder.uttak(
    ...
    void saldoutregning_flerbarnsdager() {
        ...
        var fastsattPeriode =
                new FastsattUttakPeriode.Builder()
                        ...
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(5), FELLESPERIODE, identifikator)))
                        .build();
        var annenpartsPeriode =
                AnnenpartUttakPeriode.Builder.uttak(fødselsdato, fødselsdato.plusDays(5))
                        .innvilget(true)
        ...
        assertThat(resultat.saldoITrekkdager(MØDREKVOTE, identifikator))
                .isEqualTo(new Trekkdager(14 * 5));
        assertThat(resultat.saldoITrekkdager(MØDREKVOTE, forSelvstendigNæringsdrivende()))
                .isEqualTo(new Trekkdager(14 * 5));
        assertThat(resultat.restSaldoFlerbarnsdager(identifikator))
    ...
    void saldoutregning_flerbarnsdager_begge_fellesperiode_berørt() {
        ...
        var annenpartsPeriode =
                AnnenpartUttakPeriode.Builder.uttak(
                        ...
                        .build();
        var saldoUtregningGrunnlag =
                SaldoUtregningGrunnlag.forUtregningAvHeleUttaket(
                        List.of(fastsattPeriode),
                        true,
                        List.of(annenpartsPeriode),
                        kontoer.build(),
    ...
    void bfhr_enkel_minsterett_og_litt_msp() {
        ...
        var kontoer =
                new Kontoer.Builder().konto(konto(FORELDREPENGER, 5 * 40)).minsterettDager(40);
        ...
        var avslåttPeriode =
                new FastsattUttakPeriode.Builder()
                        .tidsperiode(
                                fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(16).minusDays(1))
                        .periodeResultatType(AVSLÅTT)
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                mspTD, FORELDREPENGER, identifikator)))
                        .build();
        var innvilgetPeriode =
                new FastsattUttakPeriode.Builder()
                        .tidsperiode(
        ...
        var saldoUtregningGrunnlag =
                SaldoUtregningGrunnlag.forUtregningAvDelerAvUttak(
                        List.of(avslåttPeriode, innvilgetPeriode),
                        List.of(),
                        grunnlag,
                        utregningsdato);
        var resultat = SaldoUtregningTjeneste.lagUtregning(saldoUtregningGrunnlag);
        ...
        assertThat(resultat.restSaldoMinsterett(identifikator))
                .isEqualTo(minsterettTD.subtract(innvilgetMinsterettTD));
    ...
    void bfhr_enkel_minsterett_vs_innvilget_mye_godkjent_aktivitet() {
        ...
        var avslåttPeriode =
                new FastsattUttakPeriode.Builder()
                        .tidsperiode(
                                fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(7).minusDays(1))
                        .periodeResultatType(AVSLÅTT)
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(5), FORELDREPENGER, identifikator)))
                        .build();
        var innvilgetPeriode =
                new FastsattUttakPeriode.Builder()
                        .tidsperiode(
                                fødselsdato.plusWeeks(7), fødselsdato.plusWeeks(45).minusDays(1))
                        .periodeResultatType(INNVILGET)
    ...
    void bfhr_enkel_minsterett_vs_innvilget_med_godkjent_aktivitet_og_minsterett() {
                        ...
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(5), FORELDREPENGER, identifikator)))
                        .build();
        var innvilgetPeriode1 =
                new FastsattUttakPeriode.Builder()
                        .tidsperiode(
                                fødselsdato.plusWeeks(7), fødselsdato.plusWeeks(11).minusDays(1))
                        .periodeResultatType(INNVILGET)
                        .resultatÅrsak(ANNET)
                        .aktiviteter(
                                List.of(
        ...
        var saldoUtregningGrunnlag =
                SaldoUtregningGrunnlag.forUtregningAvDelerAvUttak(
                        List.of(avslåttPeriode, innvilgetPeriode1, innvilgetPeriode2),
                        List.of(),
                        grunnlag,
                        utregningsdato);
        var resultat = SaldoUtregningTjeneste.lagUtregning(saldoUtregningGrunnlag);
    ...
    void skal_arve_saldo_flere_ganger() {
        ...
        var saldoUtregningGrunnlag =
                SaldoUtregningGrunnlag.forUtregningAvDelerAvUttak(
                        List.of(fastsattPeriode1, fastsattPeriode2, fastsattPeriode3),
                        List.of(),
                        grunnlag,
                        utregningsdato);
        var resultat = SaldoUtregningTjeneste.lagUtregning(saldoUtregningGrunnlag);
    ...
    void skal_regne_riktig_flerbarnsdager_hvis_annenpart_har_nyoppstartet_arbeidsforhold() {
        ...
        assertThat(resultat.restSaldoFlerbarnsdager(søkersArbeidsforhold))
                .isEqualTo(new Trekkdager(49));
    }
    ...
    void oppholdsperiode_hos_søker_som_ikke_er_knekt() {
        ...
        var uttakEtterOpphold =
                new FastsattUttakPeriode.Builder()
                        ...
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(1), FELLESPERIODE, forFrilans())))
                        .build();
        var annenpartUttaksperiode1 =
                AnnenpartUttakPeriode.Builder.uttak(
        ...
        var grunnlag =
                SaldoUtregningGrunnlag.forUtregningAvHeleUttaket(
                        ...
                        false,
                        List.of(
                                annenpartUttaksperiode1,
                                annenpartUttaksperiode2,
                                annenpartUttaksperiode3),
                        kontoer.build(),
    ...
    void oppholdsperiode_hos_søker_der_annenpart_ikke_har_fylt_hele_perioden() {
        ...
        var uttakEtterOpphold =
                new FastsattUttakPeriode.Builder()
                        ...
                        .build();
        var annenpartUttaksperiode =
                AnnenpartUttakPeriode.Builder.uttak(opphold.getFom(), LocalDate.of(2022, 2, 2))
                        .innvilget(true)
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        forFrilans(),
    ...
    void oppholdsperiode_hos_søker_der_annenpart_har_hull_i_oppholdsperioden() {
        ...
        var uttakEtterOpphold =
                new FastsattUttakPeriode.Builder()
                        ...
                        .build();
        var annenpartUttaksperiode1 =
                AnnenpartUttakPeriode.Builder.uttak(opphold.getFom(), LocalDate.of(2022, 2, 1))
                        .innvilget(true)
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        forFrilans(),
    ...
    void oppholdsperioder_skal_ikke_telle_dager_ved_fritt_uttak() {
        ...
        var annenpartOpphold =
                AnnenpartUttakPeriode.Builder.uttak(
                                LocalDate.of(2022, 11, 8), LocalDate.of(2022, 11, 8))
                        .innvilget(true)
        ...
        var annenpartUttak =
                AnnenpartUttakPeriode.Builder.uttak(
                                LocalDate.of(2022, 11, 9), LocalDate.of(2022, 11, 9))
                        .innvilget(true)
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        forFrilans(),
