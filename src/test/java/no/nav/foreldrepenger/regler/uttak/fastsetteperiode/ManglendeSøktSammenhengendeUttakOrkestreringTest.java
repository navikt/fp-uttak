    ...
    void skal_avslå_og_trekke_mødrekvote_for_mor_hvis_dager_igjen() {
        ...
        var grunnlag = basicGrunnlagMorSammenhengendeUttak(fødselsdato)
                .søknad(søknad(
                        ...
                        oppgittPeriode(
                                Stønadskontotype.MØDREKVOTE, fødselsdato.plusWeeks(8), fødselsdato.plusWeeks(9))))
                .kontoer(kontoer(
        ...
        var grunnlag = basicGrunnlagMorSammenhengendeUttak(fødselsdato)
                .søknad(søknad(
                        ...
                        oppgittPeriode(
                                Stønadskontotype.MØDREKVOTE, fødselsdato.plusWeeks(8), fødselsdato.plusWeeks(9))))
                .kontoer(kontoer(
                        konto(Stønadskontotype.MØDREKVOTE, 30), konto(Stønadskontotype.FORELDREPENGER_FØR_FØDSEL, 15)))
                .build();
        var perioder = fastsettPerioder(grunnlag);
    ...
    void skal_avslå_og_ikke_trekke_dager_når_alle_kontoer_går_tom_midt_i_en_manglede_søkt_periode() {
        ...
        var grunnlag = basicGrunnlagFarSammenhengendeUttak(fødselsdato)
                ...
                .kontoer(new Kontoer.Builder()
                        .konto(new Konto.Builder().trekkdager(30).type(FORELDREPENGER)))
                .søknad(søknad(
                        Søknadstype.FØDSEL,
        ...
        var fastsattPeriode = new FastsattUttakPeriode.Builder()
                ...
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(
                                new Trekkdager(1), Stønadskontotype.FELLESPERIODE, AktivitetIdentifikator.forFrilans()),
                        new FastsattUttakPeriodeAktivitet(
                                new Trekkdager(0),
    ...
    void foreldrepengerFørFødsel_for_kort_fpff_starter_for_sent() {
        ...
        var grunnlag = basicGrunnlagMorSammenhengendeUttak(fødselsdato)
                .søknad(søknad(
                        FØDSEL,
                        oppgittPeriode(
                                FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(1), fødselsdato.minusDays(1))));
        var perioder = fastsettPerioder(grunnlag);
