...
class SaldoUtregningTest {
    ...
    void skal_runde_opp_hvis_ikke_brukt_mer_enn_maks() {
        var fastsattUttakPeriode1 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(10.5), FELLESPERIODE, AKTIVITET1_SØKER)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(enTirsdag, enTirsdag)
                .build();
    ...
    void skal_runde_opp_hvis_brukt_mer_enn_maks() {
        var fastsattUttakPeriode1 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(13.5), FELLESPERIODE, AKTIVITET1_SØKER)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(enTirsdag, enTirsdag)
                .build();
        var perioderSøker = List.of(fastsattUttakPeriode1);
    ...
    void returnerer_dagerUtenAktivitetskrav() {
        var fastsattUttakPeriode1 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(10), FORELDREPENGER, AKTIVITET1_SØKER)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(enTirsdag, enTirsdag)
        ...
        var fastsattUttakPeriode2 = new FastsattUttakPeriode.Builder()
                .aktiviteter(
                        List.of(new FastsattUttakPeriodeAktivitet(new Trekkdager(3), FORELDREPENGER, AKTIVITET1_SØKER)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(enTirsdag.plusDays(1), enTirsdag.plusDays(1))
                .resultatÅrsak(FastsattUttakPeriode.ResultatÅrsak.ANNET)
                .build();
        var perioderSøker = List.of(fastsattUttakPeriode1, fastsattUttakPeriode2);
        var saldoUtregning = lagForenkletSaldoUtregning(
    ...
    void for_stort_trekk_som_ikke_bruker_minsterett_gir_riktig_saldo_minsterett() {
        ...
        var fastsattUttakPeriode = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(15), FORELDREPENGER, AKTIVITET1_SØKER)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(enTirsdag, enTirsdag)
                .resultatÅrsak(FastsattUttakPeriode.ResultatÅrsak.INNVILGET_FORELDREPENGER_KUN_FAR_HAR_RETT)
                .build();
        ...
        assertThat(saldoUtregning
                        .nettoSaldoJustertForMinsterett(FORELDREPENGER, AKTIVITET1_SØKER, false)
                        .decimalValue()
                        .intValue())
                .isEqualTo(5 - 15);
        assertThat(saldoUtregning
                        .nettoSaldoJustertForMinsterett(FORELDREPENGER, AKTIVITET1_SØKER, true)
                        .decimalValue()
                        .intValue())
                .isEqualTo(10 - 15);
    ...
    void vanlig_far_fødsel_gir_riktig_saldo_far_fødsel() {
        var fastsattUttakPeriode = new FastsattUttakPeriode.Builder()
                .aktiviteter(
                        List.of(new FastsattUttakPeriodeAktivitet(new Trekkdager(5), FEDREKVOTE, AKTIVITET1_SØKER)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(enTirsdag, enTirsdag)
                .resultatÅrsak(FastsattUttakPeriode.ResultatÅrsak.ANNET)
                .build();
    ...
    void for_stort_trekk_far_fødsel_gir_riktig_saldo_far_fødsel() {
        var fastsattUttakPeriode = new FastsattUttakPeriode.Builder()
                .aktiviteter(
                        List.of(new FastsattUttakPeriodeAktivitet(new Trekkdager(15), FEDREKVOTE, AKTIVITET1_SØKER)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(enTirsdag, enTirsdag)
                .resultatÅrsak(FastsattUttakPeriode.ResultatÅrsak.ANNET)
                .build();
    ...
    void trekkdager_på_annen_part_skal_telle_med_i_saldo() {
        ...
        var saldoUtregning = new SaldoUtregning(
                Map.ofEntries(stønadskonto(MØDREKVOTE, 10), stønadskonto(FELLESPERIODE, 20)),
                perioderSøker,
                perioderAnnenpart,
                false,
                Set.of(AKTIVITET1_SØKER, AKTIVITET2_SØKER),
    ...
    void skal_trekke_oppholdsperioder_for_annenpart() {
        ...
        var periodeAnnenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(0), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.AVSLÅTT)
    ...
    void skal_ikke_stjele_fra_annenpart_hvis_søker_har_oppholdsperiode() {
        var oppholdsperiodeSøker = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of())
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(LocalDate.of(2019, 2, 11), LocalDate.of(2019, 2, 13))
        ...
        var saldoUtregning = new SaldoUtregning(
                Map.ofEntries(stønadskonto(FELLESPERIODE, 20), stønadskonto(MØDREKVOTE, 20)),
                perioderSøker,
                perioderAnnenpart,
                false,
                Set.of(AKTIVITET1_SØKER),
    ...
    void overlappende_oppholdsperioder_skal_trekke_fra_annenparts_periode_ved() {
        ...
        var oppholdsperiodeSøker = new FastsattUttakPeriode.Builder()
                ...
                .oppholdÅrsak(OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER)
                .build();
        var oppholdsperiodeAnnenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of())
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(LocalDate.of(2019, 2, 14), LocalDate.of(2019, 2, 15))
                .oppholdÅrsak(OppholdÅrsak.MØDREKVOTE_ANNEN_FORELDER)
    ...
    void hvis_alle_søkers_perioder_er_etter_annenpart_skal_det_ikke_være_nok_dager_å_frigi() {
        ...
        var periode1Annenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(5), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
    ...
    void annenpart_har_ikke_nok_dager_å_frigi_selv_med_perioder_etter_søkers_siste_periode_med_trekkdager() {
        ...
        var periode1Annenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(15), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
    ...
    void
        ...
        var periode2Annenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(10), FELLESPERIODE, AKTIVITET1_ANNENPART),
    ...
    void
        ...
        var periode1Annenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(30), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
    ...
    void annenpart_har_ikke_nok_dager_å_frigi_etter_søkers_siste_periode_med_trekkdager() {
        ...
        var perioderAnnenpart = List.of(periode1Annenpart, periode2Annenpart);
        var saldoUtregning = new SaldoUtregning(
                Map.ofEntries(stønadskonto(FELLESPERIODE, 20), stønadskonto(FEDREKVOTE, 20)),
                perioderSøker,
                perioderAnnenpart,
                false,
                Set.of(AKTIVITET1_SØKER),
    ...
    void skal_støtte_en_søknadsperiode_overlapper_med_flere_oppholdsperioder_hos_annenpart() {
        ...
        var opphold1 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of())
                .oppholdÅrsak(OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER)
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(LocalDate.of(2019, 10, 7), LocalDate.of(2019, 10, 7))
                .build();
        var opphold2 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of())
                .oppholdÅrsak(OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER)
                .periodeResultatType(Perioderesultattype.INNVILGET)
    ...
    void
        ...
        var saldoUtregning = new SaldoUtregning(
                Map.ofEntries(
                        stønadskonto(FELLESPERIODE, 51), stønadskonto(FEDREKVOTE, 75), stønadskonto(MØDREKVOTE, 75)),
                perioderSøker,
                perioderAnnenpart,
                true,
                Set.of(AKTIVITET1_SØKER),
    ...
    void skal_ikke_frigi_dager_fra_oppholdsperiode_hvis_overlapp_med_avslått_periode_annenpart() {
        var periode1Søker = new FastsattUttakPeriode.Builder()
                ...
                .build();
        var oppholdSøker = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of())
                .oppholdÅrsak(OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER)
                .periodeResultatType(Perioderesultattype.INNVILGET)
    ...
    void skal_ikke_trekke_dager_for_oppholdsperioder_på_annenpart_som_ligger_etter_søkers_siste_periode() {
        ...
        var innvilgetPeriodeAnnenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(10), MØDREKVOTE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(LocalDate.of(2019, 10, 28), LocalDate.of(2019, 10, 28))
                .build();
        var oppholdAnnenpart1 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of())
                .oppholdÅrsak(OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER)
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(LocalDate.of(2019, 10, 30), LocalDate.of(2019, 10, 30))
                .build();
        var oppholdAnnenpart2 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of())
                .oppholdÅrsak(OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER)
                .periodeResultatType(Perioderesultattype.INNVILGET)
        ...
        var saldoUtregningBerørt = new SaldoUtregning(
                Map.ofEntries(stønadskonto(FEDREKVOTE, 10), stønadskonto(MØDREKVOTE, 10)),
                perioderSøker,
                perioderAnnenpart,
                false,
    ...
    void skal_ikke_finnes_nok_dager_å_frigi_ved_flere_arbeidsforhold_der_bare_det_ene_arbeidsforholdet_har_nok_dager() {
        ...
        var saldoUtregning = new SaldoUtregning(
                ...
                null,
                null);
        var saldoUtregningBerørtBehandling = new SaldoUtregning(
                Map.ofEntries(stønadskonto(FELLESPERIODE, 10)),
                perioderSøker,
                perioderAnnenpart,
                true,
    ...
    void skal_finnes_nok_dager_å_frigi_hvis_annenparts_uttaksperiode_starter_før_men_overlapper_med_søkers_periode() {
        ...
        var annenpartsPeriode = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(75.2), FEDREKVOTE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
    ...
    void skal_telle_riktig_antall_dager_på_annenpart_når_det_er_tilkommet_nytt_arbeidsforhold() {
        var annenpartsPeriode1 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(80), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(LocalDate.of(2019, 10, 14), LocalDate.of(2020, 2, 20))
                .build();
        ...
        var saldoUtregning = new SaldoUtregning(
                Map.ofEntries(stønadskonto(MØDREKVOTE, 75), stønadskonto(FELLESPERIODE, 80)),
                List.of(),
                perioderAnnenpart,
                false,
                Set.of(AKTIVITET1_SØKER),
    ...
    void
        ...
        var periodeMedNyttArbeidsforhold = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(35), MØDREKVOTE, AKTIVITET1_SØKER),
    ...
    void innvilget_utsettelse_overlapper_med_annenpart() {
        ...
        var periodeAnnenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(75), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
                .tidsperiode(LocalDate.of(2020, 2, 21), LocalDate.of(2020, 5, 5))
                .build();
    ...
    void skal_ta_med_overlappende_perioder_i_utregningen_av_dager_å_frigi_på_annenpart() {
        ...
        var periodeAnnenpart1 = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(3), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
    ...
    void samtidig_uttak_som_overlapper_delvis_med_oppholdsperioder_skal_trekke_dager_for_resten_av_oppholdet() {
        ...
        var periodeAnnenpart = new FastsattUttakPeriode.Builder()
                .aktiviteter(List.of(
                        new FastsattUttakPeriodeAktivitet(new Trekkdager(1), FELLESPERIODE, AKTIVITET1_ANNENPART)))
                .periodeResultatType(Perioderesultattype.INNVILGET)
