...
class SaldoUtregningTest {
    ...
    private static final AktivitetIdentifikator AKTIVITET1_SØKER =
            AktivitetIdentifikator.forArbeid(new Orgnummer("111"), "222");
    private static final AktivitetIdentifikator AKTIVITET2_SØKER =
            AktivitetIdentifikator.forArbeid(new Orgnummer("333"), "444");
    private static final AktivitetIdentifikator AKTIVITET1_ANNENPART =
            AktivitetIdentifikator.forArbeid(new Orgnummer("555"), "666");
    private static final AktivitetIdentifikator AKTIVITET2_ANNENPART =
            AktivitetIdentifikator.forArbeid(new Orgnummer("777"), "888");
    private final LocalDate enTirsdag = LocalDate.of(2019, 2, 19);

    private Map.Entry<Stønadskontotype, Trekkdager> stønadskonto(
            Stønadskontotype kontoType, int trekkdager) {
        return Map.entry(kontoType, new Trekkdager(trekkdager));
    }

    @Test
    void ingen_max_dag_og_ingen_trekkdager_skal_alltid_gi_0_i_saldo() {
        var fastsattUttakPeriode =
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 0)),
                        perioderSøker,
                        List.of(),
                        false,
    ...
    void max_dager_minus_trekkdag_skal_bli_saldo() {
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 10)),
                        perioderSøker,
                        List.of(),
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    void flere_trekk_gir_riktig_saldo() {
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 12)),
                        perioderSøker,
                        List.of(),
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    void for_stort_trekk_gir_riktig_saldo() {
        var fastsattUttakPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(15), MØDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(enTirsdag, enTirsdag)
                        .build();
        var perioderSøker = List.of(fastsattUttakPeriode);
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(MØDREKVOTE, 10)),
                        perioderSøker,
                        List.of(),
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    void returnerer_dagerUtenAktivitetskrav() {
        var fastsattUttakPeriode1 =
                new FastsattUttakPeriode.Builder()
                        ...
                        .tidsperiode(enTirsdag, enTirsdag)
                        .resultatÅrsak(
                                FastsattUttakPeriode.ResultatÅrsak
        ...
        var perioderSøker = List.of(fastsattUttakPeriode1, fastsattUttakPeriode2);
        var saldoUtregning =
                lagForenkletSaldoUtregning(
                        Map.of(FORELDREPENGER, 15),
                        perioderSøker,
                        Trekkdager.ZERO,
                        new Trekkdager(10),
                        Optional.empty(),
                        Trekkdager.ZERO);
        assertThat(saldoUtregning.restSaldoDagerUtenAktivitetskrav(AKTIVITET1_SØKER))
                .isEqualTo(new Trekkdager(7));
    ...
    void for_stort_trekk_som_ikke_bruker_minsterett_gir_riktig_saldo_minsterett() {
        ...
        // Forbrukeravminsterett = innvilget utenom aktivitetskrav, avslag/søknadsfrist, eller
        // manuellbehandling
        var fastsattUttakPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
        ...
        assertThat(
                        saldoUtregning
                                .nettoSaldoJustertForMinsterett(
                                        FORELDREPENGER, AKTIVITET1_SØKER, false)
                                .decimalValue()
                                .intValue())
                .isEqualTo(5 - 15);
        assertThat(
                        saldoUtregning
                                .nettoSaldoJustertForMinsterett(
                                        FORELDREPENGER, AKTIVITET1_SØKER, true)
                                .decimalValue()
                                .intValue())
                .isEqualTo(10 - 15);
        assertThat(saldoUtregning.restSaldoMinsterett(AKTIVITET1_SØKER))
    ...
    void vanlig_far_fødsel_gir_riktig_saldo_far_fødsel() {
        var fastsattUttakPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(5), FEDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(enTirsdag, enTirsdag)
                        .resultatÅrsak(FastsattUttakPeriode.ResultatÅrsak.ANNET)
                        .build();
        ...
        var saldoUtregning =
                lagForenkletSaldoUtregning(
                        Map.of(FEDREKVOTE, 10),
                        perioderSøker,
                        Trekkdager.ZERO,
                        Trekkdager.ZERO,
                        Optional.of(new LukketPeriode(enTirsdag, enTirsdag)),
                        new Trekkdager(10));
        // Skal forbruke minsterett
        ...
        assertThat(saldoUtregning.restSaldoFarUttakRundtFødsel(AKTIVITET1_SØKER, rundtFødsel))
                .isEqualTo(new Trekkdager(5));
        assertThat(saldoUtregning.restSaldoFarUttakRundtFødsel(rundtFødsel))
                .isEqualTo(new Trekkdager(5));
    }
        ...
        var fastsattUttakPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(15), FEDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(enTirsdag, enTirsdag)
                        .resultatÅrsak(FastsattUttakPeriode.ResultatÅrsak.ANNET)
                        .build();
                        ...
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(15), MØDREKVOTE, AKTIVITET1_SØKER),
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(20), MØDREKVOTE, AKTIVITET2_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(enTirsdag, enTirsdag)
                        .build();
        var perioderSøker = List.of(fastsattUttakPeriode);
        ...
        var fastsattUttakPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(5), MØDREKVOTE, AKTIVITET1_SØKER),
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(10), MØDREKVOTE, AKTIVITET2_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(enTirsdag, enTirsdag)
                        .build();
        var perioderSøker = List.of(fastsattUttakPeriode);
    ...
    void trekkdager_på_annen_part_skal_telle_med_i_saldo() {
        var søkerPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(5), FELLESPERIODE, AKTIVITET1_SØKER),
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(10),
                                                FELLESPERIODE,
                                                AKTIVITET2_SØKER)))
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(
                                stønadskonto(MØDREKVOTE, 10), stønadskonto(FELLESPERIODE, 20)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER, AKTIVITET2_SØKER),
    ...
    void ikke_stjele_men_summere_begge_parter_hvis_berørt_behandling() {
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 20)),
                        perioderSøker,
                        perioderAnnenpart,
                        true,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            ikke_stjele_men_summere_begge_parter_hvis_tapende_periode_søkt_samme_dag_søker_søkt_først() {
        var søkerPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        ...
                        enTirsdag.atStartOfDay().plusHours(2));
        assertThat(saldoUtregning.saldo(FELLESPERIODE)).isEqualTo(3);
    }
    ...
    @Test
    void
            skal_summere_trekkdager_for_begge_parter_hvis_overlapp_og_samtidig_uttak_og_ikke_berørt_behandling() {
        var søkerPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
    ...
    void skal_ikke_stjele_fra_annenpart_hvis_søker_har_oppholdsperiode() {
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(
                                stønadskonto(FELLESPERIODE, 20), stønadskonto(MØDREKVOTE, 20)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            hvis_søkers_innvilget_periode_overlapper_med_annenparts_oppholdsperiode_skal_det_ikke_trekkes_dobbelt() {
        var periodeSøker1 =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(3), MØDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(LocalDate.of(2019, 2, 11), LocalDate.of(2019, 2, 13))
                        .build();
        var oppholdsperiodeSøker =
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(MØDREKVOTE, 20), stønadskonto(FEDREKVOTE, 20)),
                        perioderSøker,
                        perioderAnnenpart,
                        true,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            annenpart_har_ikke_nok_dager_å_frigi_selv_med_perioder_etter_søkers_siste_periode_med_trekkdager() {
        var periode1Søker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
    ...
    @Test
    void
            annenpart_har_ikke_nok_dager_å_frigi_selv_med_perioder_etter_søkers_siste_periode_med_trekkdager_flere_arbeidsforhold_hos_annenpart() {
        var periode1Søker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
    ...
    @Test
    void
            annenpart_har_nok_dager_å_frigi_etter_søkers_siste_periode_med_trekkdager_hvis_søkers_siste_periode_starter_samme_dag_som_annenparts_siste_periode() {
        var periode1Søker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 30)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            annenpart_har_nok_dager_å_frigi_etter_søkers_siste_periode_med_trekkdager_flere_arbeidsforhold_hos_annenpart() {
        var periode1Søker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
    ...
    @Test
    void
            annenpart_har_nok_dager_å_frigi_etter_søkers_siste_periode_med_trekkdager_oppholdsperiode() {
        var periode1Søker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
    ...
    void annenpart_har_ikke_nok_dager_å_frigi_etter_søkers_siste_periode_med_trekkdager() {
        ...
        var periode2Søker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(1), FEDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(
                                stønadskonto(FELLESPERIODE, 20), stønadskonto(FEDREKVOTE, 20)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            skal_ikke_telle_dobbelt_når_oppholdsperiode_annenpart_overlapper_mer_flere_søknadsperioder_i_berørt_behandling() {
        var periode1Søker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(
                                stønadskonto(FELLESPERIODE, 51),
                                stønadskonto(FEDREKVOTE, 75),
                                stønadskonto(MØDREKVOTE, 75)),
                        perioderSøker,
                        perioderAnnenpart,
                        true,
                        Set.of(AKTIVITET1_SØKER),
    ...
    void skal_ikke_frigi_dager_fra_oppholdsperiode_hvis_overlapp_med_avslått_periode_annenpart() {
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FEDREKVOTE, 10)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            skal_ikke_trekke_dager_for_oppholdsperioder_på_annenpart_som_ligger_etter_søkers_siste_periode() {
        var periodeSøker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(10), FEDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
        ...
        var perioderSøker = List.of(periodeSøker);
        var perioderAnnenpart =
                List.of(innvilgetPeriodeAnnenpart, oppholdAnnenpart1, oppholdAnnenpart2);
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FEDREKVOTE, 10), stønadskonto(MØDREKVOTE, 10)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            riktig_saldo_ved_delvis_overlapp_og_gradering_på_annenpart_der_annenpart_har_flere_arbeidsforhold() {
        var periodeSøker =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 100)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            skal_ikke_finnes_nok_dager_å_frigi_ved_flere_arbeidsforhold_der_bare_det_ene_arbeidsforholdet_har_nok_dager() {
        var aktivitet1 =
                new FastsattUttakPeriodeAktivitet(
                        new Trekkdager(8), FELLESPERIODE, AKTIVITET1_SØKER);
        var aktivitet2 =
                new FastsattUttakPeriodeAktivitet(
                        new Trekkdager(15), FELLESPERIODE, AKTIVITET2_SØKER);
        var søkersPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(List.of(aktivitet1, aktivitet2))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(enTirsdag, enTirsdag)
                        .build();
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        ...
                        null,
                        null);
        var saldoUtregningBerørtBehandling =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 10)),
                        perioderSøker,
                        perioderAnnenpart,
        ...
        assertThat(saldoUtregning.nokDagerÅFrigiPåAnnenpart(FELLESPERIODE)).isFalse();
        assertThat(saldoUtregningBerørtBehandling.nokDagerÅFrigiPåAnnenpart(FELLESPERIODE))
                .isFalse();
    }
    ...
    @Test
    void
            skal_finnes_nok_dager_å_frigi_hvis_annenparts_uttaksperiode_starter_før_men_overlapper_med_søkers_periode() {
        var søkersPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(32), FEDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FEDREKVOTE, 75)),
                        perioderSøker,
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            skal_ikke_finnes_nok_dager_å_frigi_hvis_annenparts_uttaksperiode_starter_før_men_overlapper_med_søkers_periode_og_ikke_nok_dager_etter_søkers_fom() {
        var søkersPeriode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
    ...
    void skal_telle_riktig_antall_dager_på_annenpart_når_det_er_tilkommet_nytt_arbeidsforhold() {
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(
                                stønadskonto(MØDREKVOTE, 75), stønadskonto(FELLESPERIODE, 80)),
                        List.of(),
                        perioderAnnenpart,
                        false,
                        Set.of(AKTIVITET1_SØKER),
    ...
    @Test
    void
            skal_telle_riktig_antall_dager_når_det_er_tilkommet_nytt_arbeidsforhold_og_siste_periode_før_tilkommet_er_opphold() {
        var periodeUtenNyttArbeidsforhold =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(40), MØDREKVOTE, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
        ...
        var opphold =
                new FastsattUttakPeriode.Builder()
                        ...
                        .oppholdÅrsak(OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER)
                        .build();
        var periodeMedNyttArbeidsforhold =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(35), MØDREKVOTE, AKTIVITET1_SØKER),
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(35), MØDREKVOTE, AKTIVITET2_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(LocalDate.of(2020, 2, 21), LocalDate.of(2020, 5, 5))
                        .build();
        var søkersPerioder =
                List.of(periodeUtenNyttArbeidsforhold, opphold, periodeMedNyttArbeidsforhold);
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(MØDREKVOTE, 75)),
                        søkersPerioder,
                        List.of(),
                        false,
                        Set.of(AKTIVITET1_SØKER, AKTIVITET2_SØKER),
    ...
    void innvilget_utsettelse_overlapper_med_annenpart() {
        var periode =
                new FastsattUttakPeriode.Builder()
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(0), null, AKTIVITET1_SØKER)))
                        .periodeResultatType(Perioderesultattype.INNVILGET)
                        .tidsperiode(LocalDate.of(2020, 2, 21), LocalDate.of(2020, 5, 5))
                        .build();
        var periodeAnnenpart =
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 75)),
                        søkersPerioder,
                        List.of(periodeAnnenpart),
                        false,
                        Set.of(AKTIVITET1_SØKER),
                        null,
                        null);
    ...
    void skal_ta_med_overlappende_perioder_i_utregningen_av_dager_å_frigi_på_annenpart() {
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 5)),
                        søkersPerioder,
                        List.of(periodeAnnenpart1, periodeAnnenpart2, periodeAnnenpart3),
                        false,
                        Set.of(AKTIVITET1_SØKER),
                        null,
                        null);
    ...
    @Test
    void
            samtidig_uttak_som_overlapper_delvis_med_oppholdsperioder_skal_trekke_dager_for_resten_av_oppholdet() {
        var samtidigUttak =
                new FastsattUttakPeriode.Builder()
                        .samtidigUttak(true)
                        .aktiviteter(
        ...
        var saldoUtregning =
                new SaldoUtregning(
                        Map.ofEntries(stønadskonto(FELLESPERIODE, 10)),
                        søkersPerioder,
                        List.of(oppholdAnnenpart, periodeAnnenpart),
                        false,
                        Set.of(AKTIVITET1_SØKER),
                        null,
                        null);
    ...
    private SaldoUtregning lagForenkletSaldoUtregning(
