...
public class SaldoUtregningTest {
    ...
    public void ingen_max_dag_og_ingen_trekkdager_skal_alltid_gi_0_i_saldo() {
        ...
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 0)), perioderSøker, List.of(),
    ...
    public void max_dager_minus_trekkdag_skal_bli_saldo() {
        FastsattUttakPeriode fastsattUttakPeriode = new FastsattUttakPeriode.Builder()
                ...
                .build();
        List<FastsattUttakPeriode> perioderSøker = List.of(fastsattUttakPeriode);
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 10)), perioderSøker, List.of(),
                false, Set.of(AKTIVITET1_SØKER));
    ...
    public void flere_trekk_gir_riktig_saldo() {
        ...
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 12)), perioderSøker, List.of(),
                false, Set.of(AKTIVITET1_SØKER));
    ...
    public void for_stort_trekk_gir_riktig_saldo() {
        FastsattUttakPeriode fastsattUttakPeriode = new FastsattUttakPeriode.Builder()
                ...
                .build();
        List<FastsattUttakPeriode> perioderSøker = List.of(fastsattUttakPeriode);
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(MØDREKVOTE, 10)), perioderSøker, List.of(),
                false, Set.of(AKTIVITET1_SØKER));
    ...
    public void trekkdager_på_annen_part_skal_telle_med_i_saldo() {
        ...
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(MØDREKVOTE, 10), stønadskonto(FELLESPERIODE, 20)), perioderSøker,
                perioderAnnenpart, false, Set.of(AKTIVITET1_SØKER, AKTIVITET2_SØKER));
    ...
    public void stjele_fra_annenpart_hvis_ikke_tapende_behandling_og_ikke_samtidig_uttak() {
        ...
        List<FastsattUttakPeriode> perioderSøker = List.of(søkerPeriode);
        List<FastsattUttakPeriode> perioderAnnenpart = List.of(annenpartPeriode);
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 20)), perioderSøker,
    ...
    public void annenpart_har_nok_dager_å_frigi_etter_søkers_siste_periode_med_trekkdager_hvis_søkers_siste_periode_starter_samme_dag_som_annenparts_siste_periode() {
        ...
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 30)), perioderSøker,
                perioderAnnenpart, false, Set.of(AKTIVITET1_SØKER));
    ...
    public void har_søkt_samtidig_uttak() {
        ...
        List<FastsattUttakPeriode> perioderSøker = List.of(periode1Søker);
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 20)), perioderSøker, List.of(), false, Set.of(AKTIVITET1_SØKER));
    ...
    public void har_ikke_søkt_samtidig_uttak() {
        ...
        List<FastsattUttakPeriode> perioderSøker = List.of(periode1Søker);
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 20)), perioderSøker,
                List.of(), false, Set.of(AKTIVITET1_SØKER));
    ...
    public void skal_ikke_telle_dobbelt_når_oppholdsperiode_annenpart_overlapper_mer_flere_søknadsperioder_i_tapende_behandling() {
        ...
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FELLESPERIODE, 51), stønadskonto(FEDREKVOTE, 75), stønadskonto(MØDREKVOTE, 75)),
                perioderSøker, perioderAnnenpart, true, Set.of(AKTIVITET1_SØKER));
    ...
    public void skal_ikke_frigi_dager_fra_oppholdsperiode_hvis_overlapp_med_avslått_periode_annenpart() {
        ...
        SaldoUtregning saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(FEDREKVOTE, 10)), perioderSøker,
                perioderAnnenpart, false, Set.of(AKTIVITET1_SØKER));
    ...
    public void skal_ikke_trekke_dager_for_oppholdsperioder_på_annenpart_som_ligger_etter_søkers_siste_periode() {
        ...
        SaldoUtregning saldoUtregningTapende = new SaldoUtregning(Set.of(stønadskonto(FEDREKVOTE, 10), stønadskonto(MØDREKVOTE, 10)), perioderSøker,
                perioderAnnenpart, false, Set.of(AKTIVITET1_SØKER));
    ...
    public void skal_telle_riktig_antall_dager_på_annenpart_når_det_er_tilkommet_nytt_arbeidsforhold() {
        ...
        var saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(MØDREKVOTE, 75), stønadskonto(FELLESPERIODE, 80)),
                List.of(), perioderAnnenpart, false, Set.of(AKTIVITET1_SØKER));
    ...
    public void skal_telle_riktig_antall_dager_når_det_er_tilkommet_nytt_arbeidsforhold_og_siste_periode_før_tilkommet_er_opphold() {
        var periodeUtenNyttArbeidsforhold = new FastsattUttakPeriode.Builder()
                .medAktiviteter(List.of(new FastsattUttakPeriodeAktivitet(new Trekkdager(40), MØDREKVOTE, AKTIVITET1_SØKER)))
                .medPeriodeResultatType(Perioderesultattype.INNVILGET)
        ...
        var saldoUtregning = new SaldoUtregning(Set.of(stønadskonto(MØDREKVOTE, 75)),
                søkersPerioder, List.of(), false, Set.of(AKTIVITET1_SØKER, AKTIVITET2_SØKER));
