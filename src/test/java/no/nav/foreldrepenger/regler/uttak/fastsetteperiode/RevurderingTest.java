...
class RevurderingTest {
    ...
    void revurderingSøknadUtenSamtykkeOgOverlappendePerioderSkalFørTilAvslagPgaSamtykke() {
        var oppgittPeriode = uttakPeriode(
                Stønadskontotype.FELLESPERIODE, FAMILIEHENDELSE_DATO.plusWeeks(10), FAMILIEHENDELSE_DATO.plusWeeks(12));
        var grunnlag = basicBuilder(oppgittPeriode)
                .rettOgOmsorg(samtykke(false))
                .annenPart(annenPart(lagPeriode(
    ...
    void berørtBehandlingHvorDenAndrePartenHarInnvilgetUtsettelseSkalInnvilges() {
        ...
        var grunnlag = basicBuilder(oppgittPeriode)
                .rettOgOmsorg(new RettOgOmsorg.Builder()
                        ...
                        .farHarRett(true)
                        .samtykke(true))
                .annenPart(annenPart(AnnenpartUttakPeriode.Builder.utsettelse(
    ...
    void berørtBehandlingHvorDenAndrePartenHarInnvilgetUtsettelseSkalAvslåsHvisInnenforFørsteSeksUker() {
        ...
        var grunnlag = basicBuilder(oppgittPeriode)
                .rettOgOmsorg(new RettOgOmsorg.Builder()
                        ...
                        .samtykke(true))
                .annenPart(annenPart(AnnenpartUttakPeriode.Builder.utsettelse(
                                FAMILIEHENDELSE_DATO, FAMILIEHENDELSE_DATO.plusWeeks(3))
                        .innvilget(true)
                        .build()))
    ...
    void berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakSkalManueltVurderes() {
        ...
        var grunnlag = basicBuilder(oppgittPeriode)
                ...
                .annenPart(annenPart(lagPeriode(
                                ...
                                FAMILIEHENDELSE_DATO.plusWeeks(10),
                                FAMILIEHENDELSE_DATO.plusWeeks(12),
                                Utbetalingsgrad.HUNDRED.subtract(Utbetalingsgrad.TEN),
                                true)
                        .build()))
                .behandling(berørtBehandling())
                .build();
    ...
    void berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakFlerbarnsdagerSkalFlyteVidere() {
        var oppgittPeriode = uttakPeriodeFlerbarnsdager(
                Stønadskontotype.FELLESPERIODE, FAMILIEHENDELSE_DATO.plusWeeks(10), FAMILIEHENDELSE_DATO.plusWeeks(12));
    ...
    void berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakFlerbarnsdagerSkalFlyteVidereMKAP() {
        var oppgittPeriode = uttakPeriodeFlerbarnsdager(
                Stønadskontotype.FELLESPERIODE, FAMILIEHENDELSE_DATO, FAMILIEHENDELSE_DATO.plusWeeks(10));
    ...
    void berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakFlerbarnsdagerSkalFlyteVidereMK() {
        ...
        var grunnlag = basicBuilder(oppgittPeriode, true, true)
                ...
                .annenPart(annenPart(lagPeriode(
                                Stønadskontotype.FELLESPERIODE,
                                FAMILIEHENDELSE_DATO,
                                FAMILIEHENDELSE_DATO.plusWeeks(10).minusDays(1),
                                Utbetalingsgrad.TEN,
                                true)
                        .flerbarnsdager(true)
                        .build()))
    ...
    void revurdering_søknad_der_opphørsdato_ligger_i_perioden() {
        var uttaksperiode = uttakPeriode(
                Stønadskontotype.FELLESPERIODE, FAMILIEHENDELSE_DATO.plusWeeks(10), FAMILIEHENDELSE_DATO.plusWeeks(12));

        var grunnlag = basicBuilder(uttaksperiode)
                .medlemskap(new Medlemskap.Builder()
