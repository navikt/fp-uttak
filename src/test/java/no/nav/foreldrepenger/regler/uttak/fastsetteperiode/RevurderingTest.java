...
class RevurderingTest {
    ...
    void revurderingSøknadUtenSamtykkeOgOverlappendePerioderSkalFørTilAvslagPgaSamtykke() {
        ...
        var grunnlag =
                basicBuilder(oppgittPeriode)
                        .rettOgOmsorg(samtykke(false))
                        .annenPart(
                                annenPart(
                                        lagPeriode(
                                                        Stønadskontotype.FELLESPERIODE,
    ...
    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarInnvilgetUtsettelseSkalAvslåsHvisBehandlingKreverSammenhengendeUttak() {
        var oppgittPeriode =
                uttakPeriode(
                        Stønadskontotype.FELLESPERIODE,
                        FAMILIEHENDELSE_DATO.plusWeeks(10),
                        ...
                        .annenPart(
                                annenPart(
                                        AnnenpartUttakPeriode.Builder.utsettelse(
                                                ...
                                                .build()))
                        .behandling(
                                berørtBehandling().søkerErMor(true).kreverSammenhengendeUttak(true))
                        .build();

        var regelresultat = kjørRegel(oppgittPeriode, grunnlag);

        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.OPPHOLD_UTSETTELSE);
    }

    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarInnvilgetUtsettelseSkalAvslåsHvisInnenforFørsteSeksUker() {
        var oppgittPeriode =
                OppgittPeriode.forVanligPeriode(
                        Stønadskontotype.FEDREKVOTE,
                        FAMILIEHENDELSE_DATO,
                        FAMILIEHENDELSE_DATO.plusWeeks(2),
                ...
                basicBuilder(oppgittPeriode)
                        ...
                        .annenPart(
                                annenPart(
                                        AnnenpartUttakPeriode.Builder.utsettelse(
                                                        FAMILIEHENDELSE_DATO,
                                                        FAMILIEHENDELSE_DATO.plusWeeks(3))
                                                .innvilget(true)
                                                .build()))
    ...
    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarInnvilgetUtsettelseSkalInnvilgesForBalanserteFedreSelvOmInnenforFørsteSeksUker() {
        var oppgittPeriode =
                OppgittPeriode.forVanligPeriode(
                        Stønadskontotype.FEDREKVOTE,
                        FAMILIEHENDELSE_DATO,
    ...
    void berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0MenIkkeSamtidigUttakSkalAvslås() {
        ...
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.OPPHOLD_IKKE_SAMTIDIG_UTTAK);
    }

    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0MenIkkeSamtidigUttakSkalAvslåsOgKnekkes() {
        var oppgittPeriode =
                uttakPeriode(
                        Stønadskontotype.FELLESPERIODE,
                        FAMILIEHENDELSE_DATO.plusWeeks(10),
                        ...
                        .annenPart(
                                annenPart(
                                        lagPeriode(
                                                        ...
                                                        FAMILIEHENDELSE_DATO.plusWeeks(10),
                                                        FAMILIEHENDELSE_DATO.plusWeeks(12),
                                                        Utbetalingsgrad.HUNDRED.subtract(
                                                                Utbetalingsgrad.TEN),
                                                        true)
                                                .build()))
                        .behandling(berørtBehandling())
    ...
    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakSkalAutomatiskReduseres() {
        var oppgittPeriode =
                uttakPeriode(
                        Stønadskontotype.FELLESPERIODE,
                        FAMILIEHENDELSE_DATO.plusWeeks(10),
        ...
        assertThat(regelresultat.oppfylt()).isTrue();
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(InnvilgetÅrsak.FELLESPERIODE_ELLER_FORELDREPENGER);
    ...
    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakFlerbarnsdagerSkalFlyteVidere() {
        var oppgittPeriode =
                uttakPeriodeFlerbarnsdager(
                        Stønadskontotype.FELLESPERIODE,
                        FAMILIEHENDELSE_DATO.plusWeeks(10),
                        FAMILIEHENDELSE_DATO.plusWeeks(12));
        var grunnlag =
                basicBuilder(oppgittPeriode, true, true)
                        .rettOgOmsorg(samtykke(true).morHarRett(true).farHarRett(true))
                        .annenPart(
                                annenPart(
                                        lagPeriode(
    ...
    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakFlerbarnsdagerSkalFlyteVidereMKAP() {
        var oppgittPeriode =
                uttakPeriodeFlerbarnsdager(
                        Stønadskontotype.FELLESPERIODE,
                        FAMILIEHENDELSE_DATO,
                        FAMILIEHENDELSE_DATO.plusWeeks(10));
        var grunnlag =
                basicBuilder(oppgittPeriode, false, true)
                        .rettOgOmsorg(samtykke(true).morHarRett(true).farHarRett(true))
                        .annenPart(
                                annenPart(
                                        lagPeriode(
    ...
    @Test
    void
            berørtBehandlingHvorDenAndrePartenHarUtbetalingOver0OgSamtidigUttakFlerbarnsdagerSkalFlyteVidereMK() {
        var oppgittPeriode =
                uttakPeriode(
                        Stønadskontotype.MØDREKVOTE,
                        FAMILIEHENDELSE_DATO,
        ...
        assertThat(regelresultat.oppfylt()).isTrue();
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(InnvilgetÅrsak.KVOTE_ELLER_OVERFØRT_KVOTE);
        assertThat(regelresultat.skalUtbetale()).isTrue();
        assertThat(regelresultat.trekkDagerFraSaldo()).isTrue();
    }
    ...
    void revurdering_søknad_der_opphørsdato_ligger_i_perioden() {
        ...
        var grunnlag =
                basicBuilder(uttaksperiode)
                        .medlemskap(
                                new Medlemskap.Builder()
                                        .opphørsdato(uttaksperiode.getFom().plusWeeks(1)))
                        .build();
    ...
    void revurdering_søknad_der_opphørsdato_ligger_før_perioden() {
        ...
        var grunnlag =
                basicBuilder(uttaksperiode)
                        .medlemskap(
                                new Medlemskap.Builder()
                                        .opphørsdato(uttaksperiode.getFom().minusWeeks(1)))
                        .build();
    ...
    void revurdering_søknad_der_opphørsdato_ligger_etter_perioden() {
        ...
        var grunnlag =
                basicBuilder(uttaksperiode)
                        ...
                        .medlemskap(
                                new Medlemskap.Builder()
                                        .opphørsdato(uttaksperiode.getTom().plusWeeks(1)))
                        .build();

        var regelresultat = kjørRegel(uttaksperiode, grunnlag);

        assertThat(regelresultat.getAvklaringÅrsak())
                .isNotEqualTo(IkkeOppfyltÅrsak.SØKER_IKKE_MEDLEM);
    }
    ...
    private AnnenpartUttakPeriode.Builder lagPeriode(
    ...
    private RegelGrunnlag.Builder basicBuilder(
        ...
        var kontoer =
                new Kontoer.Builder()
                        .konto(new Konto.Builder().type(Stønadskontotype.MØDREKVOTE).trekkdager(50))
                        .konto(
                                new Konto.Builder()
    ...
    private OppgittPeriode uttakPeriode(
    ...
    private OppgittPeriode uttakPeriodeFlerbarnsdager(
            Stønadskontotype stønadskontotype, LocalDate fom, LocalDate tom) {
        return OppgittPeriode.forVanligPeriode(
                stønadskontotype, fom, tom, null, true, null, null, null, null);
    }
}
