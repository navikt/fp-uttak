...
class TapendeSakOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
        ...
        */
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(
                                oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(15), fødselsdato.plusWeeks(16))));
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(annenpartsPeriode(
                                ...
                                true,
                                fødselsdato.plusWeeks(10)))
                        .uttaksperiode(annenpartsPeriodeSamtidig(
                                MØDREKVOTE,
                                fødselsdato.plusWeeks(10),
                                fødselsdato.plusWeeks(12),
                                MOR_ARBEIDSFORHOLD,
    ...
    void skal_evaluere_normal_flyt_dersom_far_rundt_fødsel_mor_berørt_behandling_annen_part_samtidig() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                .datoer(new Datoer.Builder().fødsel(fødselsdato).termin(termindato))
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(annenpartsSamtidigPeriode(
                                FEDREKVOTE,
                                termindato.minusWeeks(1),
                                termindato.plusWeeks(1).minusDays(1),
                                MOR_ARBEIDSFORHOLD,
