...
class TapendeSakOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    private static final AktivitetIdentifikator MOR_ARBEIDSFORHOLD =
    ...
    @Test
    void
            skal_sette_0_trekkdager_når_perioden_avslås_men_annen_forelder_har_innvilget_samme_tidsrom() {
        /*
        ...
        */
        ...
        assertThat(resultatPeriode.getUtbetalingsgrad(RegelGrunnlagTestBuilder.ARBEIDSFORHOLD_1))
                .isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(
                        resultatPeriode
                                .getTrekkdager(RegelGrunnlagTestBuilder.ARBEIDSFORHOLD_1)
                                .decimalValue())
                .isZero();
    }
    ...
    @Test
    void
            skal_ikke_sette_0_trekkdager_når_perioden_avslås_men_annen_forelder_har_avslått_samme_tidsrom() {
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        .datoer(new Datoer.Builder().fødsel(fødselsdato))
                        .annenPart(
                                ...
                                new AnnenPart.Builder()
                                        ...
                                        .uttaksperiode(
                                                annenpartsPeriode(
                                                        ...
                                                        true,
                                                        fødselsdato.plusWeeks(13)))
                                        .sisteSøknadMottattTidspunkt(
                                                fødselsdato
                                                        .plusWeeks(13)
                                                        .atTime(LocalTime.of(12, 12, 12))))
                        .behandling(farBehandling())
                        .rettOgOmsorg(beggeRett())
                        .søknad(
                                new Søknad.Builder()
    ...
    @Test
    void
            skal_evaluere_normal_flyt_dersom_flerbarnsdager_far_har_søkt_etter_mor_berørt_behandling() {
        // Søkt samme dag, men mor har søkt etter far
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        .datoer(new Datoer.Builder().fødsel(fødselsdato))
    ...
    @Test
    void
            skal_evaluere_normal_flyt_dersom_flerbarnsdager_far_har_søkt_etter_mor_berørt_behandling_annen_part_samtidig() {
        // Søkt samme dag, men mor har søkt etter far
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        .datoer(new Datoer.Builder().fødsel(fødselsdato))
    ...
    void skal_evaluere_normal_flyt_dersom_far_rundt_fødsel_berørt_med_samtidig() {
                                ...
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                OppgittPeriode.forVanligPeriode(
                                                        ...
                                                        termindato.plusWeeks(1).minusDays(1),
                                                        new SamtidigUttaksprosent(100),
                                                        false,
                                                        fødselsdato,
                                                        fødselsdato,
                                        ...
                                        .oppgittPeriode(
                                                OppgittPeriode.forVanligPeriode(
                                                        FEDREKVOTE,
                                                        fødselsdato.plusWeeks(35),
                                                        fødselsdato.plusWeeks(42).minusDays(1),
                                                        null,
                                                        false,
                                                        fødselsdato,
                                                        fødselsdato,
        ...
        assertThat(
                        resultat.stream()
                                ...
                                .allMatch(INNVILGET::equals))
                .isTrue();
    }

    @Test
    void
            skal_evaluere_normal_flyt_dersom_far_rundt_fødsel_mor_berørt_behandling_annen_part_samtidig() {
        // Søkt samme dag, men mor har søkt etter far
        var fødselsdato = Virkedager.justerHelgTilMandag(LocalDate.of(2022, 10, 3));
        var termindato = Virkedager.justerHelgTilMandag(LocalDate.of(2022, 10, 5));
        var grunnlag =
                                ...
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                OppgittPeriode.forVanligPeriode(
                                                        MØDREKVOTE,
                                                        fødselsdato,
                                                        fødselsdato.plusWeeks(10).minusDays(3),
                                                        null,
                                                        false,
                                                        fødselsdato,
                                                        fødselsdato,
    ...
    static AnnenpartUttakPeriode annenpartsPeriode(
    ...
    static AnnenpartUttakPeriode annenpartsSamtidigPeriode(
            Stønadskontotype stønadskontotype,
            LocalDate fom,
            LocalDate tom,
            AktivitetIdentifikator aktivitet,
    ...
    static AnnenpartUttakPeriode annenpartsPeriodeSamtidig(
            Stønadskontotype stønadskontotype,
            LocalDate fom,
            LocalDate tom,
            AktivitetIdentifikator aktivitet,
