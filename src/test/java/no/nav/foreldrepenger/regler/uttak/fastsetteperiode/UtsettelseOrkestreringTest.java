...
import static no.nav.foreldrepenger.regler.uttak.fastsetteperiode.utfall.InnvilgetÅrsak.UTSETTELSE_GYLDIG;
...
class UtsettelseOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void periode_med_dokumentert_utsettelse_pga_barn_innlagt_innenfor_første_6_ukene_skal_innvilges() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                ...
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(3), fødselsdato.plusWeeks(6).minusDays(1), INNLAGT_BARN, INNLEGGELSE_BARN_GODKJENT)));
    ...
    void periode_med_dokumentert_utsettelse_pga_barn_innlagt_etter_første_6_ukene_skal_innvilges() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                ...
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10).minusDays(1), INNLAGT_BARN, INNLEGGELSE_BARN_GODKJENT)));
    ...
    void periode_med_dokumentert_utsettelse_pga_søker_innlagt_innenfor_første_6_ukene_skal_innvilges() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(3).minusDays(1)))
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(3), fødselsdato.plusWeeks(6).minusDays(1), INNLAGT_SØKER, INNLEGGELSE_SØKER_GODKJENT)));
    ...
    void periode_med_dokumentert_utsettelse_pga_søker_innlagt_etter_første_6_ukene_skal_innvilges() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10).minusDays(1), INNLAGT_SØKER, INNLEGGELSE_SØKER_GODKJENT)));
    ...
    void periode_med_dokumentert_utsettelse_pga_søker_syk_innenfor_første_6_ukene_skal_innvilges() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(3).minusDays(1)))
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(3), fødselsdato.plusWeeks(6).minusDays(1), SYKDOM_SKADE, SYKDOM_SØKER_GODKJENT)));
    ...
    void periode_med_dokumentert_utsettelse_pga_søker_syk_etter_første_6_ukene_skal_innvilges() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10).minusDays(1), SYKDOM_SKADE, SYKDOM_SØKER_GODKJENT)));
    ...
    void periode_med_utsettelse_pga_arbeid_før_uke_6_skal_til_manuell_behandling() {
        ...
        var utsettelseTom = fødselsdato.plusWeeks(10).minusDays(1);
        var grunnlag = basicGrunnlagMor(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(4).minusDays(1)))
                .oppgittPeriode(utsettelsePeriode(utsettelseFom, utsettelseTom, ARBEID, null)));
    ...
    void skal_ikke_utlede_stønadskontotype_ved_innvilgelse_av_utsettelse() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(4).minusDays(1)))
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(4), fødselsdato.plusWeeks(6).minusDays(1), INNLAGT_BARN, INNLEGGELSE_BARN_GODKJENT)));
    ...
    void periode_med_utsettelse_sykdom_som_ikke_er_dokumentert_skal_avslås() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(2).minusDays(1)))
                .oppgittPeriode(utsettelsePeriode(fødselsdato.plusWeeks(2), fødselsdato.plusWeeks(3).minusDays(1), SYKDOM_SKADE, null))
                .oppgittPeriode(
                    utsettelsePeriode(fødselsdato.plusWeeks(3), fødselsdato.plusWeeks(12).minusDays(1), SYKDOM_SKADE, SYKDOM_SØKER_GODKJENT)));
    ...
    void utsettelse_periode_med_ukjent_kontotype_må_settes_til_neste_tilgjengelig() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(4).minusDays(1)))
                .oppgittPeriode(utsettelsePeriode(fødselsdato.plusWeeks(4), fødselsdato.plusWeeks(6).minusDays(1), SYKDOM_SKADE, null)));
    ...
    void pleiepenger_utsettelse_skal_trekke_fra_fellesperiode() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).rettOgOmsorg(beggeRett().harOmsorg(true))
            .ytelser(new Ytelser(new Pleiepenger(fødselsdato, fødselsdato.plusWeeks(4).minusDays(1), true)))
        ...
        assertThat(resultat).hasSize(3);
        assertThat(resultat.getFirst().uttakPeriode().getUtsettelseÅrsak()).isEqualTo(INNLAGT_BARN);
        assertThat(resultat.getFirst().uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.AVSLÅTT);
        assertThat(resultat.getFirst().uttakPeriode().getTrekkdager(ARBEIDSFORHOLD).decimalValue()).isNotZero();
        assertThat(resultat.getFirst().uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD)).isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultat.getFirst().uttakPeriode().getStønadskontotype()).isEqualTo(FELLESPERIODE);
    }
    ...
    void pleiepenger_utsettelse_skal_trekke_fra_foreldrepenger() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).kontoer(kontoer)
            .ytelser(new Ytelser(new Pleiepenger(fødselsdato, termindato.minusDays(1), true)))
            .datoer(new Datoer.Builder().termin(termindato).fødsel(fødselsdato))
            .søknad(fødselSøknad()
                //Starter med pleiepenger
        ...
        assertThat(resultat.getFirst().uttakPeriode().getTrekkdager(ARBEIDSFORHOLD).decimalValue()).isNotZero();
        assertThat(resultat.getFirst().uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD)).isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultat.getFirst().uttakPeriode().getStønadskontotype()).isEqualTo(FORELDREPENGER);
    }
    ...
    void pleiepenger_med_overlappende_uttaksperiode_skal_gå_til_manuell() {
        ...
        assertThat(resultat.get(0).uttakPeriode().getManuellbehandlingårsak()).isEqualTo(
        ...
        assertThat(resultat.get(1).uttakPeriode().getManuellbehandlingårsak()).isEqualTo(
    ...
    void utsettelse_pga_sykdom_før_søknad_mottatt_dato_skal_innvilges() {
        ...
        var fødselsdato = LocalDate.of(2019, 7, 1);
        var utsettelse = OppgittPeriode.forUtsettelse(fødselsdato.plusWeeks(4), fødselsdato.plusWeeks(6).minusDays(1), SYKDOM_SKADE,
            fødselsdato.plusWeeks(8), fødselsdato.plusWeeks(8), null, SYKDOM_SØKER_GODKJENT);
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
            fødselSøknad().oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(4).minusDays(1))).oppgittPeriode(utsettelse));
    ...
    void skal_avslå_periode_hvis_overlapp_med_innvilget_utsettelse_i_tidsperiode_forbeholdt_mor_i_berørt_behandling() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var grunnlag = basicGrunnlagFar(fødselsdato).annenPart(
                new AnnenPart.Builder().uttaksperiode(uttak(fødselsdato, fødselsdato.plusWeeks(2).minusDays(1)).build())
            ...
            .søknad(fødselSøknad().oppgittPeriode(oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(2), fødselsdato.plusWeeks(4).minusDays(1))));

        var resultat = fastsettPerioder(grunnlag);
        assertThat(resultat).hasSize(1);

        var uttakPeriode = resultat.getFirst().uttakPeriode();
    ...
    void skal_innvilge_periode_hvis_overlapp_med_innvilget_utsettelse_etter_tidsperiode_forbeholdt_mor_i_berørt_behandling() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var grunnlag = basicGrunnlagFar(fødselsdato).annenPart(
                new AnnenPart.Builder().uttaksperiode(uttak(fødselsdato, fødselsdato.plusWeeks(6).minusDays(1)).build())
                    .uttaksperiode(utsettelse(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10)).build()))
            .behandling(farBehandling().berørtBehandling(true))
            .søknad(fødselSøknad().oppgittPeriode(oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10).minusDays(1))));
    ...
    void utsettelse_innvilges_tilbake_i_tid_for_bare_far_har_rett_hvis_mor_er_i_aktivitet() {
        ...
        var utsettelse = OppgittPeriode.forUtsettelse(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(50), ARBEID, fødselsdato.plusWeeks(100),
        ...
        assertThat(perioder.getFirst().uttakPeriode().getTrekkdager(ARBEIDSFORHOLD)).isEqualTo(Trekkdager.ZERO);
    }
    ...
    void innvilge_eller_avslå_basert_på_pleiepenger_med_innleggelse() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).søknad(
                fødselSøknad().oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                    .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(3).minusDays(1)))
                    .oppgittPeriode(utsettelsePeriode(fødselsdato.plusWeeks(3), fødselsdato.plusWeeks(6).minusDays(1), INNLAGT_BARN, null)))
            .ytelser(
                new Ytelser(new Pleiepenger(Set.of(new PleiepengerPeriode(fødselsdato.plusWeeks(3), fødselsdato.plusWeeks(5).minusDays(1), true)))));
    ...
    void avslag_utsettelse_med_trekkdager_skal_knekkes_når_saldo_går_tom() {
        ...
        assertThat(perioder.getFirst().uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.AVSLÅTT);
        assertThat(perioder.getFirst().uttakPeriode().getFom()).isEqualTo(fom);
        assertThat(perioder.getFirst().uttakPeriode().getTom()).isEqualTo(fom.plusWeeks(2).minusDays(1));
    ...
    void utsettelse_akt_krav_bare_far_rett_innvilget_uten_trekk() {
        ...
        assertThat(perioder).hasSize(1);
        assertThat(perioder.getFirst().uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(perioder.getFirst().uttakPeriode().getPeriodeResultatÅrsak()).isEqualTo(InnvilgetÅrsak.UTSETTELSE_GYLDIG_BFR_AKT_KRAV_OPPFYLT);
        assertThat(perioder.getFirst().uttakPeriode().getFom()).isEqualTo(fom);
        assertThat(perioder.getFirst().uttakPeriode().getTom()).isEqualTo(tom);
        assertThat(perioder.getFirst().uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD)).isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(perioder.getFirst().uttakPeriode().getTrekkdager(ARBEIDSFORHOLD).merEnn0()).isFalse();
    }

    @Test
    void fri_utsettelse_før_3_uker_før_fødsel_skal_til_innvilges_uten_trekk() {
        var fødselsdato = LocalDate.of(2021, 1, 20);
        ...
        var grunnlag = basicGrunnlagMor(fødselsdato).søknad(
            søknad(FØDSEL, utsettelse, oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)),
        ...
        assertThat(perioder.getFirst().uttakPeriode().getTrekkdager(ARBEIDSFORHOLD).decimalValue()).isZero();
        assertThat(perioder.getFirst().uttakPeriode().getFom()).isEqualTo(fom);
        assertThat(perioder.getFirst().uttakPeriode().getTom()).isEqualTo(tom);
    }

    @Test
    void prematur_fødsel_pleiepenger_skal_gi_utsettelse_med_trekkdager_fram_til_termindato_både_med_og_uten_innleggelse() {
        var fødselsdato = LocalDate.of(2021, 11, 22);
        var termindato = fødselsdato.plusWeeks(10);
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato).datoer(new Datoer.Builder().fødsel(fødselsdato).termin(termindato))
            .ytelser(new Ytelser(new Pleiepenger(List.of(new PleiepengerPeriode(fødselsdato, fødselsdato.plusWeeks(8).minusDays(1), true),
                new PleiepengerPeriode(fødselsdato.plusWeeks(8), termindato.minusDays(1), false)))))
            .søknad(fødselSøknad().oppgittPeriode(
                    utsettelsePeriode(fødselsdato, fødselsdato.plusWeeks(8).minusDays(1), INNLAGT_BARN, INNLEGGELSE_BARN_GODKJENT))
                .oppgittPeriode(utsettelsePeriode(fødselsdato.plusWeeks(8), termindato.minusDays(1), INNLAGT_BARN,
                    null)) //Saksbehandler får ikke dokumentasjonsvurdering ap i utsettelser etter uke 6
        ...
        var p4 = resultat.get(3).uttakPeriode();
        ...
        assertThat(p2.getTom()).isEqualTo(fødselsdato.plusWeeks(8).minusDays(1));
        ...
        assertThat(p3.getUtsettelseÅrsak()).isEqualTo(INNLAGT_BARN);
        assertThat(p3.getFom()).isEqualTo(fødselsdato.plusWeeks(8));
        assertThat(p3.getTom()).isEqualTo(termindato.minusDays(1));
        assertThat(p3.getPerioderesultattype()).isEqualTo(Perioderesultattype.AVSLÅTT);
        assertThat(p3.getPeriodeResultatÅrsak()).isEqualTo(FRATREKK_PLEIEPENGER);
        assertThat(p3.getTrekkdager(ARBEIDSFORHOLD)).isEqualTo(new Trekkdager(10));

        assertThat(p4.getStønadskontotype()).isEqualTo(MØDREKVOTE);
    }

    @Test
    void prematur_fødsel_pleiepenger_far_skal_få_innvilget_utsettelse_når_mor_allerede_har_fått_fratrekk() {
        // Når mor allerede har fått FRATREKK_PLEIEPENGER i prematurperioden, skal far sin utsettelse
        // innvilges uten trekkdager med årsak UTSETTELSE_GYLDIG (2024).
        // Reglene må sjekke om annen part allerede har fått fratrekk i overlappende periode.

        var fødselsdato = LocalDate.of(2026, 5, 13);
        var termindato = fødselsdato.plusWeeks(10);

        var grunnlag = basicGrunnlagFar(fødselsdato)
            .datoer(new Datoer.Builder().fødsel(fødselsdato).termin(termindato))
            .rettOgOmsorg(beggeRett())
            .ytelser(new Ytelser(new Pleiepenger(List.of(
                new PleiepengerPeriode(fødselsdato, termindato.minusDays(1), true)))))
            ...
            .søknad(søknad(FØDSEL,
                utsettelsePeriode(fødselsdato, termindato.minusDays(1), INNLAGT_BARN, INNLEGGELSE_BARN_GODKJENT),
                oppgittPeriode(FEDREKVOTE, termindato, termindato.plusWeeks(6))));

        var resultat = fastsettPerioder(grunnlag);

        // Prematurperioden: utsettelsen skal innvilges uten trekkdager
        var prematurPerioder = resultat.stream()
            .filter(r -> r.uttakPeriode().getFom().isBefore(termindato))
            .toList();

        assertThat(prematurPerioder).isNotEmpty();
        assertThat(prematurPerioder).allSatisfy(p -> {
            assertThat(p.uttakPeriode().getPerioderesultattype()).isEqualTo(INNVILGET);
            assertThat(p.uttakPeriode().getPeriodeResultatÅrsak()).isEqualTo(UTSETTELSE_GYLDIG);
            assertThat(p.uttakPeriode().getTrekkdager(ARBEIDSFORHOLD)).isEqualTo(Trekkdager.ZERO);
        });
    }
    ...
    void fri_utsettelse_første_6_ukene_skal_innvilges_for_far_begge_rett() {
        var fødselsdato = LocalDate.of(2022, 6, 28);
        var grunnlag = basicGrunnlagFar(fødselsdato).kontoer(defaultKontoer().farUttakRundtFødselDager(10))
            .søknad(søknad(FØDSEL, utsettelsePeriode(fødselsdato, fødselsdato.plusWeeks(1).minusDays(1), FRI, null),
                oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(1), fødselsdato.plusWeeks(2).minusDays(1), false, SamtidigUttaksprosent.HUNDRED),
        ...
        assertThat(perioder.get(4).uttakPeriode().getPeriodeResultatÅrsak()).isEqualTo(UTSETTELSE_GYLDIG);
        ...
        assertThat(perioder.get(5).uttakPeriode().getPeriodeResultatÅrsak()).isEqualTo(UTSETTELSE_GYLDIG);
    ...
    void fri_utsettelse_første_6_ukene_skal_innvilges_for_bfhr() {
        ...
        var grunnlag = basicGrunnlagFar(fødselsdato).rettOgOmsorg(bareFarRett())
            ...
            .søknad(søknad(FØDSEL, utsettelsePeriode(fødselsdato, fødselsdato.plusWeeks(1).minusDays(1), FRI, null),
                ...
                utsettelsePeriode(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(8).minusDays(1), FRI, MorsAktivitet.ARBEID,
    ...
    void fri_utsettelse_etter_uke_6_far_aleneomsorg_innvilges() {
        ...
        var grunnlag = basicGrunnlagFar(fødselsdato).rettOgOmsorg(aleneomsorg())
            .kontoer(new Kontoer.Builder().konto(FORELDREPENGER, 100))
            .søknad(søknad(FØDSEL, oppgittPeriode(FORELDREPENGER, fødselsdato, fødselsdato.plusWeeks(6).minusDays(1)),
    ...
    void annen_parts_periode_skal_trekke_dager_selv_om_de_overlapper_med_søkers_utsettelse(UtsettelseÅrsak utsettelseÅrsak) {
        ...
        var utsettelsePeriode = OppgittPeriode.forUtsettelse(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10).minusDays(1), utsettelseÅrsak,
