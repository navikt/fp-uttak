...
import static no.nav.foreldrepenger.regler.uttak.fastsetteperiode.util.ManglendeSøktePerioderForSammenhengendeUttakTjeneste.finnManglendeSøktePerioder;
...
class ManglendeSøktePerioderForSammenhengendeUttakTjenesteTest {
    ...
    void farMedAleneomsorgSkalHaUttakFraFødsel() {
        ...
        // Skjæringstidspunktet for opptjening og beregning er ved hans første uttaksdag, men vi må
        // trekke dager fra fødselen eller omsorgsovertakelsedatoen ved adopsjon.
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(
                                oppgittPeriode(FORELDREPENGER, førsteUttakSøktFom, førsteUttakSøktFom.plusWeeks(10))))
    ...
    void farMedAleneomsorgMedInnvilgetAnnetPartPerioder() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(LocalDate.of(2020, 11, 5), morTom)
                                .build()))
                .behandling(farBehandling())
    ...
    private RegelGrunnlag.Builder grunnlagMedKontoer() {
        var kontoer = new Kontoer.Builder()
                .konto(konto(FORELDREPENGER_FØR_FØDSEL, førFødselDager))
        ...
        return RegelGrunnlagTestBuilder.create()
                ...
                .arbeid(new Arbeid.Builder()
                        .arbeidsforhold(new Arbeidsforhold(RegelGrunnlagTestBuilder.ARBEIDSFORHOLD_1)));
    }
    ...
    void skalUtledeMspIFellesperiodeFørFødsel() {
        ...
        var uttakPeriode =
                oppgittPeriode(FELLESPERIODE, familiehendelsesDato.minusWeeks(8), familiehendelsesDato.minusWeeks(5));
        var grunnlag = grunnlagMedKontoer()
        ...
        mspFørFødsel.ifPresent(msp -> {
            assertThat(msp.getFom())
                    .isEqualTo(familiehendelsesDato.minusWeeks(5).plusDays(1));
            assertThat(msp.getTom())
                    .isEqualTo(familiehendelsesDato.minusWeeks(3).minusDays(3)); // -3 pga helg
        });
    }
    ...
    void skal_ikke_overlappe_msp_fpff_og_msp_fellesperiode_før_fødsel() {
        ...
        var fellesperiode1 =
                oppgittPeriode(FELLESPERIODE, familiehendelsesDato.minusWeeks(10), familiehendelsesDato.minusWeeks(8));
        var fellesperiode2 =
                oppgittPeriode(FELLESPERIODE, familiehendelsesDato.minusWeeks(7), familiehendelsesDato.minusWeeks(5));
        var fpff = oppgittPeriode(
                FORELDREPENGER_FØR_FØDSEL, familiehendelsesDato.minusWeeks(3), familiehendelsesDato.minusWeeks(2));
        var fellesperiode3 = oppgittPeriode(
                FELLESPERIODE,
                familiehendelsesDato,
                familiehendelsesDato.plusWeeks(6).minusDays(1));
        var grunnlag = grunnlagMedKontoer()
                .datoer(new Datoer.Builder().fødsel(familiehendelsesDato))
                .søknad(new Søknad.Builder()
        ...
        assertThat(manglendeSøktePerioder.get(0).getFom())
                .isEqualTo(familiehendelsesDato.minusWeeks(8).plusDays(1));
        assertThat(manglendeSøktePerioder.get(0).getTom())
                .isEqualTo(familiehendelsesDato.minusWeeks(7).minusDays(1));

        assertThat(manglendeSøktePerioder.get(1).getStønadskontotype()).isEqualTo(FELLESPERIODE);
        assertThat(manglendeSøktePerioder.get(1).getFom())
                .isEqualTo(familiehendelsesDato.minusWeeks(5).plusDays(1));
        assertThat(manglendeSøktePerioder.get(1).getTom())
                .isEqualTo(familiehendelsesDato.minusWeeks(3).minusDays(1));

        assertThat(manglendeSøktePerioder.get(2).getStønadskontotype()).isEqualTo(FORELDREPENGER_FØR_FØDSEL);
        assertThat(manglendeSøktePerioder.get(2).getFom())
                .isEqualTo(familiehendelsesDato.minusWeeks(2).plusDays(1));
        ...
        var grunnlag = grunnlagMedKontoer()
                .søknad(new Søknad.Builder()
                        .oppgittPeriode(oppgittPeriode(
                                MØDREKVOTE, familiehendelsesDato.plusWeeks(6), familiehendelsesDato.plusWeeks(7))))
                .datoer(new Datoer.Builder().fødsel(familiehendelsesDato))
                .build();

        var manglendeSøktePerioder = finnManglendeSøktePerioder(grunnlag);

        var mspEtterFødsel = manglendeSøktePerioder.stream()
    ...
    void finnerHullMellomSøktePerioderOgAnnenPartsUttakperioder() {
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(hullDato.plusDays(1), fødselsdato.plusWeeks(10))
                                        .build()))
                .build();
    ...
    void finnerHullMellomSøktePerioderOgAnnenPartsUttakperioderAvslåttPeriodeUtenTrekkdagerOgUtbetaling() {
        ...
        var annenpartInnvilgetMødrekvote = AnnenpartUttakPeriode.Builder.uttak(
                        familiehendelse, familiehendelse.plusWeeks(6).minusDays(1))
                .innvilget(true)
                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                        AktivitetIdentifikator.forFrilans(), MØDREKVOTE, new Trekkdager(10), Utbetalingsgrad.TEN))
                .build();
        var annenpartAvslåttMødrekvote = AnnenpartUttakPeriode.Builder.uttak(
                        familiehendelse.plusWeeks(6), familiehendelse.plusWeeks(7))
                .innvilget(false)
                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                        AktivitetIdentifikator.forFrilans(), MØDREKVOTE, Trekkdager.ZERO, Utbetalingsgrad.ZERO))
                .build();
        var grunnlag = grunnlagMedKontoer()
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(oppgittPeriode(
                                FEDREKVOTE, familiehendelse.plusWeeks(8), familiehendelse.plusWeeks(15))))
                .behandling(farBehandling())
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(
                                        fødselsdato.plusWeeks(7).plusDays(1), fødselsdato.plusWeeks(8))
                                .build())
                        .uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(
                                        fødselsdato.plusWeeks(9).plusDays(1), fødselsdato.plusWeeks(11))
                                .build()))
                .build();
    ...
    void helgErIkkeHull() {
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(annenPartStart, annenPartStart.plusWeeks(10))
                                .build()))
                .build();
    ...
    void skalLageManglendeSøktFraUke7TilFørsteUttaksdagNårBareFarHarRett() {
        ...
        var grunnlag = grunnlagMedKontoer()
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER, familiehendelse.plusWeeks(7), familiehendelse.plusWeeks(8))))
                .behandling(farBehandling())
        ...
        assertThat(msp).hasSize(1);
        assertThat(msp.get(0).getFom())
                .isEqualTo(grunnlag.getDatoer().getFamiliehendelse().plusWeeks(6));
        assertThat(msp.get(0).getTom())
                .isEqualTo(grunnlag.getSøknad()
                        .getOppgittePerioder()
                        .get(0)
                        .getFom()
                        .minusDays(1));
    ...
    void skalLageManglendeSøktSomGårOver6UkerEtterFødsel() {
        ...
        var grunnlag = grunnlagMedKontoer()
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER_FØR_FØDSEL, søknadsperiodeFom, familiehendelse.minusDays(1)))
                        .oppgittPeriode(oppgittPeriode(MØDREKVOTE, familiehendelse, familiehendelse.plusWeeks(3)))
                        .oppgittPeriode(OppgittPeriode.forUtsettelse(
                                familiehendelse.plusWeeks(6).plusDays(1),
                                familiehendelse.plusWeeks(8),
        ...
        assertThat(msp.get(0).getFom())
                .isEqualTo(
                        grunnlag.getDatoer().getFamiliehendelse().plusWeeks(3).plusDays(1));
        assertThat(msp.get(0).getTom())
                .isEqualTo(
                        grunnlag.getDatoer().getFamiliehendelse().plusWeeks(6).minusDays(1));
        assertThat(msp.get(1).getFom())
                .isEqualTo(grunnlag.getDatoer().getFamiliehendelse().plusWeeks(6));
        assertThat(msp.get(1).getTom())
                .isEqualTo(grunnlag.getDatoer().getFamiliehendelse().plusWeeks(6));
    ...
    void skalLageManglendeSøktFraUke7FørStpOpptjeningHvisEtterFødselNårBareFarHarRett() {
        ...
        var grunnlag = grunnlagMedKontoer()
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(
                                oppgittPeriode(FORELDREPENGER, søknadsperiodeFom, familiehendelse.plusWeeks(10))))
                .behandling(farBehandling())
                .rettOgOmsorg(new RettOgOmsorg.Builder().farHarRett(true).morHarRett(false))
                .opptjening(new Opptjening.Builder().skjæringstidspunkt(søknadsperiodeFom))
                .datoer(new Datoer.Builder().fødsel(familiehendelse))
    ...
    void skalLageManglendeSøktFraMellomForeldreFørStpForOpptjeningAnnenpartAvslåttSistePeriode() {
        ...
        var annenpartInnvilgetMødrekvote = AnnenpartUttakPeriode.Builder.uttak(
                ...
                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                        AktivitetIdentifikator.forFrilans(), MØDREKVOTE, new Trekkdager(10), Utbetalingsgrad.TEN))
                .build();
        var annenpartInnvilgetUtsettelse = AnnenpartUttakPeriode.Builder.utsettelse(
                        familiehendelse.plusWeeks(6),
    ...
    void skalLageManglendeSøktFraMellomForeldreFørStpForOpptjeningAnnenpartInnvilgetUtsettelseSistePeriode() {
        ...
        assertThat(msp).hasSize(1);
        assertThat(msp.get(0).getFom())
                .isEqualTo(annenpartInnvilgetUtsettelse.getTom().plusDays(1));
    }
    ...
    void skalLageManglendeSøktFraMellomForeldreFørStpForOpptjening() {
        ...
        assertThat(msp).hasSize(1);
        assertThat(msp.get(0).getFom())
                .isEqualTo(annenpartInnvilgetMødrekvote.getTom().plusDays(1));
    }
    ...
    void skalLageManglendeSøktFraOmsorgsovertakelseTilFørsteUttaksdagVedAdopsjon() {
        ...
        var grunnlag = grunnlagMedKontoer()
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.ADOPSJON)
                        .oppgittPeriode(
                                oppgittPeriode(MØDREKVOTE, familiehendelse.plusWeeks(1), familiehendelse.plusWeeks(3))))
                .behandling(morBehandling())
                .rettOgOmsorg(new RettOgOmsorg.Builder().farHarRett(true).morHarRett(true))
    ...
    void skalIkkeLageManglendeSøktFraOmsorgsovertakelseTilFørsteUttaksdagHvisAnnenpartHarUttakITidsrommet() {
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(omsorgsovertakelse, førsteUttaksdato.minusDays(1))
                                        .build()))
                .build();
    ...
    @Test
    void
            skalLageManglendeSøktFraOmsorgsovertakelseTilFørsteUttaksdagHvisAnnenpartIkkeHarTattHelePeriodenFramTilSøkersFørsteUttaksdato() {
        var omsorgsovertakelse = LocalDate.of(2018, 12, 4);
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(omsorgsovertakelse, førsteUttaksdato.minusWeeks(1))
                                        .build()))
                .build();
        ...
        assertThat(msp).hasSize(1);
        assertThat(msp.get(0).getFom())
                .isEqualTo(grunnlag.getAnnenPart()
                        .getUttaksperioder()
                        .get(0)
                        .getTom()
                        .plusDays(1));
    ...
    @Test
    void
            skalLageManglendeSøktFraOmsorgsovertakelseTilFørsteUttaksdagAnnenpartHvisAnnenpartHarUttakMidtMellomOmsorgsovertakelseOgSøkersFørsteUttaksdag() {
        var omsorgsovertakelse = LocalDate.of(2018, 12, 4);
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(
                                        omsorgsovertakelse.plusWeeks(1), førsteUttaksdato.minusWeeks(1))
                                .build()))
                .build();
        ...
        var grunnlag = grunnlagMedKontoer()
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(
                                oppgittPeriode(MØDREKVOTE, familiehendelse.plusWeeks(1), familiehendelse.plusWeeks(3)))
                        .oppgittPeriode(oppgittPeriode(
                                FELLESPERIODE, familiehendelse.plusWeeks(5), familiehendelse.plusWeeks(7))))
                .behandling(morBehandling())
                .rettOgOmsorg(new RettOgOmsorg.Builder().farHarRett(true).morHarRett(true))
                .datoer(new Datoer.Builder().omsorgsovertakelse(familiehendelse))
                .adopsjon(new Adopsjon.Builder().ankomstNorge(familiehendelse.plusDays(3)))
    ...
    void manglende_fpff_skal_ikke_slutte_i_helg() {
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .søknad(new Søknad.Builder()
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER_FØR_FØDSEL, LocalDate.of(2018, 5, 21), LocalDate.of(2018, 6, 7)))
                        .oppgittPeriode(
                                oppgittPeriode(MØDREKVOTE, LocalDate.of(2018, 6, 11), LocalDate.of(2018, 8, 17)))
                        .oppgittPeriode(
                                oppgittPeriode(FELLESPERIODE, LocalDate.of(2018, 9, 10), LocalDate.of(2018, 10, 12))))
                .annenPart(new AnnenPart.Builder()
                        // Annen part starter mandagen etter
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(LocalDate.of(2018, 8, 20), LocalDate.of(2018, 9, 8))
                                        .samtidigUttak(true)
                                        .build()))
                .build();
    ...
    void skalOppretteManglendeSøktFraSkjæringstidspunktForOpptjening() {
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .søknad(new Søknad.Builder()
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusWeeks(2)))
                        .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(6))))
    ...
    void skalIkkeOppretteManglendeSøktBasertPåAnnenPartFørSkjæringstidspunktForOpptjening() {
        ...
        var grunnlag = grunnlagMedKontoer()
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(fødselsdato.plusWeeks(7), fødselsdato.plusWeeks(8))
                                        .build()))
                .build();
    ...
    void skal_ikke_opprette_manglende_søkt_før_endringsdato() {
        ...
        var oppgittPeriode = OppgittPeriode.forVanligPeriode(
                FORELDREPENGER,
                fødselsdato.plusWeeks(20),
                fødselsdato.plusWeeks(22),
                null,
                false,
