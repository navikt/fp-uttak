...
class ManglendeSøktePerioderForSammenhengendeUttakTjenesteTest {
                                ...
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        FORELDREPENGER,
                                                        førsteUttakSøktFom,
                                                        førsteUttakSøktFom.plusWeeks(10))))
    ...
    void farMedAleneomsorgSkalHaUttakFraAdopsjon() {
        ...
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        ...
                        .adopsjon(
                                new Adopsjon.Builder()
                                        .ankomstNorge(adopsjonsDato)
        ...
        return RegelGrunnlagTestBuilder.create()
                ...
                .arbeid(
                        new Arbeid.Builder()
                                .arbeidsforhold(
                                        new Arbeidsforhold(
                                                RegelGrunnlagTestBuilder.ARBEIDSFORHOLD_1)));
    }
    ...
    void skalIkkeUtledeMspIForeldrepengerFørFødselDersomSøknadstypeErAdopsjon() {
        ...
        var uttakPeriode =
                oppgittPeriode(FELLESPERIODE, omsorgsovertakelse, omsorgsovertakelse.plusWeeks(7));
        ...
        var mspFørFødsel =
                manglendeSøktePerioder.stream()
                        .filter(
                                mspPeriode ->
                                        FORELDREPENGER_FØR_FØDSEL.equals(
                                                mspPeriode.getStønadskontotype()))
                        .findFirst();
    ...
    void skalUtledeMspIFellesperiodeFørFødsel() {
        ...
        var uttakPeriode =
                oppgittPeriode(
                        FELLESPERIODE,
                        familiehendelsesDato.minusWeeks(8),
    ...
    void skal_ikke_overlappe_msp_fpff_og_msp_fellesperiode_før_fødsel() {
        ...
        var fellesperiode1 =
                oppgittPeriode(
                        FELLESPERIODE,
                        familiehendelsesDato.minusWeeks(10),
                        familiehendelsesDato.minusWeeks(8));
        var fellesperiode2 =
                oppgittPeriode(
                        FELLESPERIODE,
                        familiehendelsesDato.minusWeeks(7),
                        familiehendelsesDato.minusWeeks(5));
        var fpff =
                oppgittPeriode(
                        FORELDREPENGER_FØR_FØDSEL,
                        familiehendelsesDato.minusWeeks(3),
                        familiehendelsesDato.minusWeeks(2));
        var fellesperiode3 =
                oppgittPeriode(
                        FELLESPERIODE,
        ...
        assertThat(manglendeSøktePerioder.get(2).getStønadskontotype())
                .isEqualTo(FORELDREPENGER_FØR_FØDSEL);
        assertThat(manglendeSøktePerioder.get(2).getFom())
                .isEqualTo(familiehendelsesDato.minusWeeks(2).plusDays(1));
        assertThat(manglendeSøktePerioder.get(2).getTom())
                .isEqualTo(familiehendelsesDato.minusDays(1));
    }
    ...
    void skalUtledeMspMødrekvoteITidsperiodenForbeholdtMorEtterFødsel() {
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        MØDREKVOTE,
                                                        familiehendelsesDato.plusWeeks(6),
                                                        familiehendelsesDato.plusWeeks(7))))
                        .datoer(new Datoer.Builder().fødsel(familiehendelsesDato))
                        .build();
        ...
        mspEtterFødsel.ifPresent(
                msp -> {
                    assertThat(msp.getFom()).isEqualTo(familiehendelsesDato);
                    assertThat(msp.getTom())
                            .isEqualTo(
                                    familiehendelsesDato.plusWeeks(6).minusDays(3)); // -3 pga helg
                });
    }
    ...
    void skalIkkeUtledeMspIPerioderFørEndringsdato() {
        ...
        var grunnlag =
                grunnlagMedKontoer()
                        ...
                        .revurdering(
                                new Revurdering.Builder().endringsdato(LocalDate.of(2019, 6, 4)))
                        .build();
    ...
    @Test
    void
            finnerHullMellomSøktePerioderOgAnnenPartsUttakperioderAvslåttPeriodeUtenTrekkdagerOgUtbetaling() {
        var familiehendelse = LocalDate.of(2018, 12, 4);

        var annenpartInnvilgetMødrekvote =
                AnnenpartUttakPeriode.Builder.uttak(
                        ...
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        ...
                                        Utbetalingsgrad.TEN))
                        .build();
        var annenpartAvslåttMødrekvote =
                AnnenpartUttakPeriode.Builder.uttak(
                                ...
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        ...
                                                        familiehendelse.plusWeeks(15))))
                        .behandling(farBehandling())
                        .opptjening(
                                new Opptjening.Builder()
                                        .skjæringstidspunkt(familiehendelse.plusWeeks(10)))
                                ...
                                new AnnenPart.Builder()
                                        .uttaksperiode(
                                                AnnenpartUttakPeriode.Builder.uttak(
                                                        ...
                                                        .build()))
                        .revurdering(
                                new Revurdering.Builder().endringsdato(LocalDate.of(2019, 1, 1)))
                        .behandling(new Behandling.Builder())
                        .build();
                ...
                grunnlagMedKontoer()
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        MØDREKVOTE, fødselsdato, mødrekvoteSlutt)))
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(
                                                AnnenpartUttakPeriode.Builder.uttak(
                                                                annenPartStart,
                                                                annenPartStart.plusWeeks(10))
                                                        .build()))
                        .build();
    ...
    void skalLageManglendeSøktFraUke7TilFørsteUttaksdagNårBareFarHarRett() {
        ...
        assertThat(msp.get(0).getTom())
                .isEqualTo(grunnlag.getSøknad().getOppgittePerioder().get(0).getFom().minusDays(1));
        assertThat(msp.get(0).getStønadskontotype()).isEqualTo(FORELDREPENGER);
    }
    ...
    void skalLageManglendeSøktSomGårOver6UkerEtterFødsel() {
        ...
        assertThat(msp.get(0).getFom())
                .isEqualTo(grunnlag.getDatoer().getFamiliehendelse().plusWeeks(3).plusDays(1));
        assertThat(msp.get(0).getTom())
                .isEqualTo(grunnlag.getDatoer().getFamiliehendelse().plusWeeks(6).minusDays(1));
                ...
                AnnenpartUttakPeriode.Builder.uttak(
                        ...
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        ...
                                        Utbetalingsgrad.TEN))
                        .build();
        var annenpartInnvilgetUtsettelse =
                AnnenpartUttakPeriode.Builder.utsettelse(
    ...
    @Test
    void
            skalLageManglendeSøktFraMellomForeldreFørStpForOpptjeningAnnenpartInnvilgetUtsettelseSistePeriode() {
        var familiehendelse = LocalDate.of(2018, 12, 4);
    ...
    void skalLageManglendeSøktFraMellomForeldreFørStpForOpptjening() {
        ...
        var grunnlag =
                grunnlagMedKontoer()
                        ...
                        .datoer(new Datoer.Builder().fødsel(familiehendelse))
                        .annenPart(
                                new AnnenPart.Builder().uttaksperiode(annenpartInnvilgetMødrekvote))
                        .build();
    ...
    @Test
    void
            skalLageManglendeSøktFraOmsorgsovertakelseTilFørsteUttaksdagVedAdopsjonDerAnnenpartIkkeHarUttaksperioder() {
        var familiehendelse = LocalDate.of(2018, 12, 4);
    ...
    @Test
    void
            skalIkkeLageManglendeSøktFraOmsorgsovertakelseTilFørsteUttaksdagHvisAnnenpartHarUttakITidsrommet() {
    ...
    void
        ...
        assertThat(msp).hasSize(1);
        assertThat(msp.get(0).getFom())
                .isEqualTo(grunnlag.getAnnenPart().getUttaksperioder().get(0).getTom().plusDays(1));
    ...
    void
                ...
                grunnlagMedKontoer()
                        ...
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(
                                                AnnenpartUttakPeriode.Builder.uttak(
                                                                omsorgsovertakelse.plusWeeks(1),
                                                                førsteUttaksdato.minusWeeks(1))
                                                        .build()))
                        .build();
        ...
        assertThat(msp.get(0).getTom())
                .isEqualTo(
                        grunnlag.getAnnenPart().getUttaksperioder().get(0).getFom().minusDays(1));
        assertThat(msp.get(1).getFom())
                .isEqualTo(grunnlag.getAnnenPart().getUttaksperioder().get(0).getTom().plusDays(1));
    ...
    @Test
    void
            skalLageManglendeSøktFraAnkomstNorgeDatoTilFørsteUttaksdagPlussVanligeHullMellomPerioder() {
        var familiehendelse = LocalDate.of(2018, 12, 4);
        ...
        assertThat(msp.get(1).getFom())
                .isEqualTo(grunnlag.getSøknad().getOppgittePerioder().get(0).getTom().plusDays(1));
        assertThat(msp.get(1).getTom())
                .isEqualTo(grunnlag.getSøknad().getOppgittePerioder().get(1).getFom().minusDays(1));
    ...
    void skalOppretteManglendeSøktFraSkjæringstidspunktForOpptjening() {
        ...
        var grunnlag =
                grunnlagMedKontoer()
                        ...
                        .opptjening(
                                new Opptjening.Builder()
                                        .skjæringstidspunkt(fødselsdato.minusWeeks(1)))
                        .build();
    ...
    void skalIkkeOppretteManglendeSøktBasertPåAnnenPartFørSkjæringstidspunktForOpptjening() {
        ...
        var grunnlag =
                grunnlagMedKontoer()
                        ...
                        .opptjening(
                                new Opptjening.Builder()
                                        .skjæringstidspunkt(fødselsdato.plusWeeks(7)))
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(
                                                AnnenpartUttakPeriode.Builder.uttak(
    ...
    void skal_ikke_opprette_manglende_søkt_før_endringsdato() {
        ...
        var grunnlag =
                grunnlagMedKontoer()
                        ...
                        .rettOgOmsorg(new RettOgOmsorg.Builder().farHarRett(true).morHarRett(false))
                        .revurdering(
                                new Revurdering.Builder().endringsdato(fødselsdato.plusWeeks(18)))
                        .build();
