...
class MødrekvoteOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void mødrekvoteperiode_før_familiehendelse() {
        ...
        assertThat(perioder.get(0).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.minusWeeks(1).minusDays(1));
    ...
    void overføring_av_mødrekvote_grunnet_sykdom_skade_skal_innvilges() {
        ...
        assertThat(perioder.get(0).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(6).minusDays(1));
        assertThat(perioder.get(0).uttakPeriode().getOverføringÅrsak())
                .isEqualTo(OverføringÅrsak.SYKDOM_ELLER_SKADE);
        ...
        assertThat(perioder.get(1).uttakPeriode().getOverføringÅrsak())
                .isEqualTo(OverføringÅrsak.SYKDOM_ELLER_SKADE);
    ...
    @Test
    void
            overføring_av_mødrekvote_grunnet_sykdom_skade_men_far_har_ikke_omsorg_skal_til_manuell_behandling() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var grunnlag =
                basicGrunnlagFar(fødselsdato)
                        .rettOgOmsorg(
        ...
        // 6 første uker mødrekvote avslås
        assertThat(perioder.get(0).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.AVSLÅTT); // UT1006
        assertThat(perioder.get(0).uttakPeriode().getStønadskontotype())
                .isEqualTo(Stønadskontotype.MØDREKVOTE);
        ...
        assertThat(perioder.get(2).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.AVSLÅTT); // UT1086
        assertThat(perioder.get(1).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.MOR_HAR_IKKE_OMSORG);
        assertThat(perioder.get(2).uttakPeriode().getStønadskontotype())
                .isEqualTo(Stønadskontotype.FEDREKVOTE);
