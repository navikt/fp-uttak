...
class OrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void skal_innvilge_to_perioder_med_med_mødrekvote_på_under_10_uker() {
        ...
        resultat.stream().map(FastsettePeriodeResultat::uttakPeriode).forEach(uttakPeriode -> assertThat(
    ...
    void skal_knekke_mødrekvote_dersom_det_ikke_er_flere_dager_igjen() {
        ...
        var uttakPerioder =
                resultat.stream().map(FastsettePeriodeResultat::uttakPeriode).collect(Collectors.toList());
        ...
        assertThat(uttakPerioder.get(1).getTom())
        ...
        assertThat(uttakPerioder.get(2).getTom())
        ...
        assertThat(uttakPerioder.get(3).getTom())
    ...
    void helePeriodenUtenforSøknadsfrist() {
        ...
        var fpff = forVanligPeriode(
                ...
                null,
                null);
        var mødrekvote = forVanligPeriode(
                MØDREKVOTE,
                fødselsdato,
                sisteUttaksdag,
                null,
    ...
    void skalKnekkePeriodenVedGrenseForSøknadsfrist() {
        ...
        assertThat(mødrekvoteEtterKnekk.getTom())
                .isEqualTo(fødselsdato.plusWeeks(6).minusDays(1));
    ...
    void hele_perioden_skal_avslås_automatisk_når_det_er_søkt_for_sent() {
        ...
        var fedrekvote = forVanligPeriode(
                FEDREKVOTE,
                periodeFom,
                periodeTom,
                null,
    ...
    void UT1290_skal_være_ugyldige_stønadskonto_hvis_søker_på_konto_som_man_ikke_har_tilgang_til() {
        ...
        var grunnlag = basicGrunnlagMor(fødselsdato)
                .søknad(new Søknad.Builder()
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
                        .oppgittPeriode(oppgittPeriode(
                                MØDREKVOTE,
                                fødselsdato,
                                fødselsdato.plusWeeks(6).minusDays(1)))
                        .oppgittPeriode(
                                oppgittPeriode(FORELDREPENGER, fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10))));
        ...
        assertThat(resultat.get(2)
                        .uttakPeriode()
                        .getTrekkdager(ARBEIDSFORHOLD_1)
                        .decimalValue())
                .isNotZero();
    ...
    void skal_knekke_periode_og_gå_til_manuell_behandling_ved_ikke_nok_flerbarnsdager() {
        ...
        var annenPartPeriode1 = AnnenpartUttakPeriode.Builder.uttak(fødselsdato.minusWeeks(3), fødselsdato.minusDays(1))
                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                        ...
                        Utbetalingsgrad.TEN))
                .build();
        var annenPartPeriode2 = AnnenpartUttakPeriode.Builder.uttak(
                        fødselsdato, fødselsdato.plusWeeks(6).minusDays(1))
                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                        aktivitetIdentifikator, Stønadskontotype.MØDREKVOTE, new Trekkdager(30), Utbetalingsgrad.TEN))
                .build();
        var annenPartPeriode3 = AnnenpartUttakPeriode.Builder.uttak(fødselsdato.plusWeeks(6), tom)
                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                        aktivitetIdentifikator,
                        Stønadskontotype.FELLESPERIODE,
                        new Trekkdager(Virkedager.beregnAntallVirkedager(fødselsdato.plusWeeks(6), tom)),
                        Utbetalingsgrad.TEN))
                .build();
        var kontoer = new Kontoer.Builder()
        ...
        var periodeGrunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(søknad(
                        ...
                        oppgittPeriode(
                                ...
                                null),
                        oppgittPeriode(
                                Stønadskontotype.FORELDREPENGER, fødselsdato, fødselsdato.plusWeeks(100), true, null)))
                .build();
        ...
        var periodeGrunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(søknad(
                        ...
                        oppgittPeriode(
                                ...
                                null),
                        oppgittPeriode(
                                Stønadskontotype.FORELDREPENGER, fødselsdato, fødselsdato.plusWeeks(100), false, null)))
                .build();
    ...
    void skalIkkeKasteExceptionVedUtsettelseFraDerSaldoGårUt() {
        ...
        var grunnlag = new RegelGrunnlag.Builder()
                ...
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER_FØR_FØDSEL, LocalDate.of(2018, 7, 30), LocalDate.of(2018, 8, 19)))
                        .oppgittPeriode(
                                oppgittPeriode(MØDREKVOTE, LocalDate.of(2018, 8, 20), LocalDate.of(2018, 12, 2)))
                        .oppgittPeriode(utsettelsePeriode(
    ...
    void skal_filtrere_bort_perioden_som_kun_er_helg() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var periodeSomKunErHelg = oppgittPeriode(
                MØDREKVOTE,
                ...
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(LocalDate.of(2019, 3, 4), LocalDate.of(2019, 3, 6))
                                        ...
                                        .build())
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(LocalDate.of(2019, 3, 7), LocalDate.of(2019, 3, 31))
                                        .innvilget(true)
                                        .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                                                AktivitetIdentifikator.forFrilans(),
                                                Stønadskontotype.MØDREKVOTE,
                                        ...
                                        .build())
                        .uttaksperiode(
                                AnnenpartUttakPeriode.Builder.uttak(LocalDate.of(2019, 4, 1), LocalDate.of(2019, 5, 3))
                                        .innvilget(true)
                                        .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                                                AktivitetIdentifikator.forFrilans(),
                                                Stønadskontotype.MØDREKVOTE,
    ...
    void skal_knekke_på_riktig_dato_når_flerbarnskonto_går_tom() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(søknad(
                        Søknadstype.FØDSEL,
                        oppgittPeriode(
                                FELLESPERIODE, fødselsdato.plusWeeks(6), LocalDate.of(2020, 5, 13), true, null)));
    ...
    void skal_håndtere_flere_knekk_i_samme_søknadsperiode_ved_flere_arbeidsforhold() {
        ...
        var fastsattPeriode = new FastsattUttakPeriode.Builder()
                ...
                .aktiviteter(List.of(new FastsattUttakPeriodeAktivitet(
                        new Trekkdager(15), FORELDREPENGER, arbeidsforhold1.identifikator())));
        ...
        var grunnlag = new RegelGrunnlag.Builder()
                ...
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER, fødselsdato.plusWeeks(6).plusDays(1), fødselsdato.plusWeeks(15))))
    ...
    void søknadsfrist_ikke_trekke_dager_etter_at_konto_er_tom_manglende_søkt_periode() {
        ...
        var grunnlag = basicGrunnlagFar(fødselsdato)
                ...
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(
                                oppgittPeriode(FORELDREPENGER, fødselsdato.plusYears(1), fødselsdato.plusYears(1))))
                .kontoer(new Kontoer.Builder().konto(konto(FORELDREPENGER, 50)));
    ...
    void
        ...
        var grunnlag = basicGrunnlag(fødselsdato)
                ...
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(utsettelsePeriode(
                                fødselsdato.plusWeeks(7), fødselsdato.plusWeeks(100), UtsettelseÅrsak.ARBEID, null)))
    ...
    void innvilge_foreldrepenger_14_uker_før_fødsel_men_ikke_12_uker_før_termin_ved_terminsøknad() {
        ...
        var fpff = forVanligPeriode(
                ...
                null,
                null);
        var fp2 = forVanligPeriode(FORELDREPENGER, termin, termin.plusWeeks(4), null, false, null, null, null, null);
        var testGrunnlag = basicGrunnlag()
                ...
                .kontoer(new Kontoer.Builder()
                        .konto(new Konto.Builder().type(FORELDREPENGER).trekkdager(1000)))
    ...
    void skal_delvis_innvilge_med_periode_før_etter_start_ny_stønadsperiode() {
        ...
        var grunnlag = basicGrunnlag()
                .datoer(datoer(fødselsdato).startdatoNesteStønadsperiode(nesteStønadsperiode))
                .rettOgOmsorg(beggeRett())
                .behandling(farBehandling())
                .søknad(søknad(
                        Søknadstype.FØDSEL,
    ...
    void to_tette_skal_innvilge_med_periode_etter_start_ny_stønadsperiode_gjenstående_minsterett() {
        ...
        assertThat(resultat).hasSize(5);
        assertThat(resultat.stream()
                        .filter(r -> Perioderesultattype.AVSLÅTT.equals(
    ...
    void to_tette_bfhr_redusert_minsterett_oppbrukt_før_start_ny_sak() {
        ...
        var grunnlag = basicGrunnlag()
                ...
                .behandling(farBehandling())
                .kontoer(new Kontoer.Builder()
                        .konto(new Konto.Builder().type(FORELDREPENGER).trekkdager(40 * 5))
        ...
        assertThat(resultat).hasSize(4);
        assertThat(resultat.stream()
                        .filter(r -> IkkeOppfyltÅrsak.BARE_FAR_RETT_IKKE_SØKT.equals(
    ...
    void bare_far_har_rett_skal_innvilge_to_uker_rundt_fødsel_deretter_minsterett() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(forVanligPeriode(
                                FORELDREPENGER,
    ...
    void bare_far_har_rett_skal_innvilge_minsterett_men_ikke_etter_barns_død_selv_om_dager_igjen() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                .datoer(datoer(fødselsdato)
                        .termin(fødselsdato)
                        .dødsdatoer(
                                new Dødsdatoer.Builder().barnsDødsdato(dødsdato).alleBarnDøde(true)))
                .behandling(farBehandling())
                .rettOgOmsorg(bareFarRett())
                .kontoer(new Kontoer.Builder()
                        .konto(new Konto.Builder().type(FORELDREPENGER).trekkdager(5 * 40))
    ...
    void bare_far_har_rett_skal_innvilge_minsterett_men_ikke_etter_ny_stønad_selv_om_dager_igjen() {
        ...
        var nestesakStartDato =
                fødselsdato.plusWeeks(41); // TOTETTE <= 45 uker (stønadsperiode begynner 3 uker før fødsel). OBS
