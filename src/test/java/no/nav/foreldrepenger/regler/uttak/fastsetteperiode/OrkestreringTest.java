...
class OrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void skal_innvilge_to_perioder_med_med_mødrekvote_på_under_10_uker() {
        ...
        resultat.stream()
                ...
                .forEach(
                        uttakPeriode ->
                                assertThat(uttakPeriode.getPerioderesultattype())
    ...
    void skal_knekke_mødrekvote_dersom_det_ikke_er_flere_dager_igjen() {
        ...
        assertThat(uttakPerioder.get(0).getPerioderesultattype())
                .isEqualTo(Perioderesultattype.INNVILGET);
        ...
        assertThat(uttakPerioder.get(1).getPerioderesultattype())
                .isEqualTo(Perioderesultattype.INNVILGET);
        ...
        assertThat(uttakPerioder.get(2).getPerioderesultattype())
                .isEqualTo(Perioderesultattype.INNVILGET);
        ...
        assertThat(uttakPerioder.get(3).getManuellbehandlingårsak())
    ...
    void helePeriodenUtenforSøknadsfrist() {
        ...
        assertThat(førFødsel.get().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.SØKNADSFRIST);

        var avslåttMødrekvote =
                resultat.stream()
                        .map(FastsettePeriodeResultat::uttakPeriode)
        ...
        assertThat(avslåttMødrekvote.get().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.SØKNADSFRIST);
    }
    ...
    void skalKnekkePeriodenVedGrenseForSøknadsfrist() {
        ...
        var mødrekvote =
                forVanligPeriode(
                        ...
                        null);
        var grunnlag =
                basicGrunnlagMor(fødselsdato).søknad(søknad(Søknadstype.FØDSEL, fpff, mødrekvote));
        ...
        assertThat(mødrekvoteFørKnekk.getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.SØKNADSFRIST);
    ...
    void skal_ikke_innvilge_etter_eller_på_barnets_3årsdag_selv_om_det_er_nok_på_saldoen() {
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                ...
                                                fødselsdato.minusDays(1)),
                                        oppgittPeriode(
                                                MØDREKVOTE, fødselsdato, fødselsdato.plusYears(4))))
                        .arbeid(
                                new Arbeid.Builder()
        ...
        assertThat(resultat.get(0).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.INNVILGET);
        ...
        assertThat(resultat.get(1).uttakPeriode().getTom())
        ...
        assertThat(resultat.get(2).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusYears(3).minusDays(1));
        assertThat(resultat.get(2).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.INNVILGET);
        ...
        assertThat(resultat.get(3).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD_1))
    ...
    void skal_ikke_innvilge_periode_som_starter_på_barnets_3årsdag_eller_som_starter_senere() {
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                MØDREKVOTE,
                                                fødselsdato,
                                                fødselsdato.plusYears(3).minusDays(1)),
                                        oppgittPeriode(
                                                FELLESPERIODE,
                                                fødselsdato.plusYears(3),
                                                fødselsdato.plusYears(4).minusDays(1)),
                                        oppgittPeriode(
                                                MØDREKVOTE,
                                                fødselsdato.plusYears(4),
                                                fødselsdato.plusYears(5))))
                        .arbeid(
                                new Arbeid.Builder()
                                        .arbeidsforhold(new Arbeidsforhold(ARBEIDSFORHOLD_1)))
                        .kontoer(kontoer)
        ...
        assertThat(resultat.get(3).uttakPeriode().getFom()).isEqualTo(fødselsdato.plusYears(3));
        assertThat(resultat.get(3).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusYears(4).minusDays(1));
        assertThat(resultat.get(3).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.AVSLÅTT);
        ...
        assertThat(resultat.get(4).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.AVSLÅTT);
    }

    @Test
    void
            skal_avslå_første_del_pga_manglende_omsorg_og_andre_del_pga_tom_på_kvote_siden_dager_trekkes() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        ...
        assertThat(uttakPeriode1.getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.FAR_HAR_IKKE_OMSORG);
        ...
        assertThat(uttakPeriode2.getPeriodeResultatÅrsak())
    ...
    void UT1290_skal_være_ugyldige_stønadskonto_hvis_søker_på_konto_som_man_ikke_har_tilgang_til() {
        ...
        assertThat(resultat.get(2).uttakPeriode().getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.UGYLDIG_STØNADSKONTO);
        assertThat(resultat.get(2).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN);
        assertThat(resultat.get(2).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1).decimalValue())
                .isNotZero();
        assertThat(resultat.get(2).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD_1))
                .isEqualTo(Utbetalingsgrad.ZERO);
    }

    @Test
    void skal_knekke_periode_og_gå_til_manuell_behandling_ved_ikke_nok_flerbarnsdager() {
        var aktivitetIdentifikator =
                AktivitetIdentifikator.forArbeid(new Orgnummer("1234"), "12345");

        var fødselsdato = LocalDate.of(2019, 3, 13);
        var tom = Virkedager.plusVirkedager(fødselsdato.plusWeeks(6), 5);
        var annenPartPeriode1 =
                AnnenpartUttakPeriode.Builder.uttak(
                ...
                AnnenpartUttakPeriode.Builder.uttak(
                        ...
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        ...
                                        Utbetalingsgrad.TEN))
                        .build();
        var annenPartPeriode3 =
                AnnenpartUttakPeriode.Builder.uttak(fødselsdato.plusWeeks(6), tom)
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        aktivitetIdentifikator,
                                        Stønadskontotype.FELLESPERIODE,
                                        new Trekkdager(
                                                Virkedager.beregnAntallVirkedager(
                                                        fødselsdato.plusWeeks(6), tom)),
                                        Utbetalingsgrad.TEN))
                        .build();
        var kontoer =
                new Kontoer.Builder()
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                ...
                                                null)))
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(annenPartPeriode1)
    ...
    @Test
    void
            skal_håndtere_at_både_flerbarnsdager_og_foreldrepenger_kvote_går_tom_i_samme_søknadsperiode_på_forskjellig_dato() {
        var fødselsdato = LocalDate.of(2019, 3, 13);
    ...
    void skal_gå_til_avslag_når_søker_er_tom_for_sine_konto_mor() {
        ...
        var uttakPeriode =
                resultat.get(4)
                        .uttakPeriode(); // henter ut den siste perioden, som skal gå til avslag
        assertThat(uttakPeriode.getStønadskontotype()).isEqualTo(Stønadskontotype.MØDREKVOTE);
        assertThat(uttakPeriode.getPerioderesultattype()).isEqualTo(Perioderesultattype.AVSLÅTT);
        assertThat(uttakPeriode.getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN);
    }
    ...
    void skal_filtrere_bort_perioden_som_kun_er_helg() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var periodeSomKunErHelg =
                oppgittPeriode(
                        MØDREKVOTE,
                        fødselsdato.plusWeeks(6).plusDays(5),
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                MØDREKVOTE,
                                                fødselsdato.plusWeeks(6),
                                                fødselsdato.plusWeeks(6).plusDays(4)),
                                        periodeSomKunErHelg,
                                        oppgittPeriode(
                                                MØDREKVOTE,
    ...
    void skal_gå_til_avslag_når_søker_er_tom_for_sine_konto_far() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var kontoer =
                new Kontoer.Builder().konto(konto(FEDREKVOTE, 15)).konto(konto(FELLESPERIODE, 50));
        var søknad =
                søknad(
                        Søknadstype.FØDSEL,
                        oppgittPeriode(
                                FEDREKVOTE,
                                fødselsdato.plusWeeks(6),
                                fødselsdato.plusWeeks(9).minusDays(1)),
                        oppgittPeriode(
                                FEDREKVOTE,
        ...
        assertThat(uttakPeriode.getPerioderesultattype())
                .isEqualTo(Perioderesultattype.MANUELL_BEHANDLING);
        assertThat(uttakPeriode.getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.STØNADSKONTO_TOM);
        assertThat(uttakPeriode.getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN);
    }
    ...
    void skal_gå_regne_ubetalingsprosent_ut_fra_samtidig_uttaksprosent_hvis_ikke_gradering() {
        ...
        var kontoer =
                new Kontoer.Builder()
                        .konto(konto(FORELDREPENGER_FØR_FØDSEL, 3 * 5))
        ...
        assertThat(periodeMedSamtidigUttak.getUtbetalingsgrad(ARBEIDSFORHOLD_1))
    ...
    void skal_gå_regne_trekkdager_ut_fra_samtidig_uttaksprosent_hvis_ikke_gradering() {
        ...
        assertThat(periodeMedSamtidigUttak.getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(8));
    }
    ...
    void oppholdsperiode_skal_knekke_og_bevare_årsaken() {
        ...
        assertThat(resultat).hasSize(4);
        assertThat(resultat.get(2).uttakPeriode().getOppholdÅrsak())
                .isEqualTo(OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER);
        assertThat(resultat.get(3).uttakPeriode().getOppholdÅrsak())
                .isEqualTo(OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER);
    }
    ...
    void skal_knekke_på_riktig_dato_når_konto_går_tom_og_periode_har_samtidig_uttak() {
        ...
        assertThat(resultat.get(resultat.size() - 1).uttakPeriode().getFom())
                .isEqualTo(LocalDate.of(2019, 4, 30));
        assertThat(resultat.get(resultat.size() - 1).uttakPeriode().getTom())
                .isEqualTo(sisteUttaksdato);
    }
    ...
    void far_skal_kunne_få_overført_perioder_fra_mor_i_revurdering_med_endringsdato() {
        ...
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        ...
                        .datoer(datoer(fødselsdato))
                        .behandling(
                                new Behandling.Builder().søkerErMor(true).berørtBehandling(true))
                        .rettOgOmsorg(beggeRett())
                        .revurdering(
                                new Revurdering.Builder().endringsdato(LocalDate.of(2019, 3, 4)))
                        // far har fått overført mange dager av mor. Det er noen dager igjen til
                        // mor. Skal avslå alle mors perioder og ikke trekk dager
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(
                                                AnnenpartUttakPeriode.Builder.uttak(
        ...
        var resultat = fastsettPerioder(grunnlag);
        assertThat(resultat).hasSize(2);
        assertThat(resultat.get(0).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1).decimalValue())
                .isZero();
        assertThat(
                        resultat.get(0)
                                .uttakPeriode()
                                .getUtbetalingsgrad(ARBEIDSFORHOLD_1)
                                .decimalValue())
                .isZero();
        assertThat(resultat.get(1).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1).decimalValue())
                .isZero();
        assertThat(
                        resultat.get(1)
                                .uttakPeriode()
    ...
    void skal_knekke_på_riktig_dato_når_flerbarnskonto_går_tom() {
        ...
        var resultat = fastsettPerioder(grunnlag);
        assertThat(resultat).hasSize(2);
        // Flerbarnsdager går tom, trekkdager satt til 5 dager som er resten av flerbansdager
        // kontoen
        assertThat(resultat.get(0).uttakPeriode().getFom()).isEqualTo(fødselsdato.plusWeeks(6));
        assertThat(resultat.get(0).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(7).minusDays(1));
        assertThat(resultat.get(0).uttakPeriode().getPerioderesultattype()).isEqualTo(INNVILGET);
        assertThat(resultat.get(0).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        FORELDREPENGER,
                                                        fødselsdato.plusWeeks(6).plusDays(1),
    ...
    void søknadsfrist_ikke_trekke_dager_etter_at_konto_er_tom() {
        ...
        assertThat(resultat.get(1).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(20));
        assertThat(resultat.get(2).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
    ...
    @Test
    void
            utsettelse_som_går_til_manuell_behandling_skal_ikke_trekke_dager_hvis_dager_igjen_på_bare_ett_av_to_arbeidsforhold_selv_om_sluttpunkt_trekker_dager() {
        var fødselsdato = LocalDate.of(2018, 6, 14);
        var arbeidsforhold1 = new Arbeidsforhold(ARBEIDSFORHOLD_1);
        var arbeidsforhold2 = new Arbeidsforhold(ARBEIDSFORHOLD_2);
        var grunnlag =
                                ...
                                new Arbeid.Builder()
                                        ...
                                        .endringAvStilling(
                                                new EndringAvStilling(
                                                        fødselsdato, BigDecimal.valueOf(75))))
                        .søknad(
                                new Søknad.Builder()
                                        .type(Søknadstype.FØDSEL)
                                        .oppgittPeriode(
        ...
        assertThat(resultat.get(2).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(Trekkdager.ZERO);
        assertThat(resultat.get(2).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_2))
                .isEqualTo(Trekkdager.ZERO);
    ...
    void innvilge_foreldrepenger_14_uker_før_fødsel_men_ikke_12_uker_før_termin_ved_terminsøknad() {
        ...
        var fp =
                forVanligPeriode(
                        FORELDREPENGER,
                        termin.minusWeeks(15),
                        termin.minusWeeks(3).minusDays(1),
                        null,
                        false,
                        null,
                        null,
        ...
        var testGrunnlag =
                basicGrunnlag()
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        .type(Søknadstype.TERMIN)
                                        .oppgittePerioder(List.of(fp, fpff, fp2)));
        ...
        assertThat(resultater.get(0).uttakPeriode().getTom())
                .isEqualTo(termin.minusWeeks(12).minusDays(1));
        assertThat(resultater.get(0).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultater.get(0).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD))
                .isEqualTo(Trekkdager.ZERO);
    ...
    void skal_innvilge_med_privatperson_som_arbeidsgiver() {
        ...
        assertThat(resultat)
                ...
                .allMatch(
                        p ->
                                p.uttakPeriode()
                                        .getPerioderesultattype()
                                        .equals(Perioderesultattype.INNVILGET));
    }
    ...
    void skal_delvis_innvilge_med_periode_før_etter_start_ny_stønadsperiode() {
        ...
        var grunnlag =
                basicGrunnlag()
                        .datoer(
                                datoer(fødselsdato)
                                        .startdatoNesteStønadsperiode(nesteStønadsperiode))
                        .rettOgOmsorg(beggeRett())
                        .behandling(farBehandling())
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                FEDREKVOTE,
                                                nesteStønadsperiode.minusWeeks(5),
                                                nesteStønadsperiode.plusWeeks(5).minusDays(1))));
        ...
        assertThat(avslått.getPeriodeResultatÅrsak())
                ...
                basicGrunnlag()
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                FEDREKVOTE,
                                                nesteStønadsperiode.minusWeeks(18),
                                                nesteStønadsperiode.minusWeeks(8).minusDays(1))));
                ...
                basicGrunnlag()
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                FEDREKVOTE,
                                                nesteStønadsperiode.plusWeeks(1),
                                                nesteStønadsperiode.plusWeeks(11).minusDays(1))));

        var resultat = fastsettPerioder(grunnlag);

        assertThat(resultat).hasSize(1);
        assertThat(resultat.get(0).uttakPeriode().getPerioderesultattype()).isEqualTo(AVSLÅTT);
        assertThat(resultat.get(0).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.UTTAK_ETTER_NY_STØNADSPERIODE);
    }
    ...
    void to_tette_skal_innvilge_med_periode_etter_start_ny_stønadsperiode_gjenstående_minsterett() {
                ...
                basicGrunnlag()
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                FELLESPERIODE,
                                                nesteStønadsperiode.minusWeeks(4),
                                                nesteStønadsperiode.plusWeeks(12).minusDays(1))));
        ...
        assertThat(
                        resultat.stream()
                                .filter(
                                        r ->
                                                Perioderesultattype.AVSLÅTT.equals(
                                                        r.uttakPeriode().getPerioderesultattype()))
                                .count())
                .isEqualTo(1);
        ...
        assertThat(resultat.get(3).uttakPeriode().getTom())
                .isEqualTo(nesteStønadsperiode.plusWeeks(3).minusDays(1));
        assertThat(resultat.get(4).uttakPeriode().getPerioderesultattype()).isEqualTo(AVSLÅTT);
        assertThat(resultat.get(4).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.UTTAK_ETTER_NY_STØNADSPERIODE);
    }
    ...
    void to_tette_skal_avslå_med_periode_etter_start_ny_stønadsperiode_oppbrukt_minsterett() {
                ...
                basicGrunnlag()
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                FEDREKVOTE,
                                                nesteStønadsperiode.minusWeeks(12),
                                                nesteStønadsperiode.minusWeeks(2).minusDays(1)),
                                        oppgittPeriode(
                                                FEDREKVOTE,
                                                nesteStønadsperiode,
                                                nesteStønadsperiode.plusWeeks(5).minusDays(1))));
        ...
        assertThat(
                        resultat.stream()
                                ...
                                .count())
                .isEqualTo(1);
        // Periode 0 er 8 uker FK innenfor minsteretten. Det var søkt om 10 uker men perioden blir
        // knekt etter 8 uker pga minsterett
        // Periode 1 er 2 uker FK utenfor minsteretten. Det var søkt om 10 uker og dette er
        // restperioden på 2 uker
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype()).isEqualTo(INNVILGET);
        assertThat(resultat.get(1).uttakPeriode().getFom())
                .isEqualTo(nesteStønadsperiode.minusWeeks(4));
        assertThat(resultat.get(1).uttakPeriode().getTom())
                .isEqualTo(nesteStønadsperiode.minusWeeks(2).minusDays(1));
    ...
    void to_tette_bfhr_redusert_minsterett_oppbrukt_før_start_ny_sak() {
        ...
        assertThat(
                        resultat.stream()
                                .filter(
                                        r ->
                                                IkkeOppfyltÅrsak.BARE_FAR_RETT_IKKE_SØKT.equals(
                                                        r.uttakPeriode().getPeriodeResultatÅrsak()))
                                .count())
                .isEqualTo(2); // MSP
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype()).isEqualTo(INNVILGET);
        assertThat(resultat.get(1).uttakPeriode().getFom())
                .isEqualTo(nesteStønadsperiode.minusWeeks(12));
        assertThat(resultat.get(1).uttakPeriode().getTom())
                .isEqualTo(nesteStønadsperiode.minusWeeks(2).minusDays(1));
        assertThat(resultat.get(3).uttakPeriode().getPerioderesultattype()).isEqualTo(AVSLÅTT);
    ...
    void to_tette_bfhr_redusert_minsterett_oppbrukt_etter_start_ny_sak() {
                        ...
                        .søknad(
                                søknad(
                                        ...
                                        oppgittPeriode(
                                                FORELDREPENGER,
                                                nesteStønadsperiode.minusWeeks(12),
                                                nesteStønadsperiode.minusWeeks(6).minusDays(1)),
                                        oppgittPeriode(
                                                FORELDREPENGER,
                                                nesteStønadsperiode.plusWeeks(8),
                                                nesteStønadsperiode.plusWeeks(9).minusDays(1)),
                                        oppgittPeriode(
                                                FORELDREPENGER,
                                                nesteStønadsperiode.plusWeeks(15),
                                                nesteStønadsperiode.plusWeeks(18).minusDays(1))));
        ...
        assertThat(resultat.get(1).uttakPeriode().getFom())
                .isEqualTo(nesteStønadsperiode.minusWeeks(12));
        assertThat(resultat.get(1).uttakPeriode().getTom())
                .isEqualTo(nesteStønadsperiode.minusWeeks(6).minusDays(1));
        assertThat(resultat.get(3).uttakPeriode().getPerioderesultattype()).isEqualTo(AVSLÅTT);
        assertThat(resultat.get(3).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.UTTAK_ETTER_NY_STØNADSPERIODE); // MSP
        assertThat(resultat.get(4).uttakPeriode().getPerioderesultattype()).isEqualTo(INNVILGET);
        assertThat(resultat.get(4).uttakPeriode().getFom())
                .isEqualTo(nesteStønadsperiode.plusWeeks(8));
        assertThat(resultat.get(4).uttakPeriode().getTom())
                .isEqualTo(nesteStønadsperiode.plusWeeks(9).minusDays(1));
        ...
        assertThat(resultat.get(6).uttakPeriode().getFom())
                .isEqualTo(nesteStønadsperiode.plusWeeks(15));
        assertThat(resultat.get(6).uttakPeriode().getTom())
                .isEqualTo(nesteStønadsperiode.plusWeeks(16).minusDays(1));
        ...
        assertThat(resultat.get(7).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.UTTAK_ETTER_NY_STØNADSPERIODE); // Vanlig avslag
    }
    ...
    void bare_far_har_rett_skal_innvilge_to_uker_rundt_fødsel_deretter_minsterett() {
                                ...
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                forVanligPeriode(
                                                        ...
                                                        fødselsdato.plusWeeks(58).minusDays(1),
                                                        null,
                                                        false,
                                                        fødselsdato,
                                                        fødselsdato,
        ...
        assertThat(resultat.get(0).uttakPeriode().getPerioderesultattype())
                .isEqualTo(INNVILGET); // Før fødsel P1
        assertThat(resultat.get(0).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(3));
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype())
                .isEqualTo(INNVILGET); // Etter Fødsel P1
        assertThat(resultat.get(1).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(10));
        assertThat(resultat.get(2).uttakPeriode().getPerioderesultattype())
                .isEqualTo(INNVILGET); // Etter Fødsel P2
        assertThat(resultat.get(2).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(5));
        assertThat(resultat.get(3).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.BARE_FAR_RETT_IKKE_SØKT); // MSP
        assertThat(resultat.get(4).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.BARE_FAR_RETT_IKKE_SØKT); // MSP
        assertThat(resultat.get(5).uttakPeriode().getPerioderesultattype())
                .isEqualTo(INNVILGET); // Minsterett
        assertThat(resultat.get(5).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(22)); // Minsterett
        assertThat(resultat.get(6).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN); // Oppbrukt minsterett
    }
    ...
    void bare_far_har_rett_skal_innvilge_minsterett_men_ikke_etter_barns_død_selv_om_dager_igjen() {
                ...
                RegelGrunnlagTestBuilder.create()
                        .datoer(
                                datoer(fødselsdato)
                                        .termin(fødselsdato)
                                        .dødsdatoer(
                                                new Dødsdatoer.Builder()
                                                        .barnsDødsdato(dødsdato)
                                                        .alleBarnDøde(true)))
                        .behandling(farBehandling())
                        .rettOgOmsorg(bareFarRett())
                        .kontoer(
                                ...
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                forVanligPeriode(
                                                        FORELDREPENGER,
                                                        fødselsdato.plusWeeks(2),
                                                        fødselsdato.plusWeeks(4).minusDays(1),
                                                        null,
                                                        false,
                                                        fødselsdato,
                                                        fødselsdato,
                                        ...
                                        .oppgittPeriode(
                                                forVanligPeriode(
                                                        ...
                                                        fødselsdato.plusWeeks(29).minusDays(1),
                                                        null,
                                                        false,
                                                        fødselsdato,
                                                        fødselsdato,
        ...
        assertThat(resultat.get(0).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(10));
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype())
                .isEqualTo(AVSLÅTT); // MSP fom uke 6
        assertThat(resultat.get(1).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager((15 - 6) * 5));
        assertThat(resultat.get(2).uttakPeriode().getPerioderesultattype())
                .isEqualTo(INNVILGET); // Etter Fødsel P2
        assertThat(resultat.get(2).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(5));
        assertThat(resultat.get(3).uttakPeriode().getPerioderesultattype())
                .isEqualTo(MANUELL_BEHANDLING); // Fom dødsdato + 6 uker
        assertThat(resultat.get(3).uttakPeriode().getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.DØDSFALL);
        assertThat(resultat.get(3).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.BARN_DØD);
        assertThat(resultat.get(4).uttakPeriode().getPerioderesultattype())
                .isEqualTo(MANUELL_BEHANDLING);
        assertThat(resultat.get(5).uttakPeriode().getPerioderesultattype())
                .isEqualTo(MANUELL_BEHANDLING);
    ...
    void bare_far_har_rett_skal_innvilge_minsterett_men_ikke_etter_ny_stønad_selv_om_dager_igjen() {
        // Søkt samme dag, men mor har søkt etter far
        var fødselsdato = LocalDate.of(2022, 10, 6);
        var nestesakStartDato =
                fødselsdato.plusWeeks(
                        41); // TOTETTE <= 45 uker (stønadsperiode begynner 3 uker før fødsel). OBS
        // neste sak kan begyynne langt senere
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        .datoer(
                                datoer(fødselsdato)
                                        .termin(fødselsdato)
                                        .startdatoNesteStønadsperiode(nestesakStartDato))
                        .behandling(farBehandling())
                        .rettOgOmsorg(bareFarRett())
                        .kontoer(
                                new Kontoer.Builder()
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                forVanligPeriode(
                                                        FORELDREPENGER,
                                                        fødselsdato.plusWeeks(40),
                                                        fødselsdato.plusWeeks(43).minusDays(1),
                                                        null,
                                                        false,
                                                        fødselsdato,
                                                        fødselsdato,
        ...
        assertThat(resultat).hasSize(5);
        assertThat(resultat.get(0).uttakPeriode().getPerioderesultattype())
                .isEqualTo(AVSLÅTT); // MSP
        assertThat(resultat.get(0).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager((15 - 6) * 5));
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype())
                .isEqualTo(INNVILGET); // Uttak 9 uker
        assertThat(resultat.get(1).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager((24 - 15) * 5));
        assertThat(resultat.get(2).uttakPeriode().getPerioderesultattype())
                .isEqualTo(AVSLÅTT); // MSP
        assertThat(resultat.get(2).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager((40 - 24) * 5));
        assertThat(resultat.get(3).uttakPeriode().getPerioderesultattype())
                .isEqualTo(INNVILGET); // Fom ny stønad - en uke mellom fom og ny stønad
        assertThat(resultat.get(3).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(new Trekkdager(5));
        assertThat(resultat.get(4).uttakPeriode().getPerioderesultattype()).isEqualTo(AVSLÅTT);
        assertThat(resultat.get(4).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD_1))
                .isEqualTo(Trekkdager.ZERO);
    }
