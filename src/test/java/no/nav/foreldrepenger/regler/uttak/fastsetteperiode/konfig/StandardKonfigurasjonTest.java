...
class StandardKonfigurasjonTest {
    ...
    void test_standard_konfiguration() {
        assertThat(Konfigurasjon.STANDARD.getParameter(
                        Parametertype.FORBEHOLDT_MOR_ETTER_FØDSEL_UKER, LocalDate.of(2017, 12, 5)))
                .isEqualTo(6);
        assertThat(Konfigurasjon.STANDARD.getParameter(
                        Parametertype.FORBEHOLDT_MOR_ETTER_FØDSEL_UKER, LocalDate.of(2017, 12, 5)))
                .isEqualTo(6);
    ...
    void hent_parameter_utenfor_periode_skal_gi_exception() {
        assertThrows(
                ...
                () -> Konfigurasjon.STANDARD.getParameter(
                        Parametertype.FORBEHOLDT_MOR_ETTER_FØDSEL_UKER, LocalDate.of(1970, 12, 5)));
    }
}
