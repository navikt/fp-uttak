...
class SaldoUtregningFlerbarnsdagerTest {
    ...
    void skal_bare_trekke_flerbarnsdager_fra_perioder_med_flerbarnsdager_med_minsterett_hvis_perioden_trekker_minsterett() {
        ...
        var periode1 = new FastsattUttakPeriode.Builder()
                ...
                .aktiviteter(List.of(new FastsattUttakPeriodeAktivitet(new Trekkdager(5), Stønadskontotype.FORELDREPENGER,
        ...
        var periode2 = new FastsattUttakPeriode.Builder()
                ...
                .aktiviteter(List.of(new FastsattUttakPeriodeAktivitet(new Trekkdager(5), Stønadskontotype.FORELDREPENGER,
                        aktivitetIdentifikator)))
                .build();
        var saldoUtregning = new SaldoUtregningFlerbarnsdager(List.of(periode1, periode2), List.of(),
                Set.of(aktivitetIdentifikator), new Trekkdager(10), new Trekkdager(10));
    ...
    void skal_alltid_trekke_flerbarnsdager_fra_perioder_med_flerbarnsdager_hvis_uten_minsterett() {
        ...
        var periode2 = new FastsattUttakPeriode.Builder()
                ...
                .build();
        var saldoUtregning = new SaldoUtregningFlerbarnsdager(List.of(periode1, periode2), List.of(),
                Set.of(aktivitetIdentifikator), new Trekkdager(10), Trekkdager.ZERO);
