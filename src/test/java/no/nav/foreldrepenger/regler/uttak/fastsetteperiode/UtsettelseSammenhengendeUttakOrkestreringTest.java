...
class UtsettelseSammenhengendeUttakOrkestreringTest
    ...
    void periode_med_gyldig_utsettelse_pga_arbeid_skal_innvilges() {
                                ...
                                new Arbeid.Builder()
                                        ...
                                        .endringAvStilling(
                                                new EndringAvStilling(
                                                        fødselsdato, BigDecimal.valueOf(100))))
                        .kontoer(kontoer)
                        .søknad(
                                fødselSøknad()
                                        .oppgittPeriode(
        ...
        assertThat(uttakPeriode.getPerioderesultattype()).isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(uttakPeriode.getTrekkdager(arbeidsforhold.identifikator()))
    ...
    void UT1110_periode_med_utsettelse_pga_arbeid_med_50_prosent_stilling_skal_manuell_behandles() {
                ...
                basicUtsettelseGrunnlag(fødselsdato)
                        ...
                        .arbeid(
                                new Arbeid.Builder()
                                        ...
                                        .endringAvStilling(
                                                new EndringAvStilling(
                                                        utsettelseFom, BigDecimal.valueOf(50))));
        ...
        assertThat(uttakPeriode.getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.IKKE_HELTIDSARBEID);
    ...
    @Test
    void
            periode_med_utsettelse_pga_ferie_skal_til_manuell_behandling_grunnet_bevegelige_helligdager() {
        ...
        assertThat(uttakPeriode.getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.UTSETTELSE_FERIE_PÅ_BEVEGELIG_HELLIGDAG);
        assertThat(uttakPeriode.getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.IKKE_GYLDIG_GRUNN_FOR_UTSETTELSE);
    ...
    @Test
    void
            flere_perioder_med_utsettelse_pga_ferie_skal_til_manuell_behandling_grunnet_bevegelige_helligdager() {
        var fødselsdato = LocalDate.of(2018, 1, 15);
        var grunnlag =
                basicUtsettelseGrunnlag(fødselsdato)
                        .søknad(
                                fødselSøknad()
                                        ...
                                        .oppgittPeriode(
                                                utsettelsePeriode(
                                                        ...
                                                        fødselsdato.plusWeeks(18).minusDays(1),
                                                        FERIE,
                                                        null)));
    ...
    void utsettelse_uten_stønadskonto_på_helligdag_skal_gi_ugyldig_opphold() {
        ...
        assertThat(utsettelse.getPerioderesultattype())
                .isEqualTo(Perioderesultattype.MANUELL_BEHANDLING);
        assertThat(utsettelse.getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.IKKE_GYLDIG_GRUNN_FOR_UTSETTELSE);
        assertThat(utsettelse.getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.UTSETTELSE_FERIE_PÅ_BEVEGELIG_HELLIGDAG);
        // Utsettelse periode med UKJENT stønadskontotype er settes til neste tilgjengelige
        // stønadskontotype
    ...
    void skal_trekke_fra_mødrekvote_ved_avslag_ferie_innenfor_første_seks_uker() {
        // Søkt om ferieutsettelse innenfor seks uker etter fødsel. Utsettelsen skal avlås og det
        // skal trekkes dager fra mødrekvote
        var fødselsdato = LocalDate.of(2019, 7, 1);
        var grunnlag =
                basicUtsettelseGrunnlag(fødselsdato)
                        ...
                        .søknad(
                                fødselSøknad()
                                        ...
                                        .oppgittPeriode(
                                                utsettelsePeriode(
                                                        fødselsdato.plusWeeks(4).plusDays(1),
        ...
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.AVSLÅTT);
        assertThat(resultat.get(1).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD).decimalValue())
                .isNotZero();
        assertThat(resultat.get(1).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isNotEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultat.get(1).uttakPeriode().getStønadskontotype()).isEqualTo(MØDREKVOTE);
    }

    @Test
    void
            skal_trekke_fra_foreldrepengekvote_ved_avslag_ferie_innenfor_første_seks_uker_ved_aleneomsorg_far() {
        var fødselsdato = LocalDate.of(2019, 7, 1);
        var grunnlag =
    ...
    @Test
    void
            skal_trekke_fra_foreldrepengekvote_ved_avslag_ferie_innenfor_første_seks_uker_ved_aleneomsorg_mor() {
        var fødselsdato = LocalDate.of(2019, 7, 1);
        var grunnlag =
    ...
    void utsettelse_ved_tomme_dager_skal_også_avslås() {
        var fødselsdato = LocalDate.of(2019, 7, 1);
        var uttakAvsluttetMedUtsettelse =
                basicUtsettelseGrunnlag(fødselsdato)
                        .søknad(
                                fødselSøknad()
                                        .oppgittPeriode(
                                        ...
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        FELLESPERIODE,
                                                        fødselsdato.plusWeeks(10),
                                                        fødselsdato.plusWeeks(36).minusDays(1)))
                                        .oppgittPeriode(
                                                utsettelsePeriode(
                                                        fødselsdato.plusWeeks(36),
                                                        fødselsdato.plusWeeks(37).minusDays(1),
                                                        FERIE,
                                                        null))
                                        .oppgittPeriode(
                                                utsettelsePeriode(
                                                        fødselsdato.plusWeeks(37),
        ...
        assertThat(resultat.get(3).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultat.get(3).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD))
                .isEqualTo(Trekkdager.ZERO);
        ...
        assertThat(resultat.get(4).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultat.get(4).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD))
                .isEqualTo(Trekkdager.ZERO);
                ...
                basicGrunnlagFar(fødselsdato)
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        .type(FØDSEL)
                                        .oppgittPeriode(
                                                utsettelsePeriode(hvFom, hvTom, HV_OVELSE, null)));
                ...
                basicGrunnlagFar(fødselsdato)
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(
                                                AnnenpartUttakPeriode.Builder.uttak(
                                                                fødselsdato, tiltakFom.minusDays(1))
                                                        .innvilget(true)
                                                        .uttakPeriodeAktivitet(
                                                                new AnnenpartUttakPeriodeAktivitet(
                                                                        AktivitetIdentifikator
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        ...
                                        .oppgittPeriode(
                                                utsettelsePeriode(
                                                        tiltakFom, tiltakTom, NAV_TILTAK, null)));
    ...
    void bfhr_utsettelse_som_trenger_dok_og_aktivitetskrav_vurdering_skal_gå_til_manuell() {
        ...
        assertThat(perioder.get(1).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.MANUELL_BEHANDLING);
        assertThat(perioder.get(1).uttakPeriode().getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.AKTIVITEKTSKRAVET_MÅ_SJEKKES_MANUELT);

        assertThat(perioder.get(2).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.MANUELL_BEHANDLING);
        assertThat(perioder.get(2).uttakPeriode().getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.AKTIVITEKTSKRAVET_MÅ_SJEKKES_MANUELT);

        assertThat(perioder.get(3).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.MANUELL_BEHANDLING);
        assertThat(perioder.get(3).uttakPeriode().getManuellbehandlingårsak())
                .isEqualTo(Manuellbehandlingårsak.AKTIVITEKTSKRAVET_MÅ_SJEKKES_MANUELT);
    }

    private void assertDeTreFørstePeriodene(
            List<FastsettePeriodeResultat> resultat, LocalDate fødselsdato) {
    ...
    private RegelGrunnlag.Builder aleneomsorgUtsettelseGrunnlag(
            LocalDate fødselsdato, Behandling.Builder behandling) {
        var kontoer =
                new Kontoer.Builder()
                        .konto(new Konto.Builder().type(FORELDREPENGER).trekkdager(130));
