...
class UtsettelseSammenhengendeUttakOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void periode_med_gyldig_utsettelse_pga_arbeid_skal_innvilges() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato)
                .arbeid(new Arbeid.Builder()
                        ...
                        .endringAvStilling(new EndringAvStilling(fødselsdato, BigDecimal.valueOf(100))))
                .kontoer(kontoer)
                .søknad(fødselSøknad()
                        .oppgittPeriode(oppgittPeriode(
                                FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato.minusDays(1)))
    ...
    void UT1110_periode_med_utsettelse_pga_arbeid_med_50_prosent_stilling_skal_manuell_behandles() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato)
                ...
                .arbeid(new Arbeid.Builder()
                        .arbeidsforhold(arbeidsforhold)
                        .endringAvStilling(new EndringAvStilling(utsettelseFom, BigDecimal.valueOf(50))));
    ...
    void utsettelse_uten_stønadskonto_på_helligdag_skal_gi_ugyldig_opphold() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato)
                .søknad(fødselSøknad()
                        ...
                        .oppgittPeriode(utsettelsePeriode(
                                LocalDate.of(2018, 12, 25), LocalDate.of(2018, 12, 25), FERIE, null)));
    ...
    void skal_trekke_fra_mødrekvote_ved_avslag_ferie_innenfor_første_seks_uker() {
        ...
        var grunnlag = basicUtsettelseGrunnlag(fødselsdato)
                ...
                .søknad(fødselSøknad()
                        ...
                        .oppgittPeriode(utsettelsePeriode(
                                fødselsdato.plusWeeks(4).plusDays(1), fødselsdato.plusWeeks(8), FERIE, null)));
    ...
    void skal_trekke_fra_foreldrepengekvote_ved_avslag_ferie_innenfor_første_seks_uker_ved_aleneomsorg_far() {
        ...
        var grunnlag = aleneomsorgUtsettelseGrunnlag(fødselsdato, farBehandling())
                .datoer(new Datoer.Builder().fødsel(fødselsdato))
                .søknad(fødselSøknad()
                        .oppgittPeriode(oppgittPeriode(FORELDREPENGER, fødselsdato, fødselsdato.plusWeeks(4)))
                        .oppgittPeriode(utsettelsePeriode(
                                fødselsdato.plusWeeks(4).plusDays(1), fødselsdato.plusWeeks(8), FERIE, null)));
    ...
    void utsettelse_ved_tomme_dager_skal_også_avslås() {
        var fødselsdato = LocalDate.of(2019, 7, 1);
        var uttakAvsluttetMedUtsettelse = basicUtsettelseGrunnlag(fødselsdato)
                .søknad(fødselSøknad()
                        .oppgittPeriode(oppgittPeriode(
                                MØDREKVOTE,
                                fødselsdato,
    ...
    void utsettelse_pga_heimevernet_skal_gå_til_manuell_hvis_ikke_dokumentert() {
        ...
        var grunnlag = basicGrunnlagFar(fødselsdato)
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(fødselsdato, hvFom.minusDays(1))
                                .innvilget(true)
                                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                                        AktivitetIdentifikator.forFrilans(),
                                        MØDREKVOTE,
    ...
    void utsettelse_pga_tiltak_i_regi_av_nav_skal_gå_til_manuell_hvis_ikke_dokumentert() {
        ...
        var grunnlag = basicGrunnlagFar(fødselsdato)
                .annenPart(new AnnenPart.Builder()
                        .uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(fødselsdato, tiltakFom.minusDays(1))
                                .innvilget(true)
                                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(
                                        AktivitetIdentifikator.forFrilans(),
                                        MØDREKVOTE,
    ...
    void avslag_utsettelse_med_trekkdager_skal_knekkes_når_saldo_går_tom() {
        ...
        var utsettelse = OppgittPeriode.forUtsettelse(
                fom, tom, ARBEID, fødselsdato, fødselsdato, MorsAktivitet.ARBEID, MORS_AKTIVITET_IKKE_GODKJENT);
        var grunnlag = basicGrunnlagFar(fødselsdato)
    ...
    void bfhr_utsettelse_som_trenger_dok_og_aktivitetskrav_vurdering_skal_gå_til_manuell() {
        ...
        var sykdom = OppgittPeriode.forUtsettelse(
                fødselsdato.plusWeeks(10),
        ...
        var innleggelse = OppgittPeriode.forUtsettelse(
        ...
        var sykdomBarn = OppgittPeriode.forUtsettelse(
                fødselsdato.plusWeeks(12),
