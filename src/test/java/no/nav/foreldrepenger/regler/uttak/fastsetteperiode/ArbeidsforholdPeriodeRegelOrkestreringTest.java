...
class ArbeidsforholdPeriodeRegelOrkestreringTest
    ...
    void skal_starte_arbeidsforhold_fra_startdato() {
        ...
        var arbeid =
                new Arbeid.Builder()
                        .arbeidsforhold(
                                new Arbeidsforhold(
                                        arbeidsforhold1, omsorgsovertakelse.minusYears(1)))
                        // Ingen startdato på arbeidsforholdet skal tolkes som at arbeidsforholdet
                        // varer hele uttaket
                        .arbeidsforhold(new Arbeidsforhold(arbeidsforhold2))
                        .arbeidsforhold(
                                new Arbeidsforhold(
                                        arbeidsforhold3, omsorgsovertakelse.plusWeeks(8)))
                        .arbeidsforhold(
                                new Arbeidsforhold(
                                        arbeidsforhold4, omsorgsovertakelse.plusWeeks(35)));
        var mødrekvote =
                oppgittPeriode(MØDREKVOTE, omsorgsovertakelse, omsorgsovertakelse.plusWeeks(40));
        var grunnlag =
                basicGrunnlag()
                        .arbeid(arbeid)
        ...
        assertThat(aktiviteterIPeriode(resultat.get(0).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1, arbeidsforhold2);
        assertThat(aktiviteterIPeriode(resultat.get(1).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1, arbeidsforhold2, arbeidsforhold3);
        assertThat(aktiviteterIPeriode(resultat.get(2).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1, arbeidsforhold2, arbeidsforhold3);
        assertThat(aktiviteterIPeriode(resultat.get(3).uttakPeriode()))
                .containsExactlyInAnyOrder(
                        arbeidsforhold1, arbeidsforhold2, arbeidsforhold3, arbeidsforhold4);
    }
    ...
    void nytt_arbeidsforhold_skal_hente_saldo_fra_eksisterende_arbeidsforhold() {
        ...
        var arbeid =
                new Arbeid.Builder()
                        ...
                        .arbeidsforhold(
                                new Arbeidsforhold(arbeidsforhold2, fødselsdato.plusWeeks(8)));
        var fpff =
                oppgittPeriode(
        ...
        assertThat(resultat).hasSize(4);
        assertThat(aktiviteterIPeriode(resultat.get(0).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1);
        assertThat(aktiviteterIPeriode(resultat.get(1).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1);
        assertThat(aktiviteterIPeriode(resultat.get(2).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1);
        assertThat(aktiviteterIPeriode(resultat.get(3).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1, arbeidsforhold2);
        assertThat(resultat.get(3).uttakPeriode().getUtbetalingsgrad(arbeidsforhold1))
                .isEqualTo(Utbetalingsgrad.HUNDRED);
        assertThat(resultat.get(3).uttakPeriode().getUtbetalingsgrad(arbeidsforhold2))
                .isEqualTo(Utbetalingsgrad.HUNDRED);
    }

    @Test
    void
            nytt_arbeidsforhold_skal_hente_saldo_fra_arbeidsforholdet_som_har_høyest_saldo_på_startdato() {
        var fødselsdato = LocalDate.of(2019, 11, 27);
        var arbeidsforhold1 = ARBEIDSFORHOLD;
        var arbeidsforhold2 = AktivitetIdentifikator.annenAktivitet();
        var arbeidsforhold3 = AktivitetIdentifikator.forFrilans();
        var arbeid =
                new Arbeid.Builder()
                        ...
                        .arbeidsforhold(new Arbeidsforhold(arbeidsforhold2))
                        .arbeidsforhold(
                                new Arbeidsforhold(arbeidsforhold3, fødselsdato.plusWeeks(10)));
        var fpff =
                oppgittPeriode(
                        FORELDREPENGER_FØR_FØDSEL,
                        fødselsdato.minusWeeks(3),
                        fødselsdato.minusDays(1));
        var mødrekvote1 =
                oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(8).minusDays(1));
        var gradertMødrekvote =
                gradertoppgittPeriode(
                        MØDREKVOTE,
                        fødselsdato.plusWeeks(8),
        ...
        assertThat(aktiviteterIPeriode(resultat.get(3).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1, arbeidsforhold2);
        // NYtt arbeidsforhold arver saldo fra arbeidsforhold 1 pga arbeidsforhold 1 har gradert i
        // perioden før
        assertThat(aktiviteterIPeriode(resultat.get(4).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1, arbeidsforhold2, arbeidsforhold3);
        assertThat(resultat.get(4).uttakPeriode().getUtbetalingsgrad(arbeidsforhold1))
                .isEqualTo(new Utbetalingsgrad(50));
        assertThat(resultat.get(4).uttakPeriode().getUtbetalingsgrad(arbeidsforhold2))
                .isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultat.get(4).uttakPeriode().getUtbetalingsgrad(arbeidsforhold3))
                .isEqualTo(Utbetalingsgrad.HUNDRED);

        // Nytt arbeidsforhold går tomt for dager, arbeidsforhold holder 1 uke til pga gradering
        assertThat(aktiviteterIPeriode(resultat.get(5).uttakPeriode()))
                .containsExactlyInAnyOrder(arbeidsforhold1, arbeidsforhold2, arbeidsforhold3);
        assertThat(resultat.get(5).uttakPeriode().getUtbetalingsgrad(arbeidsforhold1))
                .isEqualTo(new Utbetalingsgrad(50));
        assertThat(resultat.get(5).uttakPeriode().getUtbetalingsgrad(arbeidsforhold2))
                .isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(resultat.get(5).uttakPeriode().getUtbetalingsgrad(arbeidsforhold3))
                .isEqualTo(Utbetalingsgrad.ZERO);
    }

    @Test
    void
            nytt_arbeidsforhold_skal_hente_saldo_fra_arbeidsforholdet_som_har_høyest_saldo_på_startdato_2() {
        // Testen sjekker om det nye arbeidsforholdet vinner dager på at begge eksisterende
        // arbeidsforhold graderer to uker hver
        var fødselsdato = LocalDate.of(2019, 11, 27);
        var arbeidsforhold1 = ARBEIDSFORHOLD;
        var arbeidsforhold2 = AktivitetIdentifikator.annenAktivitet();
        var arbeidsforhold3 = AktivitetIdentifikator.forFrilans();
        ...
        var gradertMødrekvote1 =
                gradertoppgittPeriode(
                        ...
                        BigDecimal.valueOf(50),
                        Set.of(arbeidsforhold1));
        var gradertMødrekvote2 =
                gradertoppgittPeriode(
                        MØDREKVOTE,
                        fødselsdato.plusWeeks(8),
                        fødselsdato.plusWeeks(10).minusDays(1),
                        BigDecimal.valueOf(50),
                        Set.of(arbeidsforhold2));
        var mødrekvote2 =
                oppgittPeriode(
                        MØDREKVOTE,
    ...
    void skal_ikke_ta_hensyn_til_startdato_hvis_bare_ett_arbeidsforhold() {
        ...
        var arbeid =
                new Arbeid.Builder()
                        .arbeidsforhold(
                                new Arbeidsforhold(arbeidsforhold, fødselsdato.plusWeeks(4)));
        var fpff =
                oppgittPeriode(
                        FORELDREPENGER_FØR_FØDSEL,
                        fødselsdato.minusWeeks(3),
                        fødselsdato.minusDays(1));
        var mødrekvote =
                oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(10).minusDays(1));
        var grunnlag =
                basicGrunnlag()
                        .arbeid(arbeid)
        ...
        assertThat(aktiviteterIPeriode(resultat.get(0).uttakPeriode()))
                .containsExactly(arbeidsforhold);
        assertThat(aktiviteterIPeriode(resultat.get(1).uttakPeriode()))
                .containsExactly(arbeidsforhold);
        assertThat(aktiviteterIPeriode(resultat.get(2).uttakPeriode()))
                .containsExactly(arbeidsforhold);
    ...
    @Test
    void
            skal_kunne_lage_manglende_søkt_periode_i_periode_uten_at_søker_har_aktive_arbeidsforhold() {
        ...
        var arbeid =
                new Arbeid.Builder()
                        .arbeidsforhold(
                                new Arbeidsforhold(
                                        tilkommetArbeidsforhold1, LocalDate.of(2019, 5, 1)))
                        .arbeidsforhold(
                                new Arbeidsforhold(
                                        tilkommetArbeidsforhold2, LocalDate.of(2019, 6, 10)));
        var utsettelseArbeid =
                utsettelsePeriode(
        ...
        // manglende søkt
        assertThat(
                        resultat.get(0).uttakPeriode().getAktiviteter().stream()
                                .findFirst()
                                .orElseThrow()
                                .getIdentifikator())
