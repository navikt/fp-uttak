...
class AvslagAktivitetskravOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void mor_med_bekreftet_uføretrygd_skal_avslås() {
        ...
        assertThat(fastsattePerioder
                        .get(1)
                        .uttakPeriode()
                        .getTrekkdager(ARBEIDSFORHOLD)
                        .merEnn0())
                .isTrue();
    }
    ...
    void ukjent_mors_aktivitet_fri_utsettelse_foreldrepenger_skal_avslås_hvis_minsterett_ikke_dokumentert() {
        ...
        var utsettelse1 = OppgittPeriode.forUtsettelse(
                ...
                null,
                null);
        var utsettelse2 = OppgittPeriode.forUtsettelse(
    ...
    void far_søker_utsettelse_sammenhengende_uttak() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var kontoer = new Kontoer.Builder().konto(konto(FORELDREPENGER, 100));
        var oppgittPeriode = OppgittPeriode.forUtsettelse(
                fødselsdato.plusWeeks(6),
                fødselsdato.plusWeeks(10),
                UtsettelseÅrsak.ARBEID,
                fødselsdato,
    ...
    private Kontoer.Builder kontoerMedFellesperiode() {
        return new Kontoer.Builder()
                .konto(new Konto.Builder().type(FELLESPERIODE).trekkdager(50));
    }
    ...
    private static Stream<Arguments> dokumentasjonOgAvslagKombinasjoner() {
        return Stream.of(
                Arguments.of(ARBEID, AKTIVITETSKRAVET_ARBEID_IKKE_OPPFYLT, MORS_AKTIVITET_IKKE_GODKJENT),
