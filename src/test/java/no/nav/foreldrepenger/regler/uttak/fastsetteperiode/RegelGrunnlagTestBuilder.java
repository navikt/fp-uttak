...
public class RegelGrunnlagTestBuilder {
    ...
    public static final AktivitetIdentifikator ARBEIDSFORHOLD_1 =
            AktivitetIdentifikator.forArbeid(new Orgnummer("000000001"), null);
    public static final AktivitetIdentifikator ARBEIDSFORHOLD_2 =
            AktivitetIdentifikator.forArbeid(new Orgnummer("000000002"), null);
    public static final AktivitetIdentifikator ARBEIDSFORHOLD_3 =
