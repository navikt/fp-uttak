...
class ToParterOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    private static final AktivitetIdentifikator FAR_ARBEIDSFORHOLD =
            RegelGrunnlagTestBuilder.ARBEIDSFORHOLD_2;
        ...
        leggPåKvoter(grunnlag)
                ...
                .annenPart(
                        new AnnenPart.Builder()
                                .uttaksperiode(
                                        lagPeriodeForFar(
                                                FELLESPERIODE, fomFarsFP, tomFarsFP, true)))
                        ...
                        new Søknad.Builder()
                                ...
                                .oppgittPeriode(
                                        oppgittPeriode(
                                                ...
                                                fødselsdato.minusWeeks(UKER_FPFF),
                                ...
                                .oppgittPeriode(
                                        oppgittPeriode(FELLESPERIODE, fomMorsFP, tomMorsFPsøknad)));
    ...
    @Test
    void
            far_har_uttak_og_mor_søker_om_uttak_før_fars_uttak_slutter_slik_at_mor_tar_dager_fra_far() {
        var fomFarsFP = fødselsdato.plusWeeks(UKER_MK);
        ...
        leggPåKvoter(grunnlag)
                ...
                .annenPart(
                        new AnnenPart.Builder()
                                .uttaksperiode(
                                        lagPeriodeForFar(
                                                FELLESPERIODE, fomFarsFP, tomFarsFPorginal, true)))
                .behandling(morBehandling())
                .rettOgOmsorg(beggeRett())
                .søknad(
                        new Søknad.Builder()
    ...
    void
        ...
        var tomMorsFP =
                fødselsdato
                        .plusWeeks(UKER_MK + UKER_FP + 7)
                        .minusDays(1); // 7 ekstra uker pga fars gradering
        var tomMorsFPsøknad = fødselsdato.plusWeeks(50);
        ...
        leggPåKvoter(grunnlag)
                ...
                .annenPart(
                        new AnnenPart.Builder()
                                .uttaksperiode(
                                        AnnenpartUttakPeriode.Builder.uttak(fomFarsFP, tomFarsFP)
                                                .samtidigUttak(true)
    ...
    void skalHåndtereAnnenPartPeriodeOverlapperMedFlereSøknadsperioder() {
                        ...
                        new Søknad.Builder()
                                ...
                                .oppgittPeriode(
                                        oppgittPeriode(
                                                ...
                                                fødselsdato.plusWeeks(UKER_MK).minusDays(1)))
                                .oppgittPeriode(
                                        oppgittPeriode(FELLESPERIODE, fomMorsFP1, tomMorsFP1))
                                .oppgittPeriode(
                                        oppgittPeriode(FELLESPERIODE, fomMorsFP2, tomMorsFP2)));
        ...
        assertThat(resultat.get(5).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(resultat.get(6).uttakPeriode().getPerioderesultattype())
                .isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(resultat.get(7).uttakPeriode().getPerioderesultattype())
    ...
    @Test
    void
            skalHåndtereAnnenPartPeriodeOverlapperMedFlereSøknadsperioderPeriodenTilSluttSkalIkkeTrekkesFra() {
    ...
    void far_skal_gå_tom_for_dager_når_mor_har_oppholdsperiode_men_far_tar_ikke_uttak_i_perioden() {
        ...
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        .arbeid(
                                new Arbeid.Builder()
                                        .arbeidsforhold(new Arbeidsforhold(FAR_ARBEIDSFORHOLD)))
                        .kontoer(kontoer)
                        .datoer(new Datoer.Builder().fødsel(fødselsdato))
                        .annenPart(
                                new AnnenPart.Builder()
                                        .uttaksperiode(
                                                annenpartPeriodeInnvilget(
                                                        fødselsdato,
                                                        fødselsdato.plusWeeks(6).minusDays(1),
                                                        MØDREKVOTE,
                                                        new Trekkdager(30)))
                                        .uttaksperiode(
                                                annenpartPeriodeOpphold(
    ...
    void skal_ikke_trekke_for_opphold_i_berørt_behandling_hvis_søker_har_søkt_i_perioden() {
        ...
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        ...
                        .revurdering(
                                new Revurdering.Builder().endringsdato(fødselsdato.plusWeeks(10)))
                        .søknad(
                                new Søknad.Builder()
                                        .type(Søknadstype.FØDSEL)
                                        .oppgittPeriode(
    ...
    void oppholdsperioder_som_overlapper_med_annenpart_uten_trekkdager_skal_ikke_fjernes() {
        var annenpartAktivitet =
                new AnnenpartUttakPeriodeAktivitet(
                        forFrilans(), FELLESPERIODE, Trekkdager.ZERO, Utbetalingsgrad.ZERO);
        var annenpartPeriodeUtenTrekkdager =
                AnnenpartUttakPeriode.Builder.uttak(
    ...
    void oppholdsperioder_som_overlapper_med_annenpart_innvilget_utsettelse_skal_fjernes() {
        var annenpartAktivitet =
                new AnnenpartUttakPeriodeAktivitet(
                        forFrilans(), FELLESPERIODE, Trekkdager.ZERO, Utbetalingsgrad.ZERO);
        var annenpartPeriodeUtsettelse =
    ...
    @Test
    void
            berørt_behandling_som_har_annenpart_med_overlappende_oppholdsperiode_skal_ikke_tape_perioden() {
        var grunnlag =
                RegelGrunnlagTestBuilder.create()
                        .datoer(new Datoer.Builder().fødsel(fødselsdato))
                        .annenPart(
                                                ...
                                                AnnenpartUttakPeriode.Builder.uttak(
                                                        ...
                                                        .uttakPeriodeAktivitet(
                                                                new AnnenpartUttakPeriodeAktivitet(
                                                                        ...
                                                                        FEDREKVOTE,
                                                                        new Trekkdager(5),
                                                                        new Utbetalingsgrad(40)))
                                                        .innvilget(true)
                                                        .samtidigUttak(true)
                                                        .build()))
                        .behandling(morBehandling().berørtBehandling(true))
                        .søknad(
                                søknad(Søknadstype.FØDSEL)
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        MØDREKVOTE,
                                                        fh,
                                                        fh.plusWeeks(6).minusDays(1)))
                                        .oppgittPeriode(
                                                oppgittPeriode(
                                                        MØDREKVOTE,
                                                        fh.plusWeeks(6),
    ...
    @Test
    void
            samtidig_uttak_til_manuell_i_berørt_hvis_samlet_over_100_prosent_uttak_ene_over_80_prosent() {
        var fh = LocalDate.of(2022, 4, 1);
        var grunnlag =
                basicGrunnlagMor(fh)
                        .annenPart(
    ...
    void skal_gi_riktig_saldo_for_flerbarnsdager() {
        var fh = LocalDate.of(2022, 4, 1);
        var annenpartUttakPeriode1 =
                AnnenpartUttakPeriode.Builder.uttak(fh, fh.plusWeeks(7).minusDays(1))
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        forFrilans(),
                                        MØDREKVOTE,
                        ...
                        .innvilget(true)
                        .build();
        var annenpartUttakPeriode2 =
                AnnenpartUttakPeriode.Builder.uttak(fh.plusWeeks(9), fh.plusWeeks(10).minusDays(1))
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        forFrilans(),
                                        MØDREKVOTE,
                        ...
                        .samtidigUttak(true)
                        .build();
        var annenpartUttakPeriode3 =
                AnnenpartUttakPeriode.Builder.uttak(fh.plusWeeks(10), fh.plusWeeks(11).minusDays(1))
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        forFrilans(),
                                        MØDREKVOTE,
                        ...
                        .samtidigUttak(false)
                        .build();
        var annenpartUttakPeriode4 =
                AnnenpartUttakPeriode.Builder.uttak(fh.plusWeeks(11), fh.plusWeeks(12).minusDays(1))
                        .uttakPeriodeAktivitet(
                                new AnnenpartUttakPeriodeAktivitet(
                                        forFrilans(),
                                        MØDREKVOTE,
        ...
        assertThat(resultat.get(5).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD))
    ...
    private AnnenpartUttakPeriode annenpartPeriodeOpphold(
            LocalDate fom, LocalDate tom, OppholdÅrsak oppholdÅrsak) {
