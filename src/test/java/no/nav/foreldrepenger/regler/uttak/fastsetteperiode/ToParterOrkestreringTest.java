...
class ToParterOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    private RegelGrunnlag.Builder leggPåKvoter(RegelGrunnlag.Builder builder) {
        var kontoer = new Kontoer.Builder().konto(kvote(FORELDREPENGER_FØR_FØDSEL, UKER_FPFF))
    ...
    void far_har_uttak_og_mor_søker_før_og_etter_fars_uttak() {
        ...
        leggPåKvoter(grunnlag).datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(lagPeriodeForFar(FELLESPERIODE, fomFarsFP, tomFarsFP, true)))
            .behandling(morBehandling())
            .rettOgOmsorg(beggeRett())
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(UKER_FPFF), fødselsdato.minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(UKER_MK).minusDays(1)))
    ...
    void far_har_uttak_og_mor_søker_om_uttak_før_fars_uttak_slutter_slik_at_mor_tar_dager_fra_far() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create();
        leggPåKvoter(grunnlag).datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(lagPeriodeForFar(FELLESPERIODE, fomFarsFP, tomFarsFPorginal, true)))
            .behandling(morBehandling())
            .rettOgOmsorg(beggeRett())
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(UKER_FPFF), fødselsdato.minusDays(1)))
    ...
    void når_far_har_uttak_og_gradert_i_ett_arbeidsforhold_ser_mors_tilgjengelige_dager_kun_det_arbeidsforholdet_for_far_med_minst_forbruk() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create();
        leggPåKvoter(grunnlag).datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(AnnenpartUttakPeriode.Builder.uttak(fomFarsFP, tomFarsFP)
                .samtidigUttak(true)
                .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(FAR_ARBEIDSFORHOLD, FELLESPERIODE,
                    new Trekkdager(Virkedager.beregnAntallVirkedager(fomFarsFP, tomFarsFP)), Utbetalingsgrad.TEN))
                .uttakPeriodeAktivitet(
                    new AnnenpartUttakPeriodeAktivitet(farArbeidsforhold2, FELLESPERIODE, new Trekkdager(5), new Utbetalingsgrad(87.5)))
                .build()))
            .rettOgOmsorg(beggeRett())
            .behandling(morBehandling())
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
    ...
    void skalHåndtereAnnenPartPeriodeOverlapperMedFlereSøknadsperioder() {
        ...
        var tomMorsFP2 = fødselsdato.plusWeeks(UKER_MK).plusWeeks(UKER_FP).minusWeeks(4).plusWeeks(1);
        ...
        assertThat(resultat.get(7).uttakPeriode().getPeriodeResultatÅrsak()).isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN);
    }
    ...
    void skalHåndtereAnnenPartPeriodeOverlapperMedFlereSøknadsperioder_medSamtidigUttak() {
        ...
        leggPåKvoter(grunnlag).datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(
                lagPeriodeForFar(FELLESPERIODE, fødselsdato.plusWeeks(UKER_MK), fødselsdato.plusWeeks(UKER_MK).plusWeeks(20).minusDays(1), true)))
            .behandling(morBehandling())
            .rettOgOmsorg(beggeRett())
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(UKER_FPFF), fødselsdato.minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(UKER_MK).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(FELLESPERIODE, fødselsdato.plusWeeks(UKER_MK).plusWeeks(2),
                ...
                .oppgittPeriode(oppgittPeriode(FELLESPERIODE, fødselsdato.plusWeeks(UKER_MK).plusWeeks(6),
    ...
    void skalHåndtereAnnenPartPeriodeOverlapperMedFlereSøknadsperioder_utenSamtidigUttak() {
        ...
        leggPåKvoter(grunnlag).datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(
                lagPeriodeForFar(FELLESPERIODE, fødselsdato.plusWeeks(UKER_MK), fødselsdato.plusWeeks(UKER_MK).plusWeeks(20).minusDays(1), false)))
            .behandling(morBehandling())
            .rettOgOmsorg(beggeRett())
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(UKER_FPFF), fødselsdato.minusDays(1)))
    ...
    void far_skal_gå_tom_for_dager_når_mor_har_oppholdsperiode_men_far_tar_ikke_uttak_i_perioden() {
        ...
        var kontoer = new Kontoer.Builder().konto(new Konto.Builder().type(FEDREKVOTE).trekkdager(75))
        ...
        assertThat(resultat.get(1).uttakPeriode().getManuellbehandlingårsak()).isEqualTo(Manuellbehandlingårsak.STØNADSKONTO_TOM);
    }
    ...
    void skal_ikke_trekke_for_opphold_i_berørt_behandling_hvis_søker_har_søkt_i_perioden() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
            ...
            .datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(
                    annenpartPeriodeInnvilget(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10).minusDays(1), FEDREKVOTE, new Trekkdager(20)))
                .uttaksperiode(annenpartPeriodeOpphold(fødselsdato.plusWeeks(10), fødselsdato.plusWeeks(19).minusDays(1),
            ...
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                ...
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato.plusWeeks(10), fødselsdato.plusWeeks(19).minusDays(1))));
    ...
    void skal_trekke_for_overlappende_avslått_hos_annenpart_i_berørt_behandling() {
        ...
        var kontoer = new Kontoer.Builder().konto(new Konto.Builder().type(MØDREKVOTE).trekkdager(75))
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
            ...
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(FELLESPERIODE, fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(10).minusDays(1))));
    ...
    void skal_ikke_trekke_for_opphold_hvis_søker_har_søkt_i_perioden() {
        ...
        var søknad = new Søknad.Builder().type(Søknadstype.FØDSEL)
            .oppgittPeriode(oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(21).minusDays(1), MORS_AKTIVITET_GODKJENT))
            .oppgittPeriode(
                oppgittPeriode(FELLESPERIODE, fødselsdato.plusWeeks(21), fødselsdato.plusWeeks(22).minusDays(1), MORS_AKTIVITET_GODKJENT));
        var grunnlag = RegelGrunnlagTestBuilder.create()
            .kontoer(kontoer)
            .arbeid(new Arbeid.Builder().arbeidsforhold(new Arbeidsforhold(FAR_ARBEIDSFORHOLD)))
            .datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(
                    annenpartPeriodeInnvilget(fødselsdato, fødselsdato.plusWeeks(6).minusDays(1), MØDREKVOTE, new Trekkdager(30)))
                .uttaksperiode(
                    annenpartPeriodeOpphold(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(21).minusDays(1), OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER))
                .uttaksperiode(
                    annenpartPeriodeInnvilget(fødselsdato.plusWeeks(21), fødselsdato.plusWeeks(30).minusDays(1), MØDREKVOTE, new Trekkdager(45))))
    ...
    void oppholdsperioder_som_overlapper_med_annenpart_skal_fjernes() {
        var grunnlag = RegelGrunnlagTestBuilder.create()
            ...
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                ...
                .oppgittPeriode(OppgittPeriode.forOpphold(fødselsdato.plusWeeks(15), fødselsdato.plusWeeks(16).minusDays(1),
                    OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER, null, null))
                .oppgittPeriode(
                    OppgittPeriode.forOpphold(fødselsdato.plusWeeks(16), fødselsdato.plusWeeks(20), OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER, null,
                        null)));
        ...
        assertThat(resultat.get(1).uttakPeriode().getOppholdÅrsak()).isEqualTo(OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER);
        assertThat(resultat.get(1).uttakPeriode().getFom()).isEqualTo(fødselsdato.plusWeeks(17).plusDays(1));
    ...
    void oppholdsperioder_som_overlapper_med_annenpart_uten_trekkdager_skal_ikke_fjernes() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
            ...
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(14), fødselsdato.plusWeeks(15).minusDays(1)))
                .oppgittPeriode(OppgittPeriode.forOpphold(annenpartPeriodeUtenTrekkdager.getFom(), annenpartPeriodeUtenTrekkdager.getTom(),
                    OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER, null, null)));
    ...
    void oppholdsperioder_som_overlapper_med_annenpart_innvilget_utsettelse_skal_fjernes() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
            ...
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(14), fødselsdato.plusWeeks(15).minusDays(1)))
                .oppgittPeriode(OppgittPeriode.forOpphold(annenpartPeriodeUtsettelse.getFom(), annenpartPeriodeUtsettelse.getTom(),
                    OppholdÅrsak.FELLESPERIODE_ANNEN_FORELDER, null, null)));
    ...
    void berørt_behandling_som_har_annenpart_med_overlappende_oppholdsperiode_skal_ikke_tape_perioden() {
        var grunnlag = RegelGrunnlagTestBuilder.create()
            .datoer(new Datoer.Builder().fødsel(fødselsdato))
            .annenPart(new AnnenPart.Builder().uttaksperiode(
                    annenpartsPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(15).minusDays(1), forFrilans(), true))
                .uttaksperiode(annenpartPeriodeOpphold(fødselsdato.plusWeeks(15), fødselsdato.plusWeeks(30).minusDays(1),
                    OppholdÅrsak.FEDREKVOTE_ANNEN_FORELDER)))
            .behandling(farBehandling().berørtBehandling(true))
            .rettOgOmsorg(beggeRett())
            .søknad(new Søknad.Builder().type(Søknadstype.FØDSEL)
                .oppgittPeriode(oppgittPeriode(FEDREKVOTE, fødselsdato.plusWeeks(15), fødselsdato.plusWeeks(30).minusDays(1))));
    ...
    void samtidig_uttak_automatiseres_i_berørt_hvis_samlet_lik_100_prosent_uttak() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), false, new SamtidigUttaksprosent(60))));

        var resultat = fastsettPerioder(grunnlag);

        assertThat(resultat).hasSize(2);
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(resultat.get(1).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD)).isEqualTo(new Utbetalingsgrad(60));
    }
    ...
    void samtidig_uttak_automatiseres_i_berørt_hvis_samlet_under_100_prosent_uttak() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .behandling(morBehandling().berørtBehandling(true))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), false, new SamtidigUttaksprosent(30))));

        var resultat = fastsettPerioder(grunnlag);

        assertThat(resultat).hasSize(2);
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(resultat.get(1).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD)).isEqualTo(new Utbetalingsgrad(30));
    }
    ...
    void samtidig_uttak_til_manuell_i_berørt_hvis_samlet_over_100_prosent_uttak_ene_over_80_prosent() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .behandling(morBehandling().berørtBehandling(true))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), false, new SamtidigUttaksprosent(70))));
    ...
    void samtidig_uttak_automatisk_reduksjon_i_berørt_hvis_samlet_over_100_prosent_uttak() {
        ...
        assertThat(resultat).hasSize(2);
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(resultat.get(1).uttakPeriode().getSamtidigUttaksprosent()).isEqualTo(new SamtidigUttaksprosent(forventetRedusertTil));
        assertThat(resultat.get(1).uttakPeriode().getAktiviteter().stream().findFirst().orElseThrow().getUtbetalingsgrad()).isEqualTo(
            new Utbetalingsgrad(forventetRedusertTil));
    }
    ...
    void samtidig_uttak_automatiseres_i_berørt_hvis_samlet_lik_150_prosent_uttak() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .behandling(morBehandling().berørtBehandling(true))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), false, new SamtidigUttaksprosent(100))));

        var resultat = fastsettPerioder(grunnlag);

        assertThat(resultat).hasSize(2);
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(resultat.get(1).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD)).isEqualTo(new Utbetalingsgrad(100));
    }
    ...
    void samtidig_uttak_automatiseres_i_berørt_hvis_samlet_lik_150_prosent_uttak_byttom() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .behandling(morBehandling().berørtBehandling(true))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(FELLESPERIODE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), false, new SamtidigUttaksprosent(50))));

        var resultat = fastsettPerioder(grunnlag);

        assertThat(resultat).hasSize(2);
        assertThat(resultat.get(1).uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.INNVILGET);
        assertThat(resultat.get(1).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD)).isEqualTo(new Utbetalingsgrad(50));
    }
    ...
    void samtidig_uttak_automatiseres_i_berørt_hvis_samlet_under_150_prosent_uttak() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .behandling(morBehandling().berørtBehandling(true))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(FELLESPERIODE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), false, new SamtidigUttaksprosent(30))));
    ...
    void samtidig_uttak_til_manuell_i_berørt_hvis_samlet_over_150_prosent_uttak_byttom() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .behandling(morBehandling().berørtBehandling(true))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(oppgittPeriode(FELLESPERIODE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), false, new SamtidigUttaksprosent(70))));
    ...
    void skal_gi_riktig_saldo_for_flerbarnsdager() {
        ...
        var annenpartUttakPeriode4 = AnnenpartUttakPeriode.Builder.uttak(fh.plusWeeks(11), fh.plusWeeks(12).minusDays(1))
            ...
            .samtidigUttak(false)
            .build();
        var grunnlag = basicGrunnlagFar(fh).annenPart(new AnnenPart.Builder().uttaksperiode(annenpartUttakPeriode1)
            ...
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(
                oppgittPeriode(FEDREKVOTE, fh.plusWeeks(8), fh.plusWeeks(17).minusDays(1), true, new SamtidigUttaksprosent(100))))
            .kontoer(new Kontoer.Builder().flerbarnsdager(40)
        ...
        assertThat(resultat.get(5).uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.MANUELL_BEHANDLING);
        assertThat(resultat.get(5).uttakPeriode().getPeriodeResultatÅrsak()).isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN);
        assertThat(resultat.get(5).uttakPeriode().getManuellbehandlingårsak()).isEqualTo(Manuellbehandlingårsak.STØNADSKONTO_TOM);
        //5 dager over flerbarns-kvoten. Dette er pga vi ikke skal dobbelt trekke flerbarnsdager i perioder der begge har oppgitt flerbarnsdager
    ...
    void skal_ikke_trekke_dobbelt_flerbarnsdager_når_begge_foreldre_oppgir_flerbarnsdager() {
        ...
        var annenpartUttakPeriode2 = AnnenpartUttakPeriode.Builder.uttak(fh.plusWeeks(9), fh.plusWeeks(10).minusDays(1))
            ...
            .samtidigUttak(false)
            .build();
        var grunnlag = basicGrunnlagFar(fh).annenPart(
                new AnnenPart.Builder().uttaksperiode(annenpartUttakPeriode1).uttaksperiode(annenpartUttakPeriode2))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(
                oppgittPeriode(FEDREKVOTE, fh.plusWeeks(8), fh.plusWeeks(15).minusDays(1), true, new SamtidigUttaksprosent(100))))
            .kontoer(new Kontoer.Builder().flerbarnsdager(34)
                .konto(konto(MØDREKVOTE, 100))
                .konto(konto(FELLESPERIODE, 100))
                .konto(konto(FEDREKVOTE, 100)));
        ...
        assertThat(resultat.get(3).uttakPeriode().getPerioderesultattype()).isEqualTo(Perioderesultattype.MANUELL_BEHANDLING);
        assertThat(resultat.get(3).uttakPeriode().getPeriodeResultatÅrsak()).isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN);
    ...
    void overlappende_gradering_avslås_i_berørt_selv_om_samlet_under_100_prosent_uttak() {
        ...
        var grunnlag = basicGrunnlagMor(fh).annenPart(new AnnenPart.Builder().uttaksperiode(
            ...
            .behandling(morBehandling().berørtBehandling(true))
            .søknad(søknad(Søknadstype.FØDSEL).oppgittPeriode(oppgittPeriode(MØDREKVOTE, fh, fh.plusWeeks(6).minusDays(1)))
                .oppgittPeriode(gradertoppgittPeriode(MØDREKVOTE, fh.plusWeeks(6), fh.plusWeeks(7).minusDays(1), BigDecimal.valueOf(30),
    ...
    private AnnenpartUttakPeriode lagPeriode(Stønadskontotype stønadskontotype,
        ...
        return AnnenpartUttakPeriode.Builder.uttak(fom, tom)
            ...
            .uttakPeriodeAktivitet(new AnnenpartUttakPeriodeAktivitet(aktivitet, stønadskontotype, trekkdager, Utbetalingsgrad.TEN))
            .build();
    }
