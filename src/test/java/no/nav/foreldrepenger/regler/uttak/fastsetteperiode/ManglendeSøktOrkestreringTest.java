...
class ManglendeSøktOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
                        ...
                        .aktiviteter(
                                List.of(
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(1), FORELDREPENGER, forFrilans()),
                                        new FastsattUttakPeriodeAktivitet(
                                                new Trekkdager(0),
                                                FORELDREPENGER,
    ...
    void manglende_søkt_periode_før_nytt_arbeidsforhold_tilkommer() {
                ...
                RegelGrunnlagTestBuilder.create()
                        .arbeid(
                                new Arbeid.Builder()
                                        ...
                                        .arbeidsforhold(
                                                new Arbeidsforhold(
                                                        tilkommetArbeidsforhold,
                                                        startdatoNyttArbeidsforhold)))
                        .kontoer(kontoer(konto(FORELDREPENGER, 100)))
                ...
                .isEqualTo(
                        new Trekkdager(
                                Virkedager.beregnAntallVirkedager(
                                        ...
                                        startdatoNyttArbeidsforhold.minusDays(1))));
        ...
        assertThat(perioder.get(0).uttakPeriode().getTom())
                .isEqualTo(startdatoNyttArbeidsforhold.minusDays(1));
        ...
        assertThat(perioder.get(1).uttakPeriode().getTrekkdager(tilkommetArbeidsforhold))
                .isEqualTo(new Trekkdager(5));
        ...
        assertThat(perioder.get(1).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(13).minusDays(3));
        ...
        assertThat(perioder.get(2).uttakPeriode().getTrekkdager(tilkommetArbeidsforhold).merEnn0())
                .isTrue();
    }
    ...
    void skal_avslå_foreldrepenger_når_msp_innenfor_første_6_ukene_bare_mor_har_rett() {
        ...
        assertThat(perioder.get(0).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(1).minusDays(1));
        assertThat(perioder.get(0).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.MOR_TAR_IKKE_UKENE_ETTER_FØDSEL);
        assertThat(perioder.get(0).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isEqualTo(Utbetalingsgrad.ZERO);
        assertThat(perioder.get(0).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD).merEnn0()).isTrue();
        assertThat(perioder.get(0).uttakPeriode().getStønadskontotype()).isEqualTo(FORELDREPENGER);
        ...
        assertThat(perioder.get(1).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(InnvilgetÅrsak.FORELDREPENGER_KUN_MOR_HAR_RETT);
        assertThat(perioder.get(1).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
        ...
        assertThat(perioder.get(2).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(4).minusDays(1));
        assertThat(perioder.get(2).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.MOR_TAR_IKKE_UKENE_ETTER_FØDSEL);
        assertThat(perioder.get(2).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isEqualTo(Utbetalingsgrad.ZERO);
        ...
        assertThat(perioder.get(3).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(InnvilgetÅrsak.FORELDREPENGER_KUN_MOR_HAR_RETT);
        assertThat(perioder.get(3).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isEqualTo(Utbetalingsgrad.HUNDRED);
    ...
    void skal_avslå_foreldrepenger_når_msp_innenfor_første_6_ukene_mor_aleneomsorg() {
        ...
        assertThat(perioder.get(1).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(3).minusDays(1));
        assertThat(perioder.get(1).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(InnvilgetÅrsak.FORELDREPENGER_ALENEOMSORG);
        assertThat(perioder.get(1).uttakPeriode().getUtbetalingsgrad(ARBEIDSFORHOLD))
                .isEqualTo(Utbetalingsgrad.HUNDRED);
        assertThat(perioder.get(1).uttakPeriode().getTrekkdager(ARBEIDSFORHOLD).merEnn0()).isTrue();
        assertThat(perioder.get(1).uttakPeriode().getStønadskontotype()).isEqualTo(FORELDREPENGER);
    ...
    void bfhr_msp_skal_ikke_avslås_pga_tom_på_konto_hvis_dager_igjen_på_minsteretten() {
        ...
        var grunnlag =
                basicGrunnlagFar(fødselsdato)
                        .søknad(søknad(FØDSEL, fpFørMsp, fpEtterMsp))
        ...
        assertThat(perioder.get(1).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(8).minusDays(1));
        assertThat(perioder.get(1).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.BARE_FAR_RETT_IKKE_SØKT);
    }
    ...
    @Test
    void
            bfhr_msp_skal_avslås_pga_tom_på_konto_hvis_ikke_dager_igjen_på_fp_men_ubrukte_minsterett() {
        var fødselsdato = LocalDate.of(2022, 6, 15);
        var fpFørMsp =
                OppgittPeriode.forVanligPeriode(
                        FORELDREPENGER,
    ...
    @Test
    void
            bfhr_msp_skal_avslås_pga_tom_på_konto_hvis_dager_igjen_på_minsteretten_men_brukt_alle_dager_foreldrepenger() {
        var fødselsdato = LocalDate.of(2022, 6, 15);
        var fpFørMsp =
                OppgittPeriode.forVanligPeriode(
                        FORELDREPENGER,
        ...
        assertThat(perioder.get(1).uttakPeriode().getTom())
                .isEqualTo(fødselsdato.plusWeeks(11).minusDays(1));
        assertThat(perioder.get(1).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN);
    }
    ...
    @Test
    void
            bfhr_msp_skal_ikke_avslås_pga_tom_på_konto_hvis_flere_dager_igjen_på_minsteretten_enn_foreldrepenger() {
        var fødselsdato = LocalDate.of(2022, 6, 15);
        var fpFørMsp =
                OppgittPeriode.forVanligPeriode(
                        FORELDREPENGER,
    ...
    void msp_pga_fødselshendelse_etter_termin_skal_innvilge_mødrekvote() {
        ...
        var fellesperiode =
                oppgittPeriode(
                        FELLESPERIODE,
                        termindato.minusWeeks(3),
                        termindato.minusWeeks(2).minusDays(1));
        var fpff =
                oppgittPeriode(
        ...
        var mødrekvote1 =
                oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(5).minusDays(1));
        // Hull skapt av justering ved fødselshendelsen
        var mødrekvote2 =
                oppgittPeriode(MØDREKVOTE, fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(7));
        var grunnlag =
                basicGrunnlagMor(fødselsdato)
        ...
        assertThat(perioder.get(3).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(InnvilgetÅrsak.MSP_INNVILGET);
        var aktivitet = grunnlag.getArbeid().getAktiviteter().stream().findFirst().orElseThrow();
        assertThat(perioder.get(3).uttakPeriode().getTrekkdager(aktivitet))
                .isEqualTo(new Trekkdager(5));
        assertThat(perioder.get(3).uttakPeriode().getUtbetalingsgrad(aktivitet))
                .isEqualTo(Utbetalingsgrad.HUNDRED);
    }
    ...
    void msp_pga_fødselshendelse_etter_termin_skal_innvilge_mødrekvote_søker_over_uke_6() {
        ...
        var fellesperiode =
                oppgittPeriode(FELLESPERIODE, LocalDate.of(2022, 5, 26), LocalDate.of(2022, 6, 1));
        var fpff =
                oppgittPeriode(
                        FORELDREPENGER_FØR_FØDSEL,
        ...
        var mødrekvote1 =
                oppgittPeriode(MØDREKVOTE, LocalDate.of(2022, 6, 23), LocalDate.of(2022, 7, 29));
        // Hull skapt av justering ved fødselshendelsen
        var mødrekvote2 =
                oppgittPeriode(MØDREKVOTE, LocalDate.of(2022, 8, 25), LocalDate.of(2022, 8, 31));
        var grunnlag =
                basicGrunnlagMor(fødselsdato)
                        .datoer(new Datoer.Builder().fødsel(fødselsdato).termin(termindato))
                        .søknad(søknad(FØDSEL, fellesperiode, fpff, mødrekvote1, mødrekvote2))
    ...
    void msp_første_6_ukene_som_ikke_er_opprettet_av_fødselshendelse_skal_avlås() {
        ...
        var fpff =
                oppgittPeriode(
                        ...
                        fødselsdato.minusDays(1));
        var mødrekvote1 =
                oppgittPeriode(MØDREKVOTE, fødselsdato, fødselsdato.plusWeeks(3).minusDays(1));
        // hull mellom 3-4
        var mødrekvote2 =
                oppgittPeriode(
                        MØDREKVOTE,
        ...
        assertThat(perioder.get(2).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.MOR_TAR_IKKE_UKENE_ETTER_FØDSEL);
        assertThat(perioder.get(2).uttakPeriode().getTrekkdager(aktivitet))
                .isEqualTo(new Trekkdager(5));
        assertThat(perioder.get(2).uttakPeriode().getUtbetalingsgrad(aktivitet))
                .isEqualTo(Utbetalingsgrad.ZERO);
        ...
        assertThat(perioder.get(4).uttakPeriode().getPeriodeResultatÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.MOR_TAR_IKKE_UKENE_ETTER_FØDSEL);
        assertThat(perioder.get(4).uttakPeriode().getTrekkdager(aktivitet))
                .isEqualTo(new Trekkdager(5));
        assertThat(perioder.get(4).uttakPeriode().getUtbetalingsgrad(aktivitet))
                .isEqualTo(Utbetalingsgrad.ZERO);
    }
}
