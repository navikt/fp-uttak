...
class EndringssøknadOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void skal_trekke_dager_for_perioder_i_vedtak() {
        ...
        var revurdering =
                new Revurdering.Builder().endringsdato(endringsdato).gjeldendeVedtak(vedtak);
        var søknadOm10UkerMødrekvote =
                søknad(
                        Søknadstype.FØDSEL,
                        oppgittPeriode(
                                Stønadskontotype.MØDREKVOTE,
    ...
    void skal_arve_høyest_saldo_fra_for_arbeidsforhold_med_startdato_i_uttak() {
        ...
        var opprinnligUttakAktivitet1 =
                new FastsattUttakPeriodeAktivitet(
                        new Trekkdager(30), Stønadskontotype.MØDREKVOTE, aktivitet1);
        var opprinnligUttakAktivitet2 =
                new FastsattUttakPeriodeAktivitet(
                        new Trekkdager(20), Stønadskontotype.MØDREKVOTE, aktivitet2);
        var vedtaksperiode =
                new FastsattUttakPeriode.Builder()
        ...
        var revurdering =
                new Revurdering.Builder()
                        .endringsdato(fødselsdato.plusWeeks(6))
                        .gjeldendeVedtak(vedtak);
        var søknadOm12UkerMødrekvote =
                søknad(
                        Søknadstype.FØDSEL,
                        oppgittPeriode(
                                Stønadskontotype.MØDREKVOTE,
