...
class MødrekvoteDelregelTest {
    ...
    @Test
    void
            mødrekvote_etter_første_6_ukene_etter_fødsel_skal_ikke_innvilges_når_mor_har_nok_på_kvoten_men_ikke_har_omsorg() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
    ...
    @Test
    void
            mødrekvote_etter_første_6_ukene_etter_fødsel_skal_ikke_innvilges_når_mor_har_noe_men_ikke_nok_på_kvoten_og_ikke_har_omsorg() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var oppgittPeriode = oppgittMødrekvote(fødselsdato.plusWeeks(6), fødselsdato.plusWeeks(7));
    ...
    void UT1221_mor_etterTermin_etter6Uker_omsorg_disponibleDager_gradering_avklart() {
        ...
        assertThat(regelresultat.skalUtbetale()).isTrue();
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(InnvilgetÅrsak.GRADERING_KVOTE_ELLER_OVERFØRT_KVOTE);
    }
    ...
    void UT1251_fødselsvilkår_ikke_oppfylt() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var oppgittPeriode =
                oppgittMødrekvote(fødselsdato.plusWeeks(10), fødselsdato.plusWeeks(11));
        var kontoer = enKonto(Stønadskontotype.MØDREKVOTE, 100);
        var grunnlag =
                basicGrunnlagMor(fødselsdato)
                        .kontoer(kontoer)
        ...
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.FØDSELSVILKÅRET_IKKE_OPPFYLT);
    }
    ...
    void UT1252_adopsjonsvilkår_ikke_oppfylt() {
        ...
        assertThat(regelresultat.getUtfallType()).isEqualTo(UtfallType.AVSLÅTT);
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.ADOPSJONSVILKÅRET_IKKE_OPPFYLT);
    }
    ...
    void UT1253_foreldreansvarsvilkår_ikke_oppfylt() {
        ...
        assertThat(regelresultat.getUtfallType()).isEqualTo(UtfallType.AVSLÅTT);
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.FORELDREANSVARSVILKÅRET_IKKE_OPPFYLT);
    }
    ...
    void UT1254_opptjeningsvilkår_ikke_oppfylt() {
        ...
        assertThat(regelresultat.getUtfallType()).isEqualTo(UtfallType.AVSLÅTT);
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.OPPTJENINGSVILKÅRET_IKKE_OPPFYLT);
    }
    ...
    void opphold_mødrekvote_annenforelder() {
        ...
        var oppholdsperiode =
                DelRegelTestUtil.oppholdPeriode(
                        fødselsdato.plusWeeks(15),
                        fødselsdato.plusWeeks(30),
    ...
    void opphold_mødrekvote_annenforelder_tom_for_konto() {
        ...
        var grunnlag =
                basicGrunnlagFar(fødselsdato)
                        ...
                        .søknad(
                                new Søknad.Builder()
                                        .oppgittPeriode(oppholdsperiode)
    ...
    void UT1275_søkte_mødrekvoteperiode_men_søker_døde_i_mellomtiden() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var oppgittPeriode =
                oppgittMødrekvote(fødselsdato.plusWeeks(1), fødselsdato.plusWeeks(6).minusDays(1));
        var kontoer = enKonto(Stønadskontotype.MØDREKVOTE, 10 * 5);
        var grunnlag =
                basicGrunnlagMor(fødselsdato)
                        .kontoer(kontoer)
                                ...
                                new Datoer.Builder()
                                        ...
                                        .dødsdatoer(
                                                new Dødsdatoer.Builder()
                                                        .søkersDødsdato(fødselsdato.plusDays(3))))
                        .build();
    ...
    void UT1289_søkte_mødrekvoteperiode_men_barn_døde_i_mellomtiden() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var oppgittPeriode =
                oppgittMødrekvote(fødselsdato.plusWeeks(7), fødselsdato.plusWeeks(13).minusDays(1));
        var kontoer = enKonto(Stønadskontotype.MØDREKVOTE, 10 * 5);
        var grunnlag =
                basicGrunnlagMor(fødselsdato)
                        .kontoer(kontoer)
                        ...
                        .datoer(
                                new Datoer.Builder()
                                        ...
                                        .dødsdatoer(
                                                new Dødsdatoer.Builder()
                                                        .barnsDødsdato(fødselsdato.plusDays(3))
                                                        .alleBarnDøde(true)))
                        .build();
    ...
    void Innvilge_ikke_UT1289_søkte_mødrekvoteperiode_og_barn_døde_men_mindre_enn_6_uker_siden() {
        ...
        var oppgittPeriode =
                oppgittMødrekvote(fødselsdato, barnsDødsdato.plusWeeks(6).minusDays(2));
        var kontoer = enKonto(Stønadskontotype.MØDREKVOTE, 10 * 5);
        var grunnlag =
                basicGrunnlagMor(fødselsdato)
                        .kontoer(kontoer)
    ...
    @Test
    void
            Innvilge_ikke_UT1289_søkte_mødrekvoteperiode_barn_døde_i_mellomtiden_men_alle_barn_er_ikke_døde() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var oppgittPeriode =
                oppgittMødrekvote(fødselsdato.plusWeeks(7), fødselsdato.plusWeeks(13).minusDays(1));
        var kontoer = enKonto(Stønadskontotype.MØDREKVOTE, 10 * 5);
    ...
    void UT1015_far_søker_mødrekvote_men_ikke_overføring() {
        ...
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.DEN_ANDRE_PART_SYK_SKADET_IKKE_OPPFYLT);
        assertThat(regelresultat.getManuellbehandlingårsak())
    ...
    void UT1016_far_overføring_innleggelse_men_ikke_gyldig() {
        ...
        assertThat(regelresultat.getUtfallType()).isEqualTo(UtfallType.AVSLÅTT);
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.DEN_ANDRE_PART_INNLEGGELSE_IKKE_OPPFYLT);
    }
    ...
    void UT1294_far_overføring_aleneomsorg_men_ikke_dokumentert() {
        ...
        assertThat(regelresultat.getUtfallType()).isEqualTo(UtfallType.AVSLÅTT);
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.ALENEOMSORG_IKKE_OPPFYLT);
    }

    private OppgittPeriode overføringsperiode(LocalDate fom, LocalDate tom, OverføringÅrsak årsak) {
        return DelRegelTestUtil.overføringsperiode(
                Stønadskontotype.MØDREKVOTE, fom, tom, årsak, null);
    }
    ...
    void UT1295_far_overføring_ikke_rett_men_ikke_dokumentert() {
        ...
        assertThat(regelresultat.getUtfallType()).isEqualTo(UtfallType.AVSLÅTT);
        assertThat(regelresultat.getAvklaringÅrsak())
                .isEqualTo(IkkeOppfyltÅrsak.DEN_ANDRE_PART_IKKE_RETT_IKKE_OPPFYLT);
    }
    ...
    private RegelGrunnlag.Builder basicGrunnlagFar(LocalDate fødselsdato) {
        return create().datoer(new Datoer.Builder().fødsel(fødselsdato))
                .rettOgOmsorg(
                        new RettOgOmsorg.Builder().samtykke(true).morHarRett(true).farHarRett(true))
