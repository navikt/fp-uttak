...
public class MødrekvoteDelregelTest {
    ...
    public void mødrekvoteperiode_med_nok_dager_på_konto() {
        ...
        RegelGrunnlag grunnlag = basicGrunnlagMor(fødselsdato)
                ...
                .leggTilKontoer(AktivitetIdentifikator.annenAktivitet(), enKonto(Stønadskontotype.MØDREKVOTE, 10 * 5))
                .build();
    ...
    public void mødrekvote_etter_første_6_ukene_etter_fødsel_skal_ikke_innvilges_når_mor_har_noe_men_ikke_nok_på_kvoten_og_ikke_har_omsorg() {
        ...
        RegelGrunnlag grunnlag = basicGrunnlagMor(fødselsdato)
                .medSøknad(søknad(søknadsperiode, new PeriodeUtenOmsorg(fødselsdato.minusWeeks(10), fødselsdato.plusWeeks(15))))
                .leggTilKontoer(AktivitetIdentifikator.annenAktivitet(), enKonto(Stønadskontotype.MØDREKVOTE, 1))
                .build();
    ...
    public void UT1007_mor_etterTermin_innenFor6Uker_ikkeGradering_disponibleDager() {
        ...
        RegelGrunnlag grunnlag = basicGrunnlagMor(fødselsdato)
                .medSøknad(søknad(søknadsperiode))
                .leggTilKontoer(AktivitetIdentifikator.annenAktivitet(), enKonto(Stønadskontotype.MØDREKVOTE, 100))
                .build();
    ...
    public void UT1275_søkte_mødrekvoteperiode_men_søker_døde_i_mellomtiden() {
        ...
        RegelGrunnlag grunnlag = basicGrunnlagMor(fødselsdato)
            ...
            .medDatoer(new Datoer.Builder()
                ...
                .medDødsdatoer(new Dødsdatoer.Builder().medSøkersDødsdato(fødselsdato.plusDays(3)).build())
                .build())
            .build();
    ...
    private Regelresultat kjørRegel(UttakPeriode uttakPeriode, RegelGrunnlag grunnlag) {
    ...
    private Søknad søknad(UttakPeriode uttakPeriode) {
        return new Søknad.Builder()
    ...
    private Kontoer enKonto(Stønadskontotype type, int trekkdager) {
        return new Kontoer.Builder()
                .leggTilKonto(konto(type, trekkdager))
                .build();
    }
