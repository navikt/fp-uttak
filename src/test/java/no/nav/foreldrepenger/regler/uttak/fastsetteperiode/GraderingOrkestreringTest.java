...
class GraderingOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void periode_med_gradering_og_10_prosent_arbeid_skal_få_riktig_antall_trekkdager() {
        ...
        var grunnlag = basicGrunnlag(fødselsdato)
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(
                                gradertoppgittPeriode(FELLESPERIODE, graderingFom, graderingTom, arbeidsprosent)))
                .build();
    ...
    void når_graderingsperiode_går_tom_skal_perioden_dras_til_søkers_fordel() {
        ...
        // (Søkers fordel)
        var søknadsperiode2 = gradertoppgittPeriode(
                FORELDREPENGER, LocalDate.of(2019, 3, 4), LocalDate.of(2019, 9, 19), BigDecimal.valueOf(60));
    ...
    void
        ...
        assertThat(resultat.get(3).uttakPeriode().getGraderingIkkeInnvilgetÅrsak())
                .isNull();
    ...
    void trekkdager_med_desimaler_når_en_periode_er_en_dag() {
        ...
        var søknadsperiode = gradertoppgittPeriode(
                FORELDREPENGER, LocalDate.of(2019, 4, 19), LocalDate.of(2019, 4, 19), BigDecimal.valueOf(75));
        var grunnlag = RegelGrunnlagTestBuilder.create()
                .arbeid(new Arbeid.Builder().arbeidsforhold(new Arbeidsforhold(ARBEIDSFORHOLD_1)))
                .kontoer(kontoer)
    ...
    void periode_med_gradering_og_80_prosent_arbeid_og_det_er_for_lite_igjen_på_saldo_slik_at_perioden_knekkes() {
        ...
        grunnlag.datoer(new Datoer.Builder().fødsel(fødselsdato))
                ...
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(oppgittPeriode(MØDREKVOTE, fødselsdato, graderingFom.minusDays(1)))
                        .oppgittPeriode(gradertoppgittPeriode(
                                FELLESPERIODE, graderingFom, graderingTom, BigDecimal.valueOf(80))))
                .arbeid(new Arbeid.Builder().arbeidsforhold(new Arbeidsforhold(ARBEIDSFORHOLD_1)))
                .kontoer(kontoer)
    ...
    void skal_knekke_riktig_ved_flere_graderingsperioder_og_flere_arbeidsforhold() {
        ...
        var fastsattAktiviter = List.of(
                new FastsattUttakPeriodeAktivitet(new Trekkdager(96), FORELDREPENGER, ARBEIDSFORHOLD_1),
    ...
    void skal_ikke_få_innvilget_en_hel_ekstra_trekkdag() {
        ...
        var grunnlag = new RegelGrunnlag.Builder()
                ...
                .søknad(new Søknad.Builder()
                        .type(Søknadstype.FØDSEL)
                        .oppgittPeriode(gradertoppgittPeriode(
                                FEDREKVOTE, LocalDate.of(2019, 5, 3), LocalDate.of(2019, 7, 5), BigDecimal.valueOf(60)))
                        .oppgittPeriode(utsettelsePeriode(
                                LocalDate.of(2019, 7, 8), LocalDate.of(2019, 7, 26), UtsettelseÅrsak.FERIE, null))
                        .oppgittPeriode(gradertoppgittPeriode(
                                FEDREKVOTE,
    ...
    void opphevet_gradering_skal_ikke_endre_på_hvilket_arbeidsforhold_det_er_søkt_gradering_for() {
        ...
        assertThat(resultat.get(1).uttakPeriode().erGraderingInnvilget(ARBEIDSFORHOLD_1))
                .isFalse();
        assertThat(resultat.get(1).uttakPeriode().erGraderingInnvilget(ARBEIDSFORHOLD_1))
                .isFalse();
        assertThat(resultat.get(1).uttakPeriode().getAktiviteter().stream()
                        .anyMatch(
                                a -> a.isSøktGradering() && a.getIdentifikator().equals(ARBEIDSFORHOLD_1)))
                .isTrue();
        assertThat(resultat.get(1).uttakPeriode().getAktiviteter().stream()
                        .anyMatch(
                                a -> a.isSøktGradering() && a.getIdentifikator().equals(ARBEIDSFORHOLD_2)))
                .isFalse();
    }
}
