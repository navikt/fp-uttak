...
class KnekkpunktOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    @Test
    void
            foreldrepengerFørFødssel_søknad_fra_3_uker_før_fødsel_til_og_med_fødsel_blir_knekt_ved_fødsel() {
        ...
        assertThat(perioder)
                .hasSize(3); // 3 perioder fordi det også lages en manglende søkt periode for de 6
        // første ukene.
    ...
    @Test
    void
            en_lang_manglende_søkt_før_første_uttaksperiode_skal_gå_til_manuell_når_alle_dager_brukes_opp() {
