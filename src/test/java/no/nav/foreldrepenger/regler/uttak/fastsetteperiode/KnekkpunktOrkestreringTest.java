...
class KnekkpunktOrkestreringTest extends FastsettePerioderRegelOrkestreringTestBase {
    ...
    void foreldrepengerFørFødssel_søknad_fra_3_uker_før_fødsel_til_og_med_fødsel_blir_knekt_ved_fødsel() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(søknad(
                        Søknadstype.FØDSEL,
                        oppgittPeriode(
                                Stønadskontotype.FORELDREPENGER_FØR_FØDSEL, fødselsdato.minusWeeks(3), fødselsdato)))
        ...
        assertThat(perioder).hasSize(3); // 3 perioder fordi det også lages en manglende søkt periode for de 6
        // første ukene.
    ...
    @Test
    void
            foreldrepengerFørFødsel_periode_dekker_alle_ukene_før_fødsel_slutter_etter_fødsel_blir_hvor_ukene_etter_fødsel_blir_avslått() {
        var fødselsdato = LocalDate.of(2018, 1, 1);
        var kontoer = new Kontoer.Builder()
                .konto(new Konto.Builder()
                        .type(Stønadskontotype.FORELDREPENGER_FØR_FØDSEL)
    ...
    void riktig_knekk_ved_tom_for_dager_ifm_helg() {
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(søknad(
                        ...
                        oppgittPeriode(
                                Stønadskontotype.MØDREKVOTE, LocalDate.of(2018, 7, 1), LocalDate.of(2018, 12, 21))))
                .kontoer(kontoer)
                .build();
    ...
    void riktig_knekk_ved_tom_for_dager_ifm_helg2() {
        ...
        var kontoer = new Kontoer.Builder()
                .konto(new Konto.Builder().type(Stønadskontotype.FEDREKVOTE).trekkdager(10));
        var grunnlag = RegelGrunnlagTestBuilder.create()
                .datoer(new Datoer.Builder().fødsel(fødselsdato))
                .rettOgOmsorg(beggeRett())
        ...
        var grunnlag = RegelGrunnlagTestBuilder.create()
                ...
                .søknad(søknad(
                        ...
                        oppgittPeriode(
                                ...
                                fødselsdato.plusWeeks(15).plusDays(1),
    ...
    void tilfelle_med_lang_overføring_sykdom() {
        ...
        var kontoer = new Kontoer.Builder()
                .konto(new Konto.Builder().type(FEDREKVOTE).trekkdager(95))
        ...
        var overføring = OppgittPeriode.forOverføring(
                MØDREKVOTE,
        ...
        var grunnlag = basicGrunnlag(termindato)
                ...
                .søknad(new Søknad.Builder()
                        ...
                        .oppgittPeriode(
                                oppgittPeriode(FEDREKVOTE, LocalDate.of(2022, 9, 12), LocalDate.of(2022, 9, 23)))
