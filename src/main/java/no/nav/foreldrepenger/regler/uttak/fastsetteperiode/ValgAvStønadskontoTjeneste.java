...
final class ValgAvStønadskontoTjeneste {
    ...
    static Optional<Stønadskontotype> velgStønadskonto(
            OppgittPeriode periode, RegelGrunnlag regelGrunnlag, SaldoUtregning saldoUtregning) {
    ...
    private static Optional<Stønadskontotype> velgStønadskontoVanligPeriode(
            OppgittPeriode periode, RegelGrunnlag regelGrunnlag, SaldoUtregning saldoUtregning) {
        return velg(periode, regelGrunnlag, saldoUtregning);
    }

    private static Optional<Stønadskontotype> velgStønadskontoForUtsettelse(
            OppgittPeriode periode, RegelGrunnlag regelGrunnlag, SaldoUtregning saldoUtregning) {
    ...
    private static Optional<Stønadskontotype> velg(
            OppgittPeriode periode, RegelGrunnlag regelGrunnlag, SaldoUtregning saldoUtregning) {
    ...
    private static boolean periodeErFørTermin(OppgittPeriode periode, RegelGrunnlag regelGrunnlag) {
        return regelGrunnlag.getDatoer().getTermin() != null
