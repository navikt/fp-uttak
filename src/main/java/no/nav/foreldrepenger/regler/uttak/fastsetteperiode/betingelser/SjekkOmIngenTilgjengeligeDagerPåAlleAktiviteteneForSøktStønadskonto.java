...
@RuleDocumentation(SjekkOmIngenTilgjengeligeDagerPåAlleAktiviteteneForSøktStønadskonto.ID)
public class SjekkOmIngenTilgjengeligeDagerPåAlleAktiviteteneForSøktStønadskonto extends LeafSpecification<FastsettePeriodeGrunnlag> {

    public static final String ID = "FP_VK 10.5.1";
    public static final String BESKRIVELSE = "Har ingen aktiviteter disponible stønadsdager igjen?";

    public SjekkOmIngenTilgjengeligeDagerPåAlleAktiviteteneForSøktStønadskonto() {
        super(ID);
    }
