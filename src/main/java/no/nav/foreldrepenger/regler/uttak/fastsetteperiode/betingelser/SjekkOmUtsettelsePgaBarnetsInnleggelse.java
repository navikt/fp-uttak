...
public class SjekkOmUtsettelsePgaBarnetsInnleggelse extends LeafSpecification<FastsettePeriodeGrunnlag> {
    public static final String ID = "FP_VK 18.3.9";
    public static final String BESKRIVELSE = "Er det utsettelse pga barnet innlagt i helseinstitusjon?";
