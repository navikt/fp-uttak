...
public class UtsettelseDelregelSammenhengendeUttak implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    private Specification<FastsettePeriodeGrunnlag> delRegelForFerie() {
        ...
        var sjekkOmFeriePåBevegeligHelligdag = rs.hvisRegel(
                        SjekkOmFeriePåBevegeligHelligdag.ID, "Er det ferie på bevegelig helligdag?")
                .hvis(
        ...
        var sjekkOmSøkerErArbeidstaker = rs.hvisRegel(SjekkOmSøkerErArbeidstaker.ID, "Er søker arbeidstaker?")
                ...
                .ellers(Manuellbehandling.opprett(
                        "UT1102",
                        IkkeOppfyltÅrsak.FERIE_SELVSTENDIG_NÆRINGSDRIVENDSE_FRILANSER,
                        Manuellbehandlingårsak.IKKE_GYLDIG_GRUNN_FOR_UTSETTELSE,
                        true,
                        false));

        var sjekkOmUtsettelseEtterUke6 = rs.hvisRegel(
                        SjekkOmUttakSkjerEtterDeFørsteUkene.ID, SjekkOmUttakSkjerEtterDeFørsteUkene.BESKRIVELSE)
                .hvis(new SjekkOmUttakSkjerEtterDeFørsteUkene(), sjekkOmSøkerErArbeidstaker)
                .ellers(IkkeOppfylt.opprett(
                        "UT1101", IkkeOppfyltÅrsak.UTSETTELSE_INNENFOR_DE_FØRSTE_6_UKENE, true, true));

        var sjekkOmSøknadGjelderFødsel = rs.hvisRegel(
                        SjekkOmSøknadGjelderTerminEllerFødsel.ID, SjekkOmSøknadGjelderTerminEllerFødsel.BESKRIVELSE)
    ...
    private Specification<FastsettePeriodeGrunnlag> delregelForArbeid() {
        var sjekkOmMorErIAktivitet = rs.hvisRegel(SjekkOmMorErIAktivitet.ID, SjekkOmMorErIAktivitet.BESKRIVELSE)
                .hvis(
                        new SjekkOmMorErIAktivitet(),
                        Oppfylt.opprett(
                                "UT1114", InnvilgetÅrsak.UTSETTELSE_GYLDIG_PGA_100_PROSENT_ARBEID, false, false))
                .ellers(new AvslagAktivitetskravDelregel().getSpecification());
        ...
        var sjekkOmSøkerErIArbeidPåHeltid = rs.hvisRegel(
    ...
    private Specification<FastsettePeriodeGrunnlag> delregelForHV() {
        var sjekkOmUtsettelseEtterUke6 = rs.hvisRegel(
                ...
                .hvis(
                        ...
                        Oppfylt.opprett(
                                "UT1131", InnvilgetÅrsak.UTSETTELSE_GYLDIG_PGA_100_PROSENT_ARBEID, false, false))
                .ellers(Manuellbehandling.opprett(
                        "UT1130",
                        IkkeOppfyltÅrsak.UTSETTELSE_INNENFOR_DE_FØRSTE_6_UKENE,
                        Manuellbehandlingårsak.IKKE_GYLDIG_GRUNN_FOR_UTSETTELSE,
    ...
    private Specification<FastsettePeriodeGrunnlag> delregelForTiltakViaNav() {
        var sjekkOmUtsettelseEtterUke6 = rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmUttakSkjerEtterDeFørsteUkene(),
                        Oppfylt.opprett(
                                "UT1135", InnvilgetÅrsak.UTSETTELSE_GYLDIG_PGA_100_PROSENT_ARBEID, false, false))
                .ellers(Manuellbehandling.opprett(
                        "UT1134",
                        IkkeOppfyltÅrsak.UTSETTELSE_INNENFOR_DE_FØRSTE_6_UKENE,
                        Manuellbehandlingårsak.IKKE_GYLDIG_GRUNN_FOR_UTSETTELSE,
