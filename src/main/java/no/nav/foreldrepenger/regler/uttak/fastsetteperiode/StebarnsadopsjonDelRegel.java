...
public class StebarnsadopsjonDelRegel implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    public Specification<FastsettePeriodeGrunnlag> getSpecification() {
        return rs.hvisRegel(SjekkOmPeriodenStarterFørFamiliehendelse.ID, "Starter perioden før omsorgsovertakelse?")
            .hvis(new SjekkOmPeriodenStarterFørFamiliehendelse(), IkkeOppfylt.opprett("UT1285", IkkeOppfyltÅrsak.FØR_OMSORGSOVERTAKELSE, false, false))
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmNoenDisponibleDager() {
        return rs.hvisRegel(SjekkOmTilgjengeligeDagerPåAlleAktivitetene.ID, "Er det noen disponible stønadsdager på mødrekvote?")
                ...
                .ellers(Manuellbehandling.opprett("UT1244", IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN, Manuellbehandlingårsak.STØNADSKONTO_TOM, true, false));
    }
