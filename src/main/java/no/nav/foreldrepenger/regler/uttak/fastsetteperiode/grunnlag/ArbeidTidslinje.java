...
public class ArbeidTidslinje {
    ...
    public static class Builder {
        ...
        public Builder() {
            Arbeid arbeid = new Arbeid(BigDecimal.ZERO, BigDecimal.valueOf(100), false);
        ...
        public ArbeidTidslinje build() {
            LocalDateTimeline<Arbeid> timeline = new LocalDateTimeline<>(kladd, (datoInterval, datoSegment1, datoSegment2) -> {
                ...
                Arbeid sumArbeid = new Arbeid(arbeid2.getArbeidsprosent(), arbeid2.getStillingsprosent(), arbeid2.isGradert());
