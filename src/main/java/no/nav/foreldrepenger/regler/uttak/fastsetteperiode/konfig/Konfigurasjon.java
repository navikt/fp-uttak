...
public class Konfigurasjon {
        ...
        STANDARD =
                KonfigurasjonBuilder.create()
                        ...
                        .leggTilParameter(
                                ...
                                6)
                        .leggTilParameter(
                                Parametertype.TIDLIGST_UTTAK_FØR_TERMIN_UKER,
                                d_2010_01_01,
                                null,
                                12)
                        .leggTilParameter(
                                Parametertype.SENEST_UTTAK_FØR_TERMIN_UKER, d_2010_01_01, null, 3)
                        .leggTilParameter(
                                Parametertype.UTTAK_ETTER_BARN_DØDT_UKER, d_2017_01_01, null, 6)
                        .leggTilParameter(
                                Parametertype.FAR_UTTAK_FØR_TERMIN_UKER,
                                d_2017_01_01,
                                null,
                                2) // TODO: endre til aug 2022 etter overgang
                        .leggTilParameter(
                                Parametertype.FAR_UTTAK_ETTER_FØDSEL_UKER,
                                d_2017_01_01,
                                null,
                                6) // TODO: endre til aug 2022 etter overgang

                        // Grenser
                        .leggTilParameter(
                                Parametertype.GRENSE_ETTER_FØDSELSDATO_ÅR, d_2010_01_01, null, 3)
                        .leggTilParameter(
                                Parametertype.TETTE_SAKER_MELLOMROM_UKER,
                                d_2017_01_01,
                                null,
                                48) // TODO: endre til aug 2022 el 48 uker tidligere etter overgang
                        .leggTilParameter(
                                Parametertype.PREMATURUKER_ANTALL_DAGER_FØR_TERMIN,
                                d_2019_07_01,
                                null,
                                52)
                        .build();
    ...
    public Optional<Integer> getParameterHvisAktivVed(
            Parametertype parametertype, final LocalDate dato) {
    ...
    public Collection<Parameter> getParameterVerdier(Parametertype parametertype) {
        return Optional.ofNullable(this.parameterMap.get(parametertype))
                .orElseThrow(
                        () ->
                                new IllegalArgumentException(
                                        "Konfigurasjon-feil/Utvikler-feil: mangler parameter av type "
                                                + parametertype));
    }
}
