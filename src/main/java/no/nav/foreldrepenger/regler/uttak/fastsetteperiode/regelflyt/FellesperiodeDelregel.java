 ...
 * - Perioden starter for tidlig før familiehendelsen (termin/fødsel) - Perioden starter i periode
 * etter fødsel som er forbeholdt mor.<br>
 *
 ...
 * stønadskontoen for fellesperiode.<br>
 */
@RuleDocumentation(
        value = FellesperiodeDelregel.ID,
...
public class FellesperiodeDelregel implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    public Specification<FastsettePeriodeGrunnlag> getSpecification() {
        return rs.hvisRegel(
                        SjekkOmOppholdFellesperiodeAnnenForelder.ID,
                        "Er det søkt om opphold av fellesperioden?")
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorHarRett() {
        return rs.hvisRegel(SjekkOmMorHarRett.ID, "Er det avklart at mor har rett?")
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1293", IkkeOppfyltÅrsak.MOR_IKKE_RETT_FP, true, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorGjelderFødsel() {
        return rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmSøknadGjelderTerminEllerFødsel(),
                        sjekkOmPeriodenStarterFørLovligUttakFørFamiliehendelse())
    ...
    private Specification<FastsettePeriodeGrunnlag>
        ...
        return rs.hvisRegel(
                ...
                .hvis(
                        ...
                        IkkeOppfylt.opprett(
                                "UT1232", IkkeOppfyltÅrsak.FØR_OMSORGSOVERTAKELSE, false, false))
    ...
    private Specification<FastsettePeriodeGrunnlag>
        ...
        return rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmPeriodenStarterFørFamiliehendelse(),
                        IkkeOppfylt.opprett(
                                "UT1235", IkkeOppfyltÅrsak.FØR_OMSORGSOVERTAKELSE, false, false))
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGraderingIPerioden() {
        return rs.hvisRegel(SjekkOmGradertPeriode.ID, "Er perioden gradert?")
                ...
                .ellers(
                        Oppfylt.opprett(
                                "UT1041", InnvilgetÅrsak.FELLESPERIODE_ELLER_FORELDREPENGER, true));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkSaldoForMor() {
        var erDetGraderingIPeriodenMedDagerPåNoenAktiviteterNode =
                rs.hvisRegel(SjekkOmGradertPeriode.ID, SjekkOmGradertPeriode.BESKRIVELSE)
                        .hvis(
                                ...
                                Oppfylt.opprett(
                                        "UT1219",
                                        InnvilgetÅrsak.GRADERING_FELLESPERIODE_ELLER_FORELDREPENGER,
                                        true))
                        .ellers(
                                Oppfylt.opprett(
                                        "UT1047",
        ...
        var sjekkOmTrekkesDager =
                rs.hvisRegel(
                                SjekkOmBehandlingKreverSammenhengendeUttak.ID,
                                SjekkOmBehandlingKreverSammenhengendeUttak.BESKRIVELSE)
                        .hvis(
                                new SjekkOmBehandlingKreverSammenhengendeUttak(),
                                IkkeOppfylt.opprett(
                                        "UT1046",
                                        IkkeOppfyltÅrsak.MOR_HAR_IKKE_OMSORG,
                                        true,
                                        false))
                        .ellers(
                                IkkeOppfylt.opprett(
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmPeriodenGjelderFlerbarnsdager() {
        return rs.hvisRegel(
                        SjekkOmPeriodenGjelderFlerbarnsdager.ID,
    ...
    private Specification<FastsettePeriodeGrunnlag>
            sjekkGyldigGrunnForTidligOppstartHelePerioden() {
        return rs.hvisRegel(
    ...
    private Specification<FastsettePeriodeGrunnlag> delFlytForTidligUttak() {
        ...
        return rs.hvisRegel(SjekkOmOmsorgHelePerioden.ID, SjekkOmOmsorgHelePerioden.BESKRIVELSE)
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1054", IkkeOppfyltÅrsak.FAR_HAR_IKKE_OMSORG, true, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGradertePeriodenGjelderFlerbarnsdager() {
        return rs.hvisRegel(
                        ...
                        SjekkOmPeriodenGjelderFlerbarnsdager.BESKRIVELSE)
                .hvis(
                        new SjekkOmPeriodenGjelderFlerbarnsdager(),
                        Oppfylt.opprett(
                                "UT1270",
                                InnvilgetÅrsak.GRADERING_FELLESPERIODE_ELLER_FORELDREPENGER,
                                true))
    ...
    private Specification<FastsettePeriodeGrunnlag>
            sjekkOmMorErIAktivitetIGradertPeriodeUtenFlerbarnsdager() {
    ...
    private Specification<FastsettePeriodeGrunnlag> delFlytForVanligUttak() {
        ...
        var sjekkOmMorErIAktivitetIPerioden =
                rs.hvisRegel(SjekkOmMorErIAktivitet.ID, SjekkOmMorErIAktivitet.BESKRIVELSE)
                        .hvis(
                                new SjekkOmMorErIAktivitet(),
                                Oppfylt.opprett(
                                        "UT1258",
        ...
        var sjekkOmPeriodenGjelderFlerbarnsdager =
                rs.hvisRegel(
                                SjekkOmPeriodenGjelderFlerbarnsdager.ID,
                                SjekkOmPeriodenGjelderFlerbarnsdager.BESKRIVELSE)
                        .hvis(
        ...
        var omGradertPeriodeNode =
                rs.hvisRegel(SjekkOmGradertPeriode.ID, SjekkOmGradertPeriode.BESKRIVELSE)
                        .hvis(
                                new SjekkOmGradertPeriode(),
                                sjekkOmGradertePeriodenGjelderFlerbarnsdager())
                        .ellers(sjekkOmPeriodenGjelderFlerbarnsdager);
