 ...
 * - Perioden starter for tidlig før familiehendelsen (termin/fødsel) - Perioden starter i periode etter fødsel som er
 * forbeholdt mor.<br>
 *
...
public class FellesperiodeDelregel implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmUttakSkjerEtterDeFørsteUkene() {
        return rs.hvisRegel(SjekkOmUttakSkjerEtterDeFørsteUkene.ID, SjekkOmUttakSkjerEtterDeFørsteUkene.BESKRIVELSE)
                ...
                .ellers(Manuellbehandling.opprett(
                        "UT1048", null, Manuellbehandlingårsak.UGYLDIG_STØNADSKONTO, true, false));
    }

    private Specification<FastsettePeriodeGrunnlag> sjekkSaldoForMor() {
        var erDetGraderingIPeriodenMedDagerPåNoenAktiviteterNode = rs.hvisRegel(
                        SjekkOmGradertPeriode.ID, SjekkOmGradertPeriode.BESKRIVELSE)
                .hvis(
                        new SjekkOmGradertPeriode(),
        ...
        var noenTilgjengligeDagerNode = rs.hvisRegel(
                        SjekkOmTilgjengeligeDagerPåNoenAktiviteteneForSøktStønadskonto.ID,
        ...
        var sjekkOmTrekkesDager = rs.hvisRegel(
                ...
                .hvis(
                        ...
                        IkkeOppfylt.opprett("UT1046", IkkeOppfyltÅrsak.MOR_HAR_IKKE_OMSORG, true, false))
    ...
    private Specification<FastsettePeriodeGrunnlag> delFlytForTidligUttak() {
        var erDetGraderingIPeriodenMedDagerPåAlleAktiviteterNode = rs.hvisRegel(
                        SjekkOmGradertPeriode.ID, SjekkOmGradertPeriode.BESKRIVELSE)
                .hvis(
                        new SjekkOmGradertPeriode(),
        ...
        var noenDisponibleDagerNode = rs.hvisRegel(
                        SjekkOmTilgjengeligeDagerPåNoenAktiviteteneForSøktStønadskonto.ID,
    ...
    private Specification<FastsettePeriodeGrunnlag> delFlytForVanligUttak() {
        ...
        var sjekkOmMorErIAktivitetIPerioden = rs.hvisRegel(
                        SjekkOmMorErIAktivitet.ID, SjekkOmMorErIAktivitet.BESKRIVELSE)
                .hvis(
                        new SjekkOmMorErIAktivitet(),
                        Oppfylt.opprett("UT1258", InnvilgetÅrsak.FELLESPERIODE_ELLER_FORELDREPENGER, true))
                .ellers(new AvslagAktivitetskravDelregel().getSpecification());

        var sjekkOmPeriodenGjelderFlerbarnsdager = rs.hvisRegel(
        ...
        var sjekkOmTrekkesDager = rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmBehandlingKreverSammenhengendeUttak(),
                        IkkeOppfylt.opprett("UT1060", IkkeOppfyltÅrsak.FAR_HAR_IKKE_OMSORG, true, false))
