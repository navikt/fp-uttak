...
/**
 * Delregel innenfor regeltjenesten FastsettePeriodeRegel som fastsetter uttaksperioder med
 * fedrekvote.
 *
 ...
 * - Perioden starter i periode etter fødsel som er forbeholdt mor og har ikke gyldig grunn for
 * dette. <br>
 *
 * <p>Utfall INNVILGET:<br>
 * - Perioden er etter ukene etter fødsel som er forbeholdt mor og det er nok dager på
 * stønadskontoen for fedrekvote.<br>
 * - Perioden har gyldig grunn for å starte i ukene etter fødsel som er forbeholdt mor og det er nok
 * dager på stønadskontoen for fedrekvote.<br>
 */
@RuleDocumentation(
        value = FedrekvoteDelregel.ID,
...
public class FedrekvoteDelregel implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    private static final String OVERFØRING_SYKDOM_SKADE =
            "Er det søkt om overføring som følge av sykdom/skade?";
    private static final String OVERFØRING_INNLEGGELSE =
            "Er det søkt om overføring som følge av innleggelse på institusjon?";
    private static final String OVERFØRING_ALENEOMSORG_ELLER_IKKE_RETT =
    ...
    public Specification<FastsettePeriodeGrunnlag> getSpecification() {
        return rs.hvisRegel(
                        SjekkOmOppholdKvoteAnnenForelder.ID,
                        "Er det søkt om opphold av fedrekvoten?")
        ...
        return rs.hvisRegel(
                ...
                .ellers(
                        Manuellbehandling.opprett(
                                "UT1262",
                                null,
                                Manuellbehandlingårsak.OPPHOLD_STØRRE_ENN_TILGJENGELIGE_DAGER,
                                true,
                                false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmPeriodenStarterFørOmsorgsovertakelse() {
        return rs.hvisRegel(
                ...
                .hvis(
                        ...
                        IkkeOppfylt.opprett(
                                "UT1231", IkkeOppfyltÅrsak.FØR_OMSORGSOVERTAKELSE, false, false))
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmDetErFødsel() {
        return rs.hvisRegel(
                ...
                .hvis(
                        ...
                        sjekkOmPeriodeStarterFørUke7EtterFamiliehendelse())
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorHarRett() {
        return rs.hvisRegel(SjekkOmMorHarRett.ID, "Er det avklart at mor har rett?")
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1292", IkkeOppfyltÅrsak.MOR_IKKE_RETT_FK, true, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmOverføringPgaInnleggelse() {
        return rs.hvisRegel(SjekkOmOverføringPgaInnleggelse.ID, OVERFØRING_INNLEGGELSE)
                .hvis(
                        ...
                        sjekkOmGyldigOverføringPgaInnleggelse())
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmOverføringPgaSykdomSkade() {
        return rs.hvisRegel(SjekkOmOverføringPgaSykdomSkade.ID, OVERFØRING_SYKDOM_SKADE)
                .hvis(
                        ...
                        sjekkOmGyldigOverføringPgaSykdomSkade())
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmOverføringPgaAleneomsorgEllerIkkeRett() {
        return rs.hvisRegel(
                        SjekkOmOverføringPgaAleneomsorg.ID, OVERFØRING_ALENEOMSORG_ELLER_IKKE_RETT)
                .hvis(
                        new SjekkOmOverføringPgaAleneomsorg(),
                        sjekkOmGyldigOverføringPgaAleneomsorg())
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGyldigOverføringPgaInnleggelse() {
        return rs.hvisRegel(
                        SjekkOmGyldigOverføringPgaInnleggelse.ID,
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1033",
                                IkkeOppfyltÅrsak.DEN_ANDRE_PART_INNLEGGELSE_IKKE_OPPFYLT,
                                false,
                                false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGyldigOverføringPgaSykdomSkade() {
        return rs.hvisRegel(
                        SjekkOmGyldigOverføringPgaSykdomSkade.ID,
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1034",
                                IkkeOppfyltÅrsak.DEN_ANDRE_PART_SYK_SKADET_IKKE_OPPFYLT,
                                false,
                                false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGyldigOverføringPgaAleneomsorg() {
        return rs.hvisRegel(
                        SjekkOmGyldigOverføringPgaAleneomsorg.ID,
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1296", IkkeOppfyltÅrsak.ALENEOMSORG_IKKE_OPPFYLT, false, false));
    }

    private Specification<FastsettePeriodeGrunnlag> sjekkOmGyldigOverføringPgaIkkeRett() {
        return rs.hvisRegel(
                        SjekkOmGyldigOverføringPgaIkkeRett.ID,
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1297",
                                IkkeOppfyltÅrsak.DEN_ANDRE_PART_IKKE_RETT_IKKE_OPPFYLT,
                                false,
                                false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorSøktOmOverføringAvFedrekvote() {
        return rs.hvisRegel(
                        ...
                        "Har mor søkt om overføring av fedrekvoten?")
    ...
    public Specification<FastsettePeriodeGrunnlag>
            sjekkOmPeriodeStarterFørUke7EtterFamiliehendelse() {
        return rs.hvisRegel(
                        SjekkOmPeriodenStarterFørUke7.ID,
                        "Starter perioden før uke 7 etter termin/fødsel?")
    ...
    private Specification<FastsettePeriodeGrunnlag> uttakFørTerminFødsel() {
        return rs.hvisRegel(
                        ...
                        "Skal uttaksperioden være før termin/fødsel?")
                .hvis(
    ...
    private Specification<FastsettePeriodeGrunnlag> delFlytForTidligUttak() {
        ...
        var graderingIPeriodenNode =
                rs.hvisRegel(SjekkOmGradertPeriode.ID, SjekkOmGradertPeriode.BESKRIVELSE)
                        ...
                        .ellers(
                                Oppfylt.opprett(
                                        "UT1026", InnvilgetÅrsak.KVOTE_ELLER_OVERFØRT_KVOTE, true));
        ...
        return rs.hvisRegel(SjekkOmOmsorgHelePerioden.ID, SjekkOmOmsorgHelePerioden.BESKRIVELSE)
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1025", IkkeOppfyltÅrsak.FAR_HAR_IKKE_OMSORG, true, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> delFlytForVanligUttak() {
        ...
        var graderingIPeriodenNode =
                rs.hvisRegel(SjekkOmGradertPeriode.ID, SjekkOmGradertPeriode.BESKRIVELSE)
                        ...
                        .ellers(
                                Oppfylt.opprett(
                                        "UT1031", InnvilgetÅrsak.KVOTE_ELLER_OVERFØRT_KVOTE, true));
        ...
        return rs.hvisRegel(SjekkOmOmsorgHelePerioden.ID, SjekkOmOmsorgHelePerioden.BESKRIVELSE)
                ...
                .ellers(
                        IkkeOppfylt.opprett(
                                "UT1030", IkkeOppfyltÅrsak.FAR_HAR_IKKE_OMSORG, true, false));
    }
}
