 ...
 * <br>
 * - Perioden har gyldig grunn for å starte i ukene etter fødsel som er forbeholdt mor og det er nok dager på
...
public class FedrekvoteDelregel implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmNoenDisponibleDager() {
        return rs.hvisRegel(
                ...
                .ellers(Manuellbehandling.opprett(
                        "UT1262", null, Manuellbehandlingårsak.OPPHOLD_STØRRE_ENN_TILGJENGELIGE_DAGER, true, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGyldigOverføringPgaInnleggelse() {
        return rs.hvisRegel(
                ...
                .ellers(IkkeOppfylt.opprett(
                        "UT1033", IkkeOppfyltÅrsak.DEN_ANDRE_PART_INNLEGGELSE_IKKE_OPPFYLT, false, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGyldigOverføringPgaSykdomSkade() {
        return rs.hvisRegel(
                ...
                .ellers(IkkeOppfylt.opprett(
                        "UT1034", IkkeOppfyltÅrsak.DEN_ANDRE_PART_SYK_SKADET_IKKE_OPPFYLT, false, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmGyldigOverføringPgaIkkeRett() {
        return rs.hvisRegel(
                ...
                .ellers(IkkeOppfylt.opprett(
                        "UT1297", IkkeOppfyltÅrsak.DEN_ANDRE_PART_IKKE_RETT_IKKE_OPPFYLT, false, false));
    }
