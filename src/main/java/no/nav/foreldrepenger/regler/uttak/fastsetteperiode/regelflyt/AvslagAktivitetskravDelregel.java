...
@RuleDocumentation(
        value = AvslagAktivitetskravDelregel.ID,
...
public class AvslagAktivitetskravDelregel implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    public Specification<FastsettePeriodeGrunnlag> getSpecification() {
        return rs.hvisRegel(
                ...
                .hvis(
                        ...
                        IkkeOppfylt.opprett(
                                "UT1319", IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN, false, false))
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorKvalifiseringsprogram() {
        return rs.hvisRegel(
                        SjekkOmMorKvalifiseringsprogram.ID,
                        SjekkOmMorKvalifiseringsprogram.BESKRIVELSE)
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorIntroduksjonsprogram() {
        return rs.hvisRegel(
                        SjekkOmMorIntroduksjonsprogram.ID,
                        SjekkOmMorIntroduksjonsprogram.BESKRIVELSE)
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorKombinasjonArbeidUtdanning() {
        return rs.hvisRegel(
                        SjekkOmMorKombinasjonArbeidUtdanning.ID,
                        SjekkOmMorKombinasjonArbeidUtdanning.BESKRIVELSE)
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorBekreftetUføretrygd() {
        return rs.hvisRegel(SjekkOmMorBekreftetUføre.ID, SjekkOmMorBekreftetUføre.BESKRIVELSE)
                ...
                .ellers(
                        avslåSjekkSkalTrekkeDager(
                                "UT1322", FORELDREPENGER_KUN_FAR_HAR_RETT_MOR_IKKE_UFØR));
    }

    private Specification<FastsettePeriodeGrunnlag> sjekkOmMorBekreftetUføretrygdErUttak() {
        return rs.hvisRegel(
                        SjekkOmUttakOgUtenAktivitetskrav.ID,
                        SjekkOmUttakOgUtenAktivitetskrav.BESKRIVELSE)
                .hvis(
                        new SjekkOmUttakOgUtenAktivitetskrav(),
                        avslå("UT1324", AKTIVITET_UKJENT_UDOKUMENTERT))
                .ellers(utfall1314AvklarAktivitetSituasjon());
    }

    private Specification<FastsettePeriodeGrunnlag>
            sjekkOmUkjentAktivitetErUttakUtenAktivitetskrav() {
        return rs.hvisRegel(
                        SjekkOmUttakOgUtenAktivitetskrav.ID,
                        SjekkOmUttakOgUtenAktivitetskrav.BESKRIVELSE)
                .hvis(
                        new SjekkOmUttakOgUtenAktivitetskrav(),
                        avslå("UT1323", AKTIVITET_UKJENT_UDOKUMENTERT))
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmUkjentAktivitetErFriUtsettelse() {
        ...
        return rs.hvisRegel(SjekkOmFriUtsettelse.ID, SjekkOmFriUtsettelse.BESKRIVELSE)
                .hvis(
                        new SjekkOmFriUtsettelse(),
                        avslåSjekkSkalTrekkeDager("UT1325", BARE_FAR_RETT_IKKE_SØKT))
                .ellers(
    ...
    private Specification<FastsettePeriodeGrunnlag> morArbeid() {
        return rs.hvisRegel(
                        SjekkOmAktivitetErDokumentert.ID, SjekkOmAktivitetErDokumentert.BESKRIVELSE)
                .hvis(
                        new SjekkOmAktivitetErDokumentert(),
                        avslåSjekkSkalTrekkeDager("UT1300", AKTIVITETSKRAVET_ARBEID_IKKE_OPPFYLT))
                .ellers(
                        avslåSjekkSkalTrekkeDager(
                                "UT1301", AKTIVITETSKRAVET_ARBEID_IKKE_DOKUMENTERT));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> morSyk() {
        return rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmAktivitetErDokumentert(),
                        avslåSjekkSkalTrekkeDager("UT1302", AKTIVITETSKRAVET_SYKDOM_IKKE_OPPFYLT))
                .ellers(
                        avslåSjekkSkalTrekkeDager(
                                "UT1303", AKTIVITETSKRAVET_SYKDOM_IKKE_DOKUMENTERT));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> morInnlagt() {
        return rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmAktivitetErDokumentert(),
                        avslåSjekkSkalTrekkeDager(
                                "UT1304", AKTIVITETSKRAVET_INNLEGGELSE_IKKE_OPPFYLT))
                .ellers(
                        avslåSjekkSkalTrekkeDager(
                                "UT1305", AKTIVITETSKRAVET_INNLEGGELSE_IKKE_DOKUMENTERT));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> morUtdannning() {
        return rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmAktivitetErDokumentert(),
                        avslåSjekkSkalTrekkeDager(
                                "UT1306", AKTIVITETSKRAVET_UTDANNING_IKKE_OPPFYLT))
                .ellers(
                        avslåSjekkSkalTrekkeDager(
                                "UT1307", AKTIVITETSKRAVET_UTDANNING_IKKE_DOKUMENTERT));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> avslåSjekkSkalTrekkeDager(
            String sluttpunktId, IkkeOppfyltÅrsak årsak) {
        return rs.hvisRegel(
                        SjekkOmAktivitetErDokumentert.ID, SjekkOmAktivitetErDokumentert.BESKRIVELSE)
                .hvis(
                        new SjekkOmSkalTrekkeDagerFraKonto(),
    ...
    private Specification<FastsettePeriodeGrunnlag> utfall1314AvklarAktivitetSituasjon() {
        return rs.hvisRegel(
                ...
                .hvis(
                        new SjekkOmSkalTrekkeDagerFraKonto(),
                        Manuellbehandling.opprett(
                                "UT1314", null, Manuellbehandlingårsak.MOR_UFØR, true, true))
                .ellers(
                        Manuellbehandling.opprett(
                                "UT1314", null, Manuellbehandlingårsak.MOR_UFØR, false, true));
    }
}
