...
public class AvslagAktivitetskravDelregel implements RuleService<FastsettePeriodeGrunnlag> {
    ...
    public Specification<FastsettePeriodeGrunnlag> getSpecification() {
        return rs.hvisRegel(SjekkOmTomForAlleSineKontoer.ID, SjekkOmTomForAlleSineKontoer.BESKRIVELSE)
                ...
                .hvis(
                        ...
                        IkkeOppfylt.opprett("UT1319", IkkeOppfyltÅrsak.IKKE_STØNADSDAGER_IGJEN, false, false))
    ...
    private Specification<FastsettePeriodeGrunnlag> sjekkOmUkjentAktivitetErFriUtsettelse() {
        ...
        return rs.hvisRegel(SjekkOmFriUtsettelse.ID, SjekkOmFriUtsettelse.BESKRIVELSE)
                ...
                .ellers(Manuellbehandling.opprett(
                        "UT1315", null, Manuellbehandlingårsak.AKTIVITEKTSKRAVET_MÅ_SJEKKES_MANUELT, true, false));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> morInnlagt() {
        return rs.hvisRegel(SjekkOmAktivitetErDokumentert.ID, SjekkOmAktivitetErDokumentert.BESKRIVELSE)
                .hvis(
                        new SjekkOmAktivitetErDokumentert(),
                        avslåSjekkSkalTrekkeDager("UT1304", AKTIVITETSKRAVET_INNLEGGELSE_IKKE_OPPFYLT))
    ...
    private Specification<FastsettePeriodeGrunnlag> morUtdannning() {
        return rs.hvisRegel(SjekkOmAktivitetErDokumentert.ID, SjekkOmAktivitetErDokumentert.BESKRIVELSE)
                .hvis(
                        new SjekkOmAktivitetErDokumentert(),
                        avslåSjekkSkalTrekkeDager("UT1306", AKTIVITETSKRAVET_UTDANNING_IKKE_OPPFYLT))
        ...
        return rs.hvisRegel(SjekkOmAktivitetErDokumentert.ID, SjekkOmAktivitetErDokumentert.BESKRIVELSE)
                .hvis(
                        ...
                        avslåSjekkSkalTrekkeDager(
                                "UT1308", AKTIVITETSKRAVET_DELTAKELSE_KVALIFISERINGSPROGRAM_IKKE_OPPFYLT))
                .ellers(avslåSjekkSkalTrekkeDager(
                        "UT1309", AKTIVITETSKRAVET_DELTAKELSE_KVALIFISERINGSPROGRAM_IKKE_DOKUMENTERT));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> morIntroduksjonsprogram() {
        return rs.hvisRegel(SjekkOmAktivitetErDokumentert.ID, SjekkOmAktivitetErDokumentert.BESKRIVELSE)
                .hvis(
                        new SjekkOmAktivitetErDokumentert(),
                        avslåSjekkSkalTrekkeDager(
                                "UT1310", AKTIVITETSKRAVET_DELTAKELSE_INTRODUKSJONSPROGRAM_IKKE_OPPFYLT))
                .ellers(avslåSjekkSkalTrekkeDager(
                        "UT1311", AKTIVITETSKRAVET_DELTAKELSE_INTRODUKSJONSPROGRAM_IKKE_DOKUMENTERT));
    }
    ...
    private Specification<FastsettePeriodeGrunnlag> morKombinasjonArbeidUtdanning() {
        return rs.hvisRegel(SjekkOmAktivitetErDokumentert.ID, SjekkOmAktivitetErDokumentert.BESKRIVELSE)
                ...
                .ellers(avslåSjekkSkalTrekkeDager(
                        "UT1313", AKTIVITETSKRAVET_KOMBINASJON_ARBEID_UTDANNING_IKKE_DOKUMENTERT));
    }
