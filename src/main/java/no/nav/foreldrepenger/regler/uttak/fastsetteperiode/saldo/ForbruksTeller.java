...
final class ForbruksTeller {
    ...
    static Trekkdager forbruksTellerKontoMedUnntak(
            Stønadskontotype stønadskonto,
            AktivitetIdentifikator aktivitet,
            List<FastsattUttakPeriode> søkersPerioder,
            Predicate<FastsattUttakPeriode> tellPeriode,
    ...
    static Trekkdager forbruksTeller(
            Stønadskontotype stønadskonto,
            AktivitetIdentifikator aktivitet,
            List<FastsattUttakPeriode> søkersPerioder,
            Predicate<FastsattUttakPeriode> tellPeriode,
        ...
        // Tilkommet aktivitet. Bruk minste forbruk inntil første forekomst - evt ZERO dersom ingen
        // forekomster.
        if (startindex > 0) {
    ...
    // Index til første periode som inneholder aktivitet, 0 dersom finnes fra start, max dersom ikke
    // funnet
    private static int førstePeriodeSomTellesMedAktivitet(
            AktivitetIdentifikator aktivitet,
    ...
    private static Trekkdager trekkdagerForUttaksperiode(
            AktivitetIdentifikator aktivitet,
